...
/***************************************************************************
* fbe_cli_getwwn_test.c
***************************************************************************
*
* DESCRIPTION
* This is the test of fbe cli "getwwn".
* 
* HISTORY
...
{
    "getwwn", //fbe cli command
    {"Resume PROM WWN Seed: 0x"}, //expected keywords for "getwwn"
    {"FBE-CLI ERROR!  "} //unexpected keywords for "getwwn"
};

// "getwwn" test setup function
