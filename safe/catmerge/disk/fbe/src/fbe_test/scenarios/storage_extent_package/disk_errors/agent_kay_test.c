...
/*!**************************************************************************
 * @file agent_kay_test.c
 ***************************************************************************
 *
 * @brief
 *  This file contains write_log flush logical errors test.
 *
 * @version
 *   5/31/2012 - Vamsi V. Created from Agent_jay test.
 *
 ***************************************************************************/
...
char * agent_kay_short_desc = "write_log flush logical errors test.";
char * agent_kay_long_desc ="\
The agent_kay scenario tests parity rg's handling of write_log flush with logical errors.\n\
\n\
...
/*!*******************************************************************
 * @def AGENT_KAY_LUNS_PER_RAID_GROUP_QUAL
 *********************************************************************
 * @brief luns per rg for the extended test. 
 *
 *********************************************************************/
#define AGENT_KAY_LUNS_PER_RAID_GROUP 1

/*!*******************************************************************
 * @def AGENT_KAY_CHUNKS_PER_LUN
 *********************************************************************
 * @brief Number of chunks each LUN will occupy.
 *
 *********************************************************************/
#define AGENT_KAY_CHUNKS_PER_LUN 3

/*!*******************************************************************
 * @def AGENT_KAY_MAX_BACKEND_IO_SIZE
 *********************************************************************
 * @brief Max size we expect the I/O to get broken up after.
 *
 *********************************************************************/
#define AGENT_KAY_MAX_BACKEND_IO_SIZE 2048

/*!*******************************************************************
 * @def AGENT_KAY_BASE_OFFSET
 *********************************************************************
 * @brief All drives have this base offset, that we need to add on.
 *
 *********************************************************************/
#define AGENT_KAY_BASE_OFFSET 0x10000

/*!*******************************************************************
 * @def AGENT_KAY_ERR_COUNT_MATCH
 *********************************************************************
 * @brief Error count should match the size of the element.
 *
 *********************************************************************/
#define AGENT_KAY_ERR_COUNT_MATCH FBE_U32_MAX

/*!*******************************************************************
 * @def AGENT_KAY_ERR_COUNT_MATCH_ELSZ
 *********************************************************************
 * @brief Error count should match the size of the element.
 *
 *********************************************************************/
#define AGENT_KAY_ERR_COUNT_MATCH_ELSZ (FBE_U32_MAX - 1)

/*!*******************************************************************
 * @def AGENT_KAY_ERR_COUNT_NON_ZERO
 *********************************************************************
 * @brief The error count should not be zero but can match any non-zero count.
 *
 *********************************************************************/
#define AGENT_KAY_ERR_COUNT_NON_ZERO (FBE_U32_MAX - 2)

/*!*******************************************************************
 * @def AGENT_KAY_WAIT_MSEC
 *********************************************************************
 ...
 *
 *********************************************************************/
#define AGENT_KAY_WAIT_MSEC 60000

/*!*******************************************************************
 * @def AGENT_KAY_MAX_RG_COUNT
 *********************************************************************
 * @brief Max number of raid groups we expect to test in parallel.
 *
 *********************************************************************/
#define AGENT_KAY_MAX_RG_COUNT 16

/*!*******************************************************************
 * @def AGENT_KAY_RAID_TYPE_COUNT
 *********************************************************************
 * @brief Number of separate configs we will setup.
 *
 *********************************************************************/
#define AGENT_KAY_RAID_TYPE_COUNT (3)

/*!*******************************************************************
 * @var agent_kay_raid_group_config_qual
 *********************************************************************
 * @brief This is the array of configurations we will loop over.
 *
 *********************************************************************/
fbe_test_rg_configuration_array_t agent_kay_raid_group_config_qual[] = 
{
...
/**************************************
 * end agent_kay_raid_group_config_qual()
 **************************************/

/*!*******************************************************************
 * @var agent_kay_raid_group_config_extended
 *********************************************************************
 * @brief This is the array of configurations we will loop over.
 *
 *********************************************************************/
fbe_test_rg_configuration_array_t agent_kay_raid_group_config_extended[] = 
{
    /* Raid 5 configurations.
     */
    {
...
/**************************************
 * end agent_kay_raid_group_config_extended()
 **************************************/

/*!*************************************************
 * @enum fbe_agent_kay_raid_type_t
 ***************************************************
 * @brief Set of raid types we will test.
 *
 ***************************************************/
typedef enum fbe_agent_kay_raid_type_e
{
    AGENT_KAY_RAID_TYPE_RAID5 = 0,
    AGENT_KAY_RAID_TYPE_RAID3 = 1,
    AGENT_KAY_RAID_TYPE_RAID6 = 2,
    AGENT_KAY_RAID_TYPE_LAST,
}
fbe_agent_kay_raid_type_t;

/*!*************************************************
 * @enum fbe_agent_kay_error_type_t
 ***************************************************
 ...
 *
 ***************************************************/
typedef enum fbe_agent_kay_error_type_e
{
    AGENT_KAY_ERROR_TYPE_INVALID = 0,
    AGENT_KAY_ERROR_TYPE_RETRYABLE,
    AGENT_KAY_ERROR_TYPE_PORT_RETRYABLE,
    AGENT_KAY_ERROR_TYPE_NON_RETRYABLE,
    AGENT_KAY_ERROR_TYPE_HARD_MEDIA_ERROR,
    AGENT_KAY_ERROR_TYPE_SOFT_MEDIA_ERROR,
    AGENT_KAY_ERROR_TYPE_INCOMPLETE_WRITE,
    AGENT_KAY_ERROR_TYPE_LAST,
}
fbe_agent_kay_error_type_t;

/*!*************************************************
 * @enum fbe_agent_kay_error_location_t
 ***************************************************
 * @brief This defines where we will inject the
 *        error on the raid group.
 *
 ***************************************************/
typedef enum fbe_agent_kay_error_location_e
{
    AGENT_KAY_ERROR_LOCATION_INVALID = 0,
    AGENT_KAY_ERROR_LOCATION_USER_DATA, /*!< Only inject on user area. */
    AGENT_KAY_ERROR_LOCATION_USER_DATA_CHUNK_1, /*!< Only inject on user area. */
    AGENT_KAY_ERROR_LOCATION_PAGED_METADATA, /*< Only inject on paged metadata. */
    AGENT_KAY_ERROR_LOCATION_RAID, /*< Inject on all raid protected areas both user and paged metadata. */
    AGENT_KAY_ERROR_LOCATION_WRITE_LOG,   /* Inject on write log area. */
    AGENT_KAY_ERROR_LOCATION_LAST,
}
fbe_agent_kay_error_location_t;

/*!*************************************************
 * @struct fbe_agent_kay_drive_error_definition_t
 ***************************************************
 * @brief Single drive's error definition.
 *
 ***************************************************/
typedef struct fbe_agent_kay_drive_error_definition_s
{
    fbe_agent_kay_error_type_t error_type;  /*!< Class of error (retryable/non/media/soft) */
    ...
    fbe_agent_kay_error_location_t location; /*!< Area to inject the error. */
...
fbe_agent_kay_drive_error_definition_t;
 ...
 *
 ***************************************************/
typedef enum fbe_agent_kay_live_stripe_data_e
{
    AGENT_KAY_LIVE_STRIPE_DATA_INVALID = 0,
    AGENT_KAY_LIVE_STRIPE_DATA_OLD,
    AGENT_KAY_LIVE_STRIPE_DATA_NEW,
    AGENT_KAY_LIVE_STRIPE_DATA_MIXED,
    AGENT_KAY_LIVE_STRIPE_DATA_LAST,
}
fbe_agent_kay_live_stripe_data_t;

/*!*******************************************************************
 * @def AGENT_KAY_ERROR_CASE_MAX_ERRORS
 *********************************************************************
 * @brief Max number of errors per error case.
 *
 *********************************************************************/
#define AGENT_KAY_ERROR_CASE_MAX_ERRORS 10

/*!*******************************************************************
 * @def AGENT_KAY_MAX_DEGRADED_POSITIONS
 *********************************************************************
 ...
 *
 *********************************************************************/
#define AGENT_KAY_MAX_DEGRADED_POSITIONS 8

/*!*******************************************************************
 * @def AGENT_KAY_MAX_TEST_WIDTHS
 *********************************************************************
 * @brief Max number of widths we can specify to test.
 *
 *********************************************************************/
#define AGENT_KAY_MAX_TEST_WIDTHS 4

/*!*******************************************************************
 * @def AGENT_KAY_MAX_ERROR_CASES
 *********************************************************************
 * @brief Max number of possible cases to validate against.
 *
 *********************************************************************/
#define AGENT_KAY_MAX_ERROR_CASES 4

/*!*******************************************************************
 * @def AGENT_KAY_MAX_POSSIBLE_STATUS
 *********************************************************************
 * @brief Max number of possible different I/O status for rdgen request
 *
 *********************************************************************/
#define AGENT_KAY_MAX_POSSIBLE_STATUS  2
#define AGENT_KAY_INVALID_STATUS       FBE_PAYLOAD_BLOCK_OPERATION_STATUS_INVALID

/*!*******************************************************************
 * @def AGENT_KAY_NUM_DIRECT_IO_ERRORS
 *********************************************************************
 ...
 *
 *********************************************************************/
#define AGENT_KAY_NUM_DIRECT_IO_ERRORS                 1

/*!*******************************************************************
 * @def AGENT_KAY_NUM_READ_AND_SINGLE_VERIFY_ERRORS
 *********************************************************************
 ...
 *
 *********************************************************************/
#define AGENT_KAY_NUM_READ_AND_SINGLE_VERIFY_ERRORS    (AGENT_KAY_NUM_DIRECT_IO_ERRORS + 2)

/*!*******************************************************************
 * @def AGENT_KAY_NUM_RETRYABLE_TO_FAIL_DRIVE
 *********************************************************************
 ...
 * 
 *********************************************************************/
#define AGENT_KAY_NUM_RETRYABLE_TO_FAIL_DRIVE 10

/*!*************************************************
 * @typedef fbe_agent_kay_error_case_t
 ***************************************************
 * @brief Single test case with the error and
 *        the blocks to read for.
 *
 ***************************************************/
typedef struct fbe_agent_kay_error_case_s
{
    ...
    fbe_agent_kay_drive_error_definition_t errors[AGENT_KAY_ERROR_CASE_MAX_ERRORS];
    fbe_u32_t num_errors;
    fbe_api_logical_error_injection_record_t flush_errors[AGENT_KAY_ERROR_CASE_MAX_ERRORS];
    fbe_u32_t flush_num_errors;    
    //fbe_test_event_log_test_result_t event_log_result; /*!< Expected event log message for injected error(s) */
    fbe_u32_t degraded_positions[AGENT_KAY_MAX_DEGRADED_POSITIONS];
    fbe_u32_t widths[AGENT_KAY_MAX_TEST_WIDTHS]; /*! Widths to test with. FBE_U32_MAX if invalid*/
    ...
    fbe_payload_block_operation_status_t block_status[AGENT_KAY_MAX_POSSIBLE_STATUS];
    fbe_payload_block_operation_qualifier_t block_qualifier[AGENT_KAY_MAX_POSSIBLE_STATUS];

    /* For any of these counters, FBE_U32_MAX means that it is not used. 
     * FBE_U32_MAX - 1 means to use a multiple of the element size. 
     */
    fbe_u32_t retryable_error_count[AGENT_KAY_MAX_ERROR_CASES]; /*!< Expected retryable errors. */
    fbe_u32_t non_retryable_error_count[AGENT_KAY_MAX_ERROR_CASES]; /*!< Expected non-retryable errors. */
    fbe_u32_t shutdown_error_count[AGENT_KAY_MAX_ERROR_CASES]; /*!< Expected shutdown errors. */
    fbe_u32_t correctable_media_error_count[AGENT_KAY_MAX_ERROR_CASES]; /*!< Expected correctable media errors. */
    fbe_u32_t uncorrectable_media_error_count[AGENT_KAY_MAX_ERROR_CASES]; /*!< Expected uncorrectable media errors. */
    fbe_u32_t correctable_time_stamp[AGENT_KAY_MAX_ERROR_CASES];
    fbe_u32_t correctable_write_stamp[AGENT_KAY_MAX_ERROR_CASES];
    fbe_u32_t uncorrectable_time_stamp[AGENT_KAY_MAX_ERROR_CASES];
    fbe_u32_t uncorrectable_write_stamp[AGENT_KAY_MAX_ERROR_CASES];
    fbe_u32_t correctable_coherency[AGENT_KAY_MAX_ERROR_CASES];
    fbe_u32_t correctable_crc_count[AGENT_KAY_MAX_ERROR_CASES]; /*!< Expected correctable crc errors. */
    fbe_u32_t uncorrectable_crc_count[AGENT_KAY_MAX_ERROR_CASES]; /*!< Expected uncorrectable crc errors. */
    fbe_u32_t max_error_cases; /*!< Max number of possible counts above. */

    /* Expected data on live-stripe after Flush operation. */
    fbe_agent_kay_live_stripe_data_t expected_data;

    /* Live stripe status */
    fbe_u32_t live_io_err_cnt;
    fbe_payload_block_operation_status_t live_block_status[AGENT_KAY_MAX_POSSIBLE_STATUS];
    fbe_payload_block_operation_qualifier_t live_block_qualifier[AGENT_KAY_MAX_POSSIBLE_STATUS];

    /* Pre-blocks status */
    fbe_u32_t pre_io_err_cnt;
    fbe_payload_block_operation_status_t pre_block_status[AGENT_KAY_MAX_POSSIBLE_STATUS];
    fbe_payload_block_operation_qualifier_t pre_block_qualifier[AGENT_KAY_MAX_POSSIBLE_STATUS];

    /* Post-blocks status */
    fbe_u32_t post_io_err_cnt;
    fbe_payload_block_operation_status_t post_block_status[AGENT_KAY_MAX_POSSIBLE_STATUS];
    fbe_payload_block_operation_qualifier_t post_block_qualifier[AGENT_KAY_MAX_POSSIBLE_STATUS];
}
fbe_agent_kay_error_case_t;

/*!***************************************************************************
 * @typedef fbe_agent_kay_provision_drive_default_background_operations_t
 *****************************************************************************
 * @brief   Global setting of default background operations.
 *
 ***************************************************/
typedef struct fbe_agent_kay_provision_drive_default_background_operations_t
{
...
fbe_agent_kay_provision_drive_default_background_operations_t;

/*!*******************************************************************
 * @def AGENT_KAY_MAX_STRING_LENGTH
 *********************************************************************
 * @brief Max size of a string in a agent_kay structure.
 *
 *********************************************************************/
#define AGENT_KAY_MAX_STRING_LENGTH 500

static fbe_status_t fbe_sep_agent_kay_setup_rdgen_test_context(fbe_api_rdgen_context_t *context_p,
                                                               fbe_object_id_t object_id,
                                                               fbe_rdgen_operation_t rdgen_operation,
                                                               fbe_u32_t num_ios);
static fbe_status_t agent_kay_get_drive_position(fbe_test_rg_configuration_t *raid_group_config_p,
                                                 fbe_u32_t *position_p);
static fbe_bool_t agent_kay_get_and_check_degraded_position(fbe_test_rg_configuration_t *raid_group_config_p,
                                                            fbe_agent_kay_error_case_t *error_case_p,
                                                            fbe_u32_t  degraded_drive_index,
                                                            fbe_u32_t *degraded_position_p);
static fbe_status_t agent_kay_get_pdo_object_id(fbe_test_rg_configuration_t *raid_group_config_p,
                                                fbe_u32_t drv_pos,
                                                fbe_object_id_t *pdo_object_id_p);
void agent_kay_setup(fbe_u32_t raid_type_index);
void agent_kay_set_rg_options(void);
void agent_kay_unset_rg_options(void);
fbe_bool_t agent_kay_is_rg_valid_for_error_case(fbe_agent_kay_error_case_t *error_case_p,
                                                fbe_test_rg_configuration_t *rg_config_p);
fbe_bool_t agent_kay_is_error_case_media_error(fbe_agent_kay_error_case_t *error_case_p,
                                               fbe_test_rg_configuration_t *rg_config_p);
fbe_bool_t agent_kay_is_corrupt_paged_metadata_error_case(fbe_agent_kay_error_case_t *error_case_p);

/*!*******************************************************************
 * @var agent_kay_test_cases_single_parity_degraded
 *********************************************************************
 * @brief These are single parity degraded only cases.
 *********************************************************************/
fbe_agent_kay_error_case_t agent_kay_test_cases_single_parity_degraded[] =
{
    {
        "Data pos degraded. Write to 2 data positions. Unexpected write error on data pos on journal write causes RG metadata reconstruct"
        "Flush SM Header read is successful. Flush Data read is successful but flush data write fails"
        "Flush is abandoned. Paged metadata is reconstructed from non-paged", __LINE__,
        ...
        {
            {
                ...
                AGENT_KAY_ERROR_LOCATION_USER_DATA, /* Location to inject. */
            ...
            },
            {
                ...
                FBE_PAYLOAD_BLOCK_OPERATION_OPCODE_WRITE,  /* opcode to inject on*/
                1, /* times to insert error. */
                1, /* raid group position to inject -- Diag pos */
                FBE_TRUE, /* Does drive die as a result of this error? */
                AGENT_KAY_ERROR_LOCATION_USER_DATA, /* Location to inject. */
                0, /* tag value only significant in case b_inc_for_all_drives is true*/
            },
        ...
        2, /* Num Errors */
        /* Errors during Flush phase.  For this error case the records below are ignored
         * and the paged metadata is `corrupted' by adding additional positions that are
         * marked NR to cause `invalid request' `too many dead positions'.
         */
        {
            { FBE_RAID_MAX_DISK_ARRAY_WIDTH - 1,    /* pos to inject error on */
                0x10, /* width */
                0x3800,  /* lba */
                0x800,  /* max number of blocks */
                FBE_API_LOGICAL_ERROR_INJECTION_TYPE_IO_UNEXPECTED,    /* error type */
            ...
            { FBE_RAID_MAX_DISK_ARRAY_WIDTH - 2,    /* pos to inject error on */
                0x10, /* width */
                0x3800,  /* lba */
                0x800,  /* max number of blocks */
                FBE_API_LOGICAL_ERROR_INJECTION_TYPE_IO_UNEXPECTED,    /* error type */
        ...
        { FBE_PAYLOAD_BLOCK_OPERATION_STATUS_INVALID_REQUEST, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
        { FBE_PAYLOAD_BLOCK_OPERATION_QUALIFIER_TOO_MANY_DEAD_POSITIONS, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
        /*  
        ...
        AGENT_KAY_LIVE_STRIPE_DATA_NEW, /* expected data in live-stripe */
        0, /* Number of I/O errors we expect. */
        { FBE_PAYLOAD_BLOCK_OPERATION_STATUS_SUCCESS, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
        { FBE_PAYLOAD_BLOCK_OPERATION_QUALIFIER_NONE, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
    ...
    {
        "Parity degraded. Write to one data pos. Non-Retryable error on parity pos on live-stripe write causes RG shutdown."
        "Flush during RG activate sees checksum error on header read."
        "Flush is abandoned. Mix of Old and New data on live stripe (parity is degraded, non-retryable error on data drive.)", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x100, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        ...
        FBE_NOTIFICATION_TYPE_LIFECYCLE_STATE_FAIL, /* Wait for rg to get to this lifecycle state. */
        1, /* Number of I/O errors we expect. */
        { FBE_PAYLOAD_BLOCK_OPERATION_STATUS_IO_FAILED, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
        { FBE_PAYLOAD_BLOCK_OPERATION_QUALIFIER_RETRY_NOT_POSSIBLE, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
        /*  
         * --> We see a shutdown error when the monitor fails the I/O. In this case the I/O completed first, and went
         * waiting.  Once the monitor runs it fails the I/O. 
         */
        ...
        AGENT_KAY_LIVE_STRIPE_DATA_MIXED, /* expected data in live-stripe */
        0, /* Number of I/O errors we expect. */
        { FBE_PAYLOAD_BLOCK_OPERATION_STATUS_SUCCESS, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
        { FBE_PAYLOAD_BLOCK_OPERATION_QUALIFIER_NONE, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
    ...
    {
        "Parity degraded. Write to one data pos. Non-Retryable error on parity pos on live-stripe write causes RG shutdown."
        "Time_stamp errors during Flush header and data reads are ignored and data is flushed to live stripe."
        "Verify after Flush does not see stamp errors as parity is missing. New data on live stripe.", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x100, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        /* 0x100 blocks will test mr3 for width 3/4, rcw for width 5/6 and 468 for larger widths */
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
         ...
         */
        {
            { FBE_RAID_MAX_DISK_ARRAY_WIDTH - 1,    /* pos to inject error on */
                ...
                0x3800,  /* lba */
                0x800,  /* max number of blocks */
                FBE_API_LOGICAL_ERROR_INJECTION_TYPE_TIME_STAMP,    /* error type */
                FBE_API_LOGICAL_ERROR_INJECTION_MODE_ALWAYS,         /* error mode */
                0x0,  /* error count */
                0x15, /* error limit */
                0x0,  /* skip count */
    ...
    {
        "Parity degraded. Write to 2 data positions. Non-Retryable error on parity pos on live-stripe write causes RG shutdown."
        "Flush during RG activate sees lba_stamp error on header read. Header is reconstructed."
        "Lba_stamp error again on data read. Flush is abandoned. Mix of Old and New data on live stripe (parity is reconstructed).", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x100, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        /* 0x100 blocks will test mr3 for width 3/4, rcw for width 5/6 and 468 for larger widths */
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
    ...
    {/* R6 Bug */
        "Data pos degraded. Write to 2 data positions. Non-Retryable error on data pos on live-stripe write causes RG shutdown."
        "Flush during RG activate sees checksum error on header read. Header is reconstructed."
        "Checksum error again on data read. Flush is abandoned. Stamp mismatch between parity and data positions (missing data pos invalidated).", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x100, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
        ...
        AGENT_KAY_LIVE_STRIPE_DATA_MIXED, /* expected data in live-stripe */
        1, /* Number of I/O errors we expect. */
        { FBE_PAYLOAD_BLOCK_OPERATION_STATUS_MEDIA_ERROR, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
        { FBE_PAYLOAD_BLOCK_OPERATION_QUALIFIER_MEDIA_ERROR_DATA_LOST, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
    ...
    {
        "Data pos degraded. Write to 2 data positions. Non-Retryable error on data pos on live-stripe write causes RG shutdown."
        "Write_stamp error injected on both Header and Data read. Flush SM does not look for write_stamp and time_stamp errors and so flushes the data."
        "Verify after Flush sees write_stamp error. Missing data pos blocks are invalidated.", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x100, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
         */
        {
            ...
            },
            {
                ...
                FBE_PAYLOAD_BLOCK_OPERATION_OPCODE_WRITE,  /* opcode to inject on*/
                1, /* times to insert error. */
                0, /* raid group position to inject -- row pos */
                FBE_TRUE, /* Does drive die as a result of this error? */
                AGENT_KAY_ERROR_LOCATION_USER_DATA, /* Location to inject. */
                0, /* tag value only significant in case b_inc_for_all_drives is true*/
            },
         ...
         */
        {
            { FBE_RAID_MAX_DISK_ARRAY_WIDTH - 1,    /* pos to inject error on */
                ...
                0x3800,  /* lba */
                0x800,  /* max number of blocks */
                FBE_API_LOGICAL_ERROR_INJECTION_TYPE_WRITE_STAMP,    /* error type */
                FBE_API_LOGICAL_ERROR_INJECTION_MODE_ALWAYS,         /* error mode */
                0x0,  /* error count */
                0x15, /* error limit */
                0x0,  /* skip count */
...

    {
        "Data pos degraded. Write to 2 data positions. Non-Retryable error on data pos on live-stripe write causes RG shutdown."
        "Write_stamp error injected on both Header and Data read. Flush SM does not look for write_stamp and time_stamp errors and so flushes the data."
        "Verify after Flush sees time_stamp error. Missing data pos blocks are invalidated.", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x100, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
    ...
    {
        "Data pos degraded. Write to 2 data positions. Incomplete write error on data pos on journal write causes RG shutdown."
        "Flush SM Header read is successful. Flush Data read is successful but data validation sees a csum_of_csums error."
        "Flush is abandoned. Live stripe has old data.", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x100, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
        ...
        {
            {
                ...
                FBE_RAID_MAX_DISK_ARRAY_WIDTH - 1, /* raid group position to inject -- Data pos-0 */
                FBE_TRUE, /* Does drive die as a result of this error? */
                AGENT_KAY_ERROR_LOCATION_WRITE_LOG, /* Location to inject. */
                0, /* tag value only significant in case b_inc_for_all_drives is true*/
            },
            {
                AGENT_KAY_ERROR_TYPE_INCOMPLETE_WRITE,
                FBE_PAYLOAD_BLOCK_OPERATION_OPCODE_WRITE,  /* opcode to inject on*/
                1, /* times to insert error. */
                0, /* raid group position to inject -- Data pos-0 */
                FBE_TRUE, /* Does drive die as a result of this error? */
                AGENT_KAY_ERROR_LOCATION_WRITE_LOG, /* Location to inject. */
                0, /* tag value only significant in case b_inc_for_all_drives is true*/
            },
         ...
         */
        {
            { FBE_RAID_MAX_DISK_ARRAY_WIDTH - 1,    /* pos to inject error on */
                ...
                0x3800,  /* lba */
                0x800,  /* max number of blocks */
                FBE_API_LOGICAL_ERROR_INJECTION_TYPE_SOFT_MEDIA_ERROR,    /* error type */
                FBE_API_LOGICAL_ERROR_INJECTION_MODE_ALWAYS,         /* error mode */
                0x0,  /* error count */
                0x15, /* error limit */
                0x0,  /* skip count */
        ...
        AGENT_KAY_LIVE_STRIPE_DATA_OLD, /* expected data in live-stripe */
        0, /* Number of I/O errors we expect. */
        { FBE_PAYLOAD_BLOCK_OPERATION_STATUS_SUCCESS, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
        { FBE_PAYLOAD_BLOCK_OPERATION_QUALIFIER_NONE, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
...

    {
        ...
        "Time_stamp errors during Flush header and data reads are ignored and data is flushed to live stripe."
        "Verify after Flush does not see stamp errors as parity is missing. New data on live stripe.", __LINE__,
        0x0, /* stripe_num */ 0x17, /* stripe_offset */ 0x93, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        /* 0x100 blocks will test mr3 for width 3/4, rcw for width 5/6 and 468 for larger widths */
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
...

    {
        ...
        "Flush SM Header read is successful. Flush Data read is successful but data validation sees a csum_of_csums error."
        "Flush is abandoned. Live stripe has old data.", __LINE__,
        0x0, /* stripe_num */ 0x3, /* stripe_offset */ 0x15, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
         */
...
/**********************************************
 * end agent_kay_test_cases_single_parity_degraded *
 **********************************************/

/*!*******************************************************************
 * @var agent_kay_test_cases_r6_single_degraded
 *********************************************************************
 * @brief These are single parity degraded cases for R6.
 *********************************************************************/
fbe_agent_kay_error_case_t agent_kay_test_cases_r6_single_degraded[] =
{
    {
...

    {
         ...
         */
        {
            { 0,    /* pos to inject error on */ /* This is also a degraded pos. So, flush does not read from here.*/
                0x10, /* width */
                0x3800,  /* lba */
                0x800,  /* max number of blocks */
                FBE_API_LOGICAL_ERROR_INJECTION_TYPE_CRC,    /* error type */
    ...
    {
        "Single Degraded R6. Non-Retryable error on write to journal causes RG double degraded. Non-Retryable error on write to live-stripe causes RG shutdown."
        "Live stripe write touched diag parity pos. Header reads and data reads see media errors; flush is abandoned. Live-stripe has Old data.", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x10, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
         */
    ...
    {
        "Single Degraded R6. Non-Retryable error on write to journal causes RG double degraded. Non-Retryable error on write to live-stripe causes RG shutdown."
        "Live stripe write did not touch any pos. Header reads successful. Data reads see csum_of_csum error; flush is abandoned. Live-stripe has Old data.", __LINE__,
        0x0, /* stripe_num */ 0x0, /* stripe_offset */ 0x100, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        /* 0x100 blocks will test mr3 for width 3/4, rcw for width 5/6 and 468 for larger widths */
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        ...
        { 6, 12, 16, FBE_U32_MAX}, /* Test all widths. */
        0, /* Expiration time. */ 0, /* No abort msecs. */
        FBE_NOTIFICATION_TYPE_LIFECYCLE_STATE_FAIL, /* Wait for rg to get to this lifecycle state. */
        1, /* Number of I/O errors we expect. */
        { FBE_PAYLOAD_BLOCK_OPERATION_STATUS_IO_FAILED, /* Error we expect. */ AGENT_KAY_INVALID_STATUS},
...
/**********************************************
 * end agent_kay_test_cases_r6_single_degraded *
 **********************************************/

/*!*******************************************************************
 * @var agent_kay_test_cases_r6_single_degraded_extended
 *********************************************************************
 * @brief These are single parity degraded cases for R6.
 *********************************************************************/
fbe_agent_kay_error_case_t agent_kay_test_cases_r6_single_degraded_extended[] =
{
    { /* BUG: R6 Double degraded data corruption */
        "Single Degraded R6. Non-Retryable error on write to journal causes RG double degraded. Non-Retryable error on write to live-stripe causes RG shutdown."
    ...
    { /* BUG: Single degraded R6 data corruption. */
        ...
        0x0, /* stripe_num */ 0x80, /* stripe_offset */ 0x280, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
         */
        {
            {
                ...
                FBE_PAYLOAD_BLOCK_OPERATION_OPCODE_WRITE,  /* opcode to inject on*/
                1, /* times to insert error. */
                6, /* raid group position to inject -- raid group position to inject -- row parity*/
                FBE_TRUE, /* Does drive die as a result of this error? */
                AGENT_KAY_ERROR_LOCATION_USER_DATA, /* Location to inject. */
                0, /* tag value only significant in case b_inc_for_all_drives is true*/
            },
         ...
         */
        {
            { 0,    /* pos to inject error on */
                ...
                0x3800,  /* lba */
                0x800,  /* max number of blocks */
                FBE_API_LOGICAL_ERROR_INJECTION_TYPE_RAID_CRC,    /* error type */
                FBE_API_LOGICAL_ERROR_INJECTION_MODE_ALWAYS,         /* error mode */
                0x0,  /* error count */
                0x15, /* error limit */
                0x0,  /* skip count */
    ...
    {/* VV: Check if timestamps are fixed. */
        "Single Degraded R6. Non-Retryable error on write to journal causes RG double degraded. Non-Retryable error on write to live-stripe causes RG shutdown."
        "Live stripe write touched row parity pos but not diag parity. Header reads and data reads see stamp errors; flush is abandoned. Live-stripe has Invalidated data.", __LINE__,
        0x0, /* stripe_num */ 0x17, /* stripe_offset */ 0x11, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
         */
...

    {
         ...
         */
        {
            { FBE_RAID_MAX_DISK_ARRAY_WIDTH - 1,    /* pos to inject error on */
                ...
                0x3800,  /* lba */
                0x800,  /* max number of blocks */
                FBE_API_LOGICAL_ERROR_INJECTION_TYPE_MULTI_BIT_CRC,    /* error type */
                FBE_API_LOGICAL_ERROR_INJECTION_MODE_ALWAYS,         /* error mode */
                0x0,  /* error count */
                0x15, /* error limit */
                0x0,  /* skip count */
...

    {
        ...
        0x0, /* stripe_num */ 0x13, /* stripe_offset */ 0x15, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
        FBE_FALSE, /* set rg expiration time? */
        FBE_FALSE, /* inc for all drives */
        /* Errors during Write phase.
         */
    ...
    },
    {
        ...
        "Live stripe has new data in both parities and one data pos and has old data in one data pos. Headers are reconstructed but data read fails with media error."
        "Flush is abandoned. Live-stripe has Invalidated data.", __LINE__,
        0x0, /* stripe_num */ 0x17, /* stripe_offset */ 0x193, /* blocks */ FBE_RDGEN_OPERATION_WRITE_ONLY, /* opcode */ 
...
/**********************************************
 * end agent_kay_test_cases_r6_single_degraded_extended *
 **********************************************/


/*!*******************************************************************
 * @def AGENT_KAY_MAX_TABLES_PER_RAID_TYPE
 *********************************************************************
 * @brief Max number of error tables for each raid type.
 *
 *********************************************************************/
#define AGENT_KAY_MAX_TABLES_PER_RAID_TYPE 10

/*!*******************************************************************
 * @var agent_kay_qual_error_cases
 *********************************************************************
 ...
 *
 *********************************************************************/
fbe_agent_kay_error_case_t *agent_kay_qual_error_cases[AGENT_KAY_RAID_TYPE_COUNT][AGENT_KAY_MAX_TABLES_PER_RAID_TYPE] =
{
    /* Raid 5 */
    {
        &agent_kay_test_cases_single_parity_degraded[0],
        NULL /* Terminator */
    },
    /* Raid 3 */
    {
        //&agent_kay_test_cases_single_parity_degraded[0], /* Disabled to meet 1000 sec limit */
        NULL /* Terminator */
    },
    /* Raid 6 */
    {
        &agent_kay_test_cases_r6_single_degraded[0],
        NULL /* Terminator */
    },
};

/*!*******************************************************************
 * @var agent_kay_extended_error_cases
 *********************************************************************
 * @brief This is the set of test cases we will execute for each
 ...
 *
 *********************************************************************/
fbe_agent_kay_error_case_t *agent_kay_extended_error_cases[AGENT_KAY_RAID_TYPE_COUNT][AGENT_KAY_MAX_TABLES_PER_RAID_TYPE] =
{
    /* Raid 5 */
    {
        &agent_kay_test_cases_single_parity_degraded[0],
    ...
    /* Raid 6 */
    {
        //&agent_kay_test_cases_single_parity_degraded[0], /* TODO enable */
        &agent_kay_test_cases_r6_single_degraded[0],
        &agent_kay_test_cases_r6_single_degraded_extended[0],
        NULL /* Terminator */
    },
};

/*!***************************************************************************
 * @var     agent_kay_provision_drive_default_operations
 *****************************************************************************
 * @brief   This simply records the default value for the provision drive
 *          background operations.
 *
 *********************************************************************/
fbe_agent_kay_provision_drive_default_background_operations_t agent_kay_provision_drive_default_operations = { 0};

/*!**************************************************************
 * agent_kay_send_seed_io()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
fbe_status_t agent_kay_send_io(fbe_test_rg_configuration_t *rg_config_p,
 ...
 *
 ****************************************************************/
fbe_status_t agent_kay_send_seed_io(fbe_test_rg_configuration_t *rg_config_p,
                                    fbe_agent_kay_error_case_t *error_case_p,
...
static fbe_status_t agent_kay_wait_for_rebuilds(fbe_test_rg_configuration_t *rg_config_p,
                                                fbe_agent_kay_error_case_t *error_case_p,
                                                fbe_u32_t raid_group_count)
{
    ...
    for ( index = 0; index < raid_group_count; index++)
    {
        ...
        status = fbe_api_wait_for_object_lifecycle_state(object_id, FBE_LIFECYCLE_STATE_READY,
                                                         AGENT_KAY_WAIT_MSEC, FBE_PACKAGE_ID_SEP_0);
        MUT_ASSERT_INT_EQUAL(FBE_STATUS_OK, status);
        ...
        for ( drive_index = 0; drive_index < error_case_p->num_errors; drive_index++)
        {
            ...
            agent_kay_get_drive_position(rg_config_p, &degraded_position);
         ...
         */
        for ( drive_index = 0; drive_index < AGENT_KAY_MAX_DEGRADED_POSITIONS; drive_index++)
        {
            if (agent_kay_get_and_check_degraded_position(rg_config_p,
                                                          error_case_p,
                                                          drive_index,
...
static fbe_status_t agent_kay_get_verify_report(fbe_test_rg_configuration_t *rg_config_p,
                                                fbe_object_id_t lun_object_id,
...
static fbe_status_t agent_kay_wait_for_verify(fbe_test_rg_configuration_t *rg_config_p,
...
fbe_bool_t agent_kay_does_count_match(fbe_u32_t expected_count,
                                      fbe_u32_t actual_count,
                                      fbe_u32_t element_size )
{
    if (expected_count == AGENT_KAY_ERR_COUNT_MATCH)
    {
        /* If FBE_U32_MAX then it is always a match.
         */
        return FBE_TRUE;
    }
    /* If the expected count is AGENT_KAY_ERR_COUNT_MATCH_ELSZ then we match the errors to element size.
     */
    if (expected_count == AGENT_KAY_ERR_COUNT_MATCH_ELSZ)
    {
    ...
    else if (expected_count == AGENT_KAY_ERR_COUNT_NON_ZERO)
    {
...
void agent_kay_validate_io_verify_report_counts(fbe_agent_kay_error_case_t * error_case_p, 
                                                fbe_lun_verify_report_t *verify_report_p,
                                                fbe_u32_t element_size)
{
    ...
    for ( index = 0; index < error_case_p->max_error_cases; index++)
    {
         ...
         */
        if (!agent_kay_does_count_match(error_case_p->correctable_time_stamp[index],
                                        verify_report_p->totals.correctable_time_stamp,
                                        element_size))
        {
            b_match = FBE_FALSE;
        }
        if (!agent_kay_does_count_match(error_case_p->correctable_write_stamp[index],
                                        verify_report_p->totals.correctable_write_stamp,
                                        element_size))
        {
            b_match = FBE_FALSE;
        }
        if (!agent_kay_does_count_match(error_case_p->uncorrectable_time_stamp[index],
                                        verify_report_p->totals.uncorrectable_time_stamp,
                                        element_size))
        {
            b_match = FBE_FALSE;
        }
        if (!agent_kay_does_count_match(error_case_p->uncorrectable_write_stamp[index],
                                        verify_report_p->totals.uncorrectable_write_stamp,
                                        element_size))
        {
            b_match = FBE_FALSE;
        }
        if (!agent_kay_does_count_match(error_case_p->correctable_coherency[index],
...
void agent_kay_validate_verify_report(fbe_agent_kay_error_case_t *error_case_p,
                                      fbe_lun_verify_report_t *verify_report_p,
                                      fbe_u32_t element_size)
{
     ...
     */
    agent_kay_validate_io_verify_report_counts(error_case_p, verify_report_p, element_size);
    return;
}

void agent_kay_cleanup_test_case(fbe_test_rg_configuration_t *rg_config_p,
                                 fbe_agent_kay_error_case_t *error_case_p)
{
    fbe_status_t status;
    fbe_object_id_t lun_object_id;
     ...
     */
    agent_kay_wait_for_verify(rg_config_p, AGENT_KAY_WAIT_MSEC);
    ...
    agent_kay_validate_verify_report(error_case_p, &verify_report, element_size);
...
static fbe_status_t agent_kay_wait_for_verifies(fbe_test_rg_configuration_t *rg_config_p,
                                                fbe_agent_kay_error_case_t *error_case_p,
                                                fbe_u32_t raid_group_count)
{
    fbe_u32_t index;
    ...
    for ( index = 0; index < raid_group_count; index++)
    {
        if (fbe_test_rg_config_is_enabled(rg_config_p))
        {
             ...
             */
            agent_kay_cleanup_test_case(rg_config_p, error_case_p);
        }
        rg_config_p++;
    }
...
static fbe_status_t agent_kay_clear_drive_error_counts(fbe_test_rg_configuration_t *rg_config_p,
                                                       fbe_agent_kay_error_case_t *error_case_p,
    ...
    for ( index = 0; index < raid_group_count; index++)
    {
        if (fbe_test_rg_config_is_enabled(rg_config_p))
        {
            ...
            for ( drive_index = 0; drive_index < num_errors; drive_index++)
            {
                ...
                agent_kay_get_drive_position(rg_config_p, &position);
                agent_kay_get_pdo_object_id(rg_config_p, position, &object_id);
...
static fbe_status_t agent_kay_inject_scsi_error (fbe_protocol_error_injection_error_record_t *record_in_p,
                                                            ...
                                                            fbe_u32_t *degraded_position_p)
{
     ...
     */
    MUT_ASSERT_TRUE(degraded_drive_index < AGENT_KAY_MAX_DEGRADED_POSITIONS);
    *degraded_position_p = error_case_p->degraded_positions[degraded_drive_index];
        ...
        (error_case_p->degraded_positions[degraded_drive_index] != FBE_U32_MAX)    )
    {
         ...
         */
        agent_kay_get_drive_position(raid_group_config_p, degraded_position_p);
        b_position_degraded = FBE_TRUE;
    }
    return(b_position_degraded);
}
static fbe_status_t agent_kay_get_port_enclosure_slot(fbe_test_rg_configuration_t *raid_group_config_p,
                                                      fbe_u32_t drv_pos,
                                                      ...
                                                      fbe_u32_t *slot_number_p )
{
    ...
    agent_kay_get_drive_position(raid_group_config_p, &position_to_inject);
                                                ...
                                                fbe_object_id_t *pdo_object_id_p)
{
    ...
    status = agent_kay_get_port_enclosure_slot(raid_group_config_p, drv_pos,
...
fbe_u8_t agent_kay_get_scsi_command(fbe_payload_block_operation_opcode_t opcode)
{
...
fbe_sata_command_t agent_kay_get_sata_command(fbe_payload_block_operation_opcode_t opcode)
{
...
static void agent_kay_fill_error_record(fbe_test_rg_configuration_t *raid_group_config_p,
                                        fbe_agent_kay_drive_error_definition_t * error_p,
                                        fbe_protocol_error_injection_error_record_t *record_p)
{
     ...
     */
    if (error_p->error_type == AGENT_KAY_ERROR_TYPE_PORT_RETRYABLE)
    {
    ...
    agent_kay_get_scsi_command(error_p->command);
    agent_kay_get_scsi_error(&record_p->protocol_error_injection_error.protocol_error_injection_scsi_error,
                             error_p->error_type);

    if (error_p->error_type == AGENT_KAY_ERROR_TYPE_INCOMPLETE_WRITE)
    {
        record_p->skip_blks = 1; /* Vamsi: hard coded */
    }
    else if (error_p->error_type == AGENT_KAY_ERROR_TYPE_SOFT_MEDIA_ERROR)
    {
...
static void agent_kay_disable_provision_drive_background_operations(fbe_u32_t bus,
                                                                    fbe_u32_t enclosure,
                                                                    fbe_u32_t slot)
{
    fbe_status_t    status;
    ...
    if (agent_kay_provision_drive_default_operations.b_is_initialized == FBE_FALSE)
    {
        ...
        {
            agent_kay_provision_drive_default_operations.b_is_background_zeroing_enabled = FBE_TRUE;
        }
        ...
        {
            agent_kay_provision_drive_default_operations.b_is_sniff_verify_enabled = FBE_TRUE;
        }
        ...
        agent_kay_provision_drive_default_operations.b_is_initialized = FBE_TRUE;
    }
    else
    {
        status = fbe_api_base_config_is_background_operation_enabled(object_id, FBE_PROVISION_DRIVE_BACKGROUND_OP_DISK_ZEROING, &b_is_background_zeroing_enabled);
        MUT_ASSERT_INT_EQUAL(agent_kay_provision_drive_default_operations.b_is_background_zeroing_enabled, b_is_background_zeroing_enabled);
        status = fbe_api_base_config_is_background_operation_enabled(object_id, FBE_PROVISION_DRIVE_BACKGROUND_OP_SNIFF, &b_is_background_sniff_enabled);
        MUT_ASSERT_INT_EQUAL(agent_kay_provision_drive_default_operations.b_is_sniff_verify_enabled, b_is_background_sniff_enabled);
    }
...
static void agent_kay_enable_error_injection(fbe_test_rg_configuration_t *rg_config_p,
                                             fbe_agent_kay_error_case_t *error_case_p,
                                             fbe_agent_kay_drive_error_definition_t *error_p,
                                             fbe_u32_t num_errors,
                                             fbe_protocol_error_injection_record_handle_t *handle_array_p)
{
    ...
    for ( error_index = 0; error_index < num_errors; error_index++)
    {
        ...
        status = agent_kay_get_port_enclosure_slot(rg_config_p, error_p->rg_position_to_inject,
                                                   &port_number, &encl_number, &slot_number);
        MUT_ASSERT_INT_EQUAL(status, FBE_STATUS_OK);

        /* Put the pdo object id into the record.
         */
        agent_kay_get_pdo_object_id(rg_config_p, error_p->rg_position_to_inject, &record.object_id);
        MUT_ASSERT_INT_EQUAL(status, FBE_STATUS_OK);

        if (error_p->location == AGENT_KAY_ERROR_LOCATION_RAID)
        {
        ...
        else if (error_p->location == AGENT_KAY_ERROR_LOCATION_USER_DATA)
        {
        ...
        else if (error_p->location == AGENT_KAY_ERROR_LOCATION_USER_DATA_CHUNK_1)
        {
            /* For now we just inject the error over a chunk.
        ...
        else if (error_p->location == AGENT_KAY_ERROR_LOCATION_PAGED_METADATA)
        {
        ...
        else if (error_p->location == AGENT_KAY_ERROR_LOCATION_WRITE_LOG)
        {
            ...
            MUT_ASSERT_INT_EQUAL(status, FBE_STATUS_OK);
            /* Inject the error just in the write log slot-0.
             */
            record.lba_start  = write_log_info.start_lba;
            record.lba_end    = record.lba_start + write_log_info.slot_size;  /* slot size is now element + 1 header block */
        }
        else
        {
        ...
        if (error_case_p->b_set_rg_expiration_time)
        {
#define AGENT_KAY_PDO_SERVICE_TIME_MS 200
            status = fbe_api_physical_drive_set_service_time(record.object_id, AGENT_KAY_PDO_SERVICE_TIME_MS);
            MUT_ASSERT_INT_EQUAL(status, FBE_STATUS_OK);
        }

        agent_kay_fill_error_record(rg_config_p, error_p, &record);
        record.lba_start += AGENT_KAY_BASE_OFFSET;
        record.lba_end += AGENT_KAY_BASE_OFFSET;
        ...
        if (error_p->error_type == AGENT_KAY_ERROR_TYPE_PORT_RETRYABLE)
        {
            ...
            agent_kay_disable_provision_drive_background_operations(port_number, encl_number, slot_number);
        }

        status = agent_kay_inject_scsi_error(&record, &handle_array_p[error_index]);
        MUT_ASSERT_INT_EQUAL(status, FBE_STATUS_OK);
...
#if 0
static fbe_status_t agent_kay_check_for_errors(fbe_raid_group_type_t raid_type,
                                               fbe_object_id_t rg_object_id,
...
#endif
static fbe_status_t agent_kay_enable_logical_error_injection(fbe_api_logical_error_injection_record_t * record_p,
                                                             fbe_u32_t num_errors, fbe_test_rg_configuration_t *rg_config_p,
                                                             fbe_object_id_t rg_object_id)
{
    fbe_status_t status;
    fbe_u32_t lei_pos;
    fbe_api_logical_error_injection_record_t record_copy;
    fbe_parity_get_write_log_info_t             write_log_info;
    fbe_u32_t error_index;
    ...
    for (error_index = 0; error_index < num_errors; error_index++)
    {
        fbe_copy_memory(&record_copy, record_p, sizeof(fbe_api_logical_error_injection_record_t));

        /* Figure out position for error record */
        lei_pos = record_p->pos_bitmap; /* Note this field is being used as pos not bitmap  */  
        agent_kay_get_drive_position(rg_config_p, &lei_pos);
        record_copy.pos_bitmap = ((fbe_u16_t)0x1 << lei_pos); /* convert from pos to bitmap */
        ...
        /* hardcoded to slot-0.
         */
        record_copy.lba  = write_log_info.start_lba;
        record_copy.blocks = write_log_info.slot_size;  /* slot size is now element + 8 header block */

        /* Add our own records.
         */
        status = fbe_api_logical_error_injection_create_record(&record_copy);
        MUT_ASSERT_INT_EQUAL(status, FBE_STATUS_OK);

        /* Increment to next error record */
        record_p++;
    }
...
static fbe_status_t agent_kay_corrupt_paged_metadata(fbe_test_rg_configuration_t *rg_config_p,
                                                     fbe_agent_kay_error_case_t *error_case_p,
                                                     fbe_agent_kay_drive_error_definition_t *error_p,
                                                     fbe_u32_t num_errors)
{
    ...
    /* Insert (1) additional NR bit for each error.
     */
    for (error_index = 0; error_index < num_errors; error_index++)
    {
        /* We expect the error type to be unexpected.
         */
        MUT_ASSERT_INT_EQUAL(FBE_PAYLOAD_BLOCK_OPERATION_STATUS_INVALID_REQUEST, error_case_p->block_status[0]);
        MUT_ASSERT_INT_EQUAL(FBE_PAYLOAD_BLOCK_OPERATION_QUALIFIER_TOO_MANY_DEAD_POSITIONS, error_case_p->block_qualifier[0]);

        /* This method only supports errors in the user area.
         */
        if (error_p->location == AGENT_KAY_ERROR_LOCATION_USER_DATA)
        {
            /* For now we just inject the error over a chunk.
             */
            error_lba = 0x0;
            error_blocks = FBE_RAID_DEFAULT_CHUNK_SIZE;
        }
        else if (error_p->location == AGENT_KAY_ERROR_LOCATION_USER_DATA_CHUNK_1)
        {
            /* For now we just inject the error over a chunk.
             * The chunk we inject on depends on the error index.
             */
            error_lba = FBE_RAID_DEFAULT_CHUNK_SIZE;
            error_blocks = FBE_RAID_DEFAULT_CHUNK_SIZE;
        }
        else
        {
         ...
         */
        status = fbe_test_sep_rebuild_utils_corrupt_paged_metadata(rg_config_p, error_lba, error_blocks);
        MUT_ASSERT_INT_EQUAL(FBE_STATUS_OK, status);
...
static void agent_kay_enable_provision_drive_background_operations(fbe_u32_t bus,
                                                                   fbe_u32_t enclosure,
                                                                   fbe_u32_t slot)
{
    fbe_status_t    status;
    ...
    MUT_ASSERT_INT_EQUAL(agent_kay_provision_drive_default_operations.b_is_initialized, FBE_TRUE);

    /* Enable those provision drive operations that were enabled by default.*/
    if (agent_kay_provision_drive_default_operations.b_is_background_zeroing_enabled == FBE_TRUE)
    {
        status = fbe_api_base_config_enable_background_operation(object_id, FBE_PROVISION_DRIVE_BACKGROUND_OP_DISK_ZEROING);
        MUT_ASSERT_INT_EQUAL(FBE_STATUS_OK, status);
    }
    if (agent_kay_provision_drive_default_operations.b_is_sniff_verify_enabled == FBE_TRUE)
    {
...
static void agent_kay_disable_error_injection(fbe_test_rg_configuration_t *rg_config_p,
                                              fbe_agent_kay_drive_error_definition_t *error_p,
                                              fbe_u32_t num_errors,
                                              fbe_protocol_error_injection_record_handle_t *handle_p)
{
    ...
    for ( error_index = 0; error_index < num_errors; error_index++)
    {
        ...
        {
            MUT_ASSERT_INT_EQUAL(1, num_errors);
            agent_kay_enable_provision_drive_background_operations(port_number, encl_number, slot_number);
        }
...
static fbe_status_t agent_kay_disable_logical_error_injection(void)
{
    fbe_status_t status;
...
void agent_kay_verify_pvd(fbe_test_raid_group_disk_set_t *drive_to_insert_p)
{
    fbe_status_t    status;
...
/******************************************
 * end agent_kay_verify_pvd()
 ******************************************/
void agent_kay_enable_trace_flags(fbe_object_id_t object_id)
...
void agent_kay_disable_trace_flags(fbe_object_id_t object_id)
...
void agent_kay_reset_drive_state(fbe_test_rg_configuration_t *rg_config_p,
                                 fbe_agent_kay_drive_error_definition_t *error_p)
{
    fbe_status_t status;
    ...
    status = agent_kay_get_pdo_object_id(rg_config_p, position, &pdo_object_id);
    ...
    agent_kay_verify_pvd(&rg_config_p->rg_disk_set[position]);
    return;
}

void agent_kay_reinsert_drives(fbe_test_rg_configuration_t *rg_config_p,
                               fbe_agent_kay_drive_error_definition_t *error_p,
                               fbe_u32_t num_errors)
{
    fbe_u32_t drive_index;
    for ( drive_index = 0; drive_index < num_errors; drive_index++)
    {
        agent_kay_reset_drive_state(rg_config_p, error_p);
        error_p++;
    }
}

void agent_kay_degrade_raid_groups(fbe_test_rg_configuration_t *rg_config_p,
                                   fbe_agent_kay_error_case_t *error_case_p)
{
    fbe_u32_t index;
    ...
    for ( index = 0; index < AGENT_KAY_MAX_DEGRADED_POSITIONS; index++)
    {
        if (agent_kay_get_and_check_degraded_position(rg_config_p,
                                                      error_case_p,
                                                      index,
...
void agent_kay_restore_raid_groups(fbe_test_rg_configuration_t *rg_config_p,
                                   fbe_agent_kay_error_case_t *error_case_p,
...
void agent_kay_validate_io_error_counts(fbe_raid_verify_error_counts_t *io_error_counts_p)
{
...
/* This function is created since even though the drive dies metadata service will
   ...
   and agent_kay will fail infrequently where retryable error will be one greater than expected
*/
fbe_bool_t agent_kay_does_retry_count_match(fbe_u32_t expected_count,
                                            fbe_u32_t actual_count,
                                            fbe_u32_t element_size )
{
    if (expected_count == AGENT_KAY_ERR_COUNT_MATCH)
...
void agent_kay_validate_io_status_for_error_case(fbe_agent_kay_error_case_t *error_case_p, 
                                                 fbe_api_rdgen_context_t *context_p)
{
    /* Handle more than one error case and return a status.
     */
    ...
    for ( index = 0; index < AGENT_KAY_MAX_POSSIBLE_STATUS; index++)
    {
        if ((error_case_p->block_status[index] != AGENT_KAY_INVALID_STATUS) &&
...
void agent_kay_validate_io_error_counts_for_error_case(fbe_agent_kay_error_case_t * error_case_p, 
                                                       ...
                                                       fbe_u32_t element_size)
{
    ...
    for ( index = 0; index < error_case_p->max_error_cases; index++)
    {
        ...
        */
        if (!agent_kay_does_retry_count_match(error_case_p->retryable_error_count[index],
...
void agent_kay_enable_trace_flags_for_raid_group(fbe_test_rg_configuration_t *rg_config_p)
{
    fbe_status_t status;
    fbe_u32_t drive_index;
    fbe_object_id_t object_id;
...
void agent_kay_disable_trace_flags_for_raid_group(fbe_test_rg_configuration_t *rg_config_p)
{
    fbe_status_t status;
    fbe_u32_t drive_index;
    fbe_object_id_t object_id;
...
void agent_kay_setup_test_case(fbe_test_rg_configuration_t *rg_config_p,
                               fbe_agent_kay_error_case_t *error_case_p,
                               fbe_api_rdgen_context_t *context_p,
                               ...
                               fbe_protocol_error_injection_record_handle_t *error_handles_p)
{
     ...
     */
    agent_kay_degrade_raid_groups(rg_config_p, error_case_p);
    ...
    mut_printf(MUT_LOG_TEST_STATUS, "set raid library debug flags 0x%x\n", current_debug_flags | default_debug_flags);
...
void agent_kay_wait_for_state(fbe_test_rg_configuration_t *rg_config_p,
                              fbe_agent_kay_error_case_t *error_case_p,
                              fbe_api_rdgen_context_t *context_p,
                              fbe_test_common_util_lifecycle_state_ns_context_t *ns_context_p,
                              fbe_protocol_error_injection_record_handle_t *error_handles_p)
{
    if (error_case_p->wait_for_state_mask != FBE_NOTIFICATION_TYPE_INVALID)
    {
         ...
         * initialized above. 
         */
        fbe_test_common_util_wait_lifecycle_state_notification(ns_context_p, AGENT_KAY_WAIT_MSEC);
        fbe_test_common_util_unregister_lifecycle_state_notification(ns_context_p);
    }
}
void agent_kay_validate_io_op(fbe_api_rdgen_context_t *context_p, fbe_u32_t io_err_cnt, 
 ...
 *
 ****************************************************************/
fbe_status_t agent_kay_retry_test_case(fbe_test_rg_configuration_t *rg_config_p,
                                       fbe_agent_kay_error_case_t *error_case_p)
{
    fbe_status_t status;
    fbe_protocol_error_injection_record_handle_t error_handles[AGENT_KAY_MAX_RG_COUNT][AGENT_KAY_ERROR_CASE_MAX_ERRORS];
    fbe_test_common_util_lifecycle_state_ns_context_t ns_context[AGENT_KAY_MAX_RG_COUNT];
    fbe_u32_t rg_index;
    fbe_u32_t num_raid_groups = fbe_test_get_rg_array_length(rg_config_p);
    fbe_test_rg_configuration_t *current_rg_config_p;
    fbe_api_rdgen_context_t context[AGENT_KAY_MAX_RG_COUNT];
    fbe_object_id_t rg_object_id[AGENT_KAY_MAX_RG_COUNT];
    fbe_status_t io_status;
    fbe_lba_t lba[AGENT_KAY_MAX_RG_COUNT];
    fbe_lba_t stripe_start_lba[AGENT_KAY_MAX_RG_COUNT]; 
    fbe_block_count_t stripe_blk_cnt[AGENT_KAY_MAX_RG_COUNT];
    fbe_object_id_t lun_object_id;
    fbe_u32_t expected_pass;
    fbe_bool_t pre_check[AGENT_KAY_MAX_RG_COUNT];
    fbe_bool_t post_check[AGENT_KAY_MAX_RG_COUNT];
    fbe_block_count_t elsz;
    fbe_u32_t num_stripes_per_parity = 8; /* FBE_RAID_ELEMENTS_PER_PARITY, FBE_RAID_ELEMENTS_PER_PARITY_BANDWIDTH */
    fbe_rdgen_operation_t rdgen_op;
    fbe_u32_t num_errors;

    /* If this is the `corrupt paged metadata' case it will result in ERROR
     * traces.  We won't allow CRITICAL errors but we must allow ERRORs. 
     */
    if (agent_kay_is_corrupt_paged_metadata_error_case(error_case_p))
    {
        /* Corrupting the paged will result in error traces.  So don't stop.
         */
    ...
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            ...
            agent_kay_send_seed_io(current_rg_config_p, error_case_p, &context[rg_index], FBE_RDGEN_PATTERN_LBA_PASS, 
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            agent_kay_setup_test_case(current_rg_config_p, error_case_p, &context[rg_index],
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            ...
            agent_kay_enable_error_injection(current_rg_config_p, error_case_p, &error_case_p->errors[0], 
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
             ...
             */
            io_status = agent_kay_send_io(current_rg_config_p, &context[rg_index], FBE_RDGEN_OPERATION_WRITE_ONLY,
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            ...
            if (!agent_kay_is_corrupt_paged_metadata_error_case(error_case_p))
            {
                agent_kay_validate_io_status_for_error_case(error_case_p, &context[rg_index]); 
            }

            /* Make sure the io error counts make sense
             */
            agent_kay_validate_io_error_counts(io_error_counts_p);

            /* Validate the verify counts attached to the io.
             */
            element_size = fbe_test_sep_util_get_element_size(current_rg_config_p);
            agent_kay_validate_io_error_counts_for_error_case(error_case_p, io_error_counts_p, element_size);
        }
        current_rg_config_p++;
    }
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            ...
            agent_kay_disable_error_injection(current_rg_config_p, &error_case_p->errors[0], 
                                              num_errors, &error_handles[rg_index][0]);
        }
        current_rg_config_p++;
    }
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            ...
            agent_kay_clear_drive_error_counts(current_rg_config_p, error_case_p, 1, num_errors);

            /* Reinsert drives that failed due to errors.
             */
            agent_kay_reinsert_drives(current_rg_config_p, &error_case_p->errors[0], num_errors);
        }
        current_rg_config_p++;
    }
    ...
    /* Next few steps are executed per RG as lei records need to be added based on RG width */
    current_rg_config_p = rg_config_p;
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        /* Step-12: Setup logical error records and enable injection (for Flush SM) */
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            /* If the error should cause a paged metadata reconstruct set the debug hook
             */
            if (agent_kay_is_corrupt_paged_metadata_error_case(error_case_p))
            {
                /* Add debug hook to validate that we go thru paged reconstruct.
                 */
                status = fbe_api_scheduler_add_debug_hook(rg_object_id[rg_index],
                ...
                /* Now corrupt the paged metadata
                 */
                status = agent_kay_corrupt_paged_metadata(current_rg_config_p, error_case_p, 
                                                          &error_case_p->errors[0], num_errors);
                MUT_ASSERT_INT_EQUAL(FBE_STATUS_OK, status);
            }
            else
            {
                ...
                status = agent_kay_enable_logical_error_injection(&error_case_p->flush_errors[0], num_errors, 
                                                                  current_rg_config_p, rg_object_id[rg_index]);
                MUT_ASSERT_INT_EQUAL(FBE_STATUS_OK, status);
            }
        }
        ...
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            /* Remove the debug hook for flsuh start and add one for flush done.
             */
            status = fbe_api_scheduler_add_debug_hook(rg_object_id[rg_index],
                                                      SCHEDULER_MONITOR_STATE_RAID_GROUP_JOURNAL_FLUSH,
            ...
            if (agent_kay_is_corrupt_paged_metadata_error_case(error_case_p))
            {
                /* Wait for debug hook to validate that we go thru paged reconstruct.
                 */
                status = fbe_test_wait_for_debug_hook(rg_object_id[rg_index], 
                                                      SCHEDULER_MONITOR_STATE_RAID_GROUP_ACTIVATE,
                                                      FBE_RAID_GROUP_SUBSTATE_PAGED_RECONSTRUCT_SETUP,
        ...
        /* Step-16: Remove logical error records and disable injection */

        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            status = fbe_api_logical_error_injection_disable_object(rg_object_id[rg_index], FBE_PACKAGE_ID_SEP_0);
            MUT_ASSERT_INT_EQUAL(FBE_STATUS_OK, status);
        }
        agent_kay_disable_logical_error_injection();
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if ((agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p)) && (pre_check[rg_index]))
        {
            /* Send I/O.  This is an asynchronous send.
             */
            io_status = agent_kay_send_io(current_rg_config_p, &context[rg_index], FBE_RDGEN_OPERATION_READ_CHECK,
                                          error_case_p->expiration_msecs, error_case_p->abort_msecs, 
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if ((agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p)) && (pre_check[rg_index]))
        {
            agent_kay_validate_io_op(&context[rg_index], error_case_p->pre_io_err_cnt, 
    ...
    if (error_case_p->expected_data == AGENT_KAY_LIVE_STRIPE_DATA_NEW)
    {
        rdgen_op = FBE_RDGEN_OPERATION_READ_CHECK; 
        expected_pass = (error_case_p->line + 1);
    }
    else if (error_case_p->expected_data == AGENT_KAY_LIVE_STRIPE_DATA_OLD)
    {
        rdgen_op = FBE_RDGEN_OPERATION_READ_CHECK;
        expected_pass = error_case_p->line;
    }
    else if (error_case_p->expected_data == AGENT_KAY_LIVE_STRIPE_DATA_MIXED)
    {
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            /* Send I/O.  This is an asynchronous send.
             */
            io_status = agent_kay_send_io(current_rg_config_p, &context[rg_index], rdgen_op,
                                          error_case_p->expiration_msecs, error_case_p->abort_msecs, 
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            agent_kay_validate_io_op(&context[rg_index], error_case_p->live_io_err_cnt, 
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if ((agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p)) && (post_check[rg_index]))
        {
            /* Send I/O.  This is an asynchronous send.
             */
            io_status = agent_kay_send_io(current_rg_config_p, &context[rg_index], FBE_RDGEN_OPERATION_READ_CHECK,
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if ((agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p)) && (post_check[rg_index]))
        {
            agent_kay_validate_io_op(&context[rg_index], error_case_p->post_io_err_cnt, 
    ...
    for ( rg_index = 0; rg_index < num_raid_groups; rg_index++)
    {
        if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
        {
            agent_kay_restore_raid_groups(current_rg_config_p, error_case_p, rg_object_id[rg_index]);
        }
        current_rg_config_p++;
    }
    ...
    if (agent_kay_is_rg_valid_for_error_case(error_case_p, current_rg_config_p))
    {
        agent_kay_wait_for_verifies(current_rg_config_p, error_case_p, num_raid_groups);
    }
...
//            fbe_bool_t b_chk_remap = agent_kay_is_error_case_media_error(error_case_p, current_rg_config_p);
    ...
    /* If this is the `corrupt paged metadata' case it will result in ERROR
     * traces.  We won't allow CRITICAL errors but we must allow ERRORs.
     * Clear the ERROR trace counter so that the test will pass.
     */
    if (agent_kay_is_corrupt_paged_metadata_error_case(error_case_p))
    {
        /* Corrupting the paged will result in error traces.  Clear the
         * counters now.
         */
...
fbe_u32_t agent_kay_get_table_case_count(fbe_agent_kay_error_case_t *error_case_p)
{
...
fbe_u32_t agent_kay_get_test_case_count(fbe_agent_kay_error_case_t *error_case_p[])
{
    ...
    while (error_case_p[table_index] != NULL)
    {
         ...
         */
        test_case_count += agent_kay_get_table_case_count(&error_case_p[table_index][0]);
        table_index++;
    }
    return test_case_count;
}
fbe_u32_t agent_kay_get_num_error_positions(fbe_agent_kay_error_case_t *error_case_p)
{
    fbe_u32_t index;
...
fbe_bool_t agent_kay_is_width_valid_for_error_case(fbe_agent_kay_error_case_t *error_case_p,
                                                   fbe_u32_t width)
{
    fbe_u32_t index = 0;
    fbe_u32_t num_err_positions = agent_kay_get_num_error_positions(error_case_p);
...
fbe_u32_t agent_kay_error_case_num_valid_widths(fbe_agent_kay_error_case_t *error_case_p)
{
    fbe_u32_t index = 0;
                                                ...
                                                fbe_test_rg_configuration_t *rg_config_p)
{
    ...
    if (!agent_kay_is_width_valid_for_error_case(error_case_p, rg_config_p->width))
    {
        b_status = FBE_FALSE;
    }
    if (!fbe_test_rg_config_is_enabled(rg_config_p))
                                               ...
                                               fbe_test_rg_configuration_t *rg_config_p)
{
    ...
    {
        if ((error_case_p->flush_errors[idx].err_type == FBE_API_LOGICAL_ERROR_INJECTION_TYPE_SOFT_MEDIA_ERROR) ||
            (error_case_p->flush_errors[idx].err_type == FBE_API_LOGICAL_ERROR_INJECTION_TYPE_MEDIA_ERROR))
        {
            return FBE_TRUE; 
        }
    }
...
fbe_bool_t agent_kay_is_corrupt_paged_metadata_error_case(fbe_agent_kay_error_case_t *error_case_p)
{
    ...
    if ((error_case_p->block_status[0] == FBE_PAYLOAD_BLOCK_OPERATION_STATUS_INVALID_REQUEST)               &&
        (error_case_p->block_qualifier[0] == FBE_PAYLOAD_BLOCK_OPERATION_QUALIFIER_TOO_MANY_DEAD_POSITIONS)    )
    {
         b_status = FBE_TRUE;
    }
    return b_status;
...
void agent_kay_run_test_case_for_all_raid_groups(fbe_test_rg_configuration_t *rg_config_p,
                                                 fbe_agent_kay_error_case_t *error_case_p,
                                                 ...
                                                 fbe_u32_t table_test_case_count)
{
    ...
    status = agent_kay_retry_test_case(rg_config_p, error_case_p);
...
fbe_status_t agent_kay_retry_test(fbe_test_rg_configuration_t *rg_config_p,
                                  fbe_agent_kay_error_case_t *error_case_p[],
                                  fbe_u32_t num_raid_groups)
{
    fbe_u32_t test_index = 0;
    fbe_u32_t table_test_index;
    fbe_u32_t total_test_case_count = agent_kay_get_test_case_count(error_case_p);
    const fbe_char_t *raid_type_string_p = NULL;
    ...
    b_abort_expiration_only = fbe_test_sep_util_get_cmd_option("-abort_cases_only");mut_printf(MUT_LOG_TEST_STATUS, "agent_kay start_table: %d start_index: %d total_cases: %d abort_only: %d",start_table_index, start_test_index, max_case_count, b_abort_expiration_only);
    ...
    while (error_case_p[table_index] != NULL)
    {
        ...
        table_test_index = 0;
        table_test_count = agent_kay_get_table_case_count(&error_case_p[table_index][0]);
        ...
        while (error_case_p[table_index][table_test_index].blocks != 0)
        {
            ...
            while (current_iteration < repeat_count)
            {
                 ...
                 */
                agent_kay_run_test_case_for_all_raid_groups(rg_config_p, 
                ...
                if (repeat_count > 1)
                {
                    mut_printf(MUT_LOG_TEST_STATUS, "agent_kay completed test case iteration [%d of %d]", current_iteration, repeat_count);
                }
            }
            agent_kay_unset_rg_options();
            time = fbe_get_time();
...
void agent_kay_test_rg_config(fbe_test_rg_configuration_t *rg_config_p, void * context_p)
{
    fbe_status_t                status = FBE_STATUS_OK;
    fbe_u32_t                   raid_group_count = fbe_test_get_rg_array_length(rg_config_p);
    fbe_agent_kay_error_case_t  **error_cases_p = NULL;
    error_cases_p = (fbe_agent_kay_error_case_t **) context_p; 

    mut_printf(MUT_LOG_TEST_STATUS, "running agent_kay test");
    ...
    */
    agent_kay_retry_test(rg_config_p, error_cases_p, raid_group_count);
...
void agent_kay_test(fbe_u32_t raid_type_index)
{
     ...
     */
    FBE_ASSERT_AT_COMPILE_TIME(AGENT_KAY_MAX_DEGRADED_POSITIONS == 8);
    ...
    if (extended_testing_level == 0)
    {
        /* Qual.
         */
        error_cases_p = agent_kay_qual_error_cases[raid_type_index];
        rg_config_p = &agent_kay_raid_group_config_qual[raid_type_index][0];
    }
    else
    {
        /* Extended. 
         */
        error_cases_p = agent_kay_extended_error_cases[raid_type_index];
        rg_config_p = &agent_kay_raid_group_config_extended[raid_type_index][0];
    }
    fbe_test_sep_util_get_raid_type_string(rg_config_p->raid_type, &raid_type_string_p);
...
void agent_kay_setup(fbe_u32_t raid_type_index)
{
    ...
    if (fbe_test_util_is_simulation())
    {
        ...
        if (extended_testing_level == 0)
        {
            /* Qual.
             */
            array_p = &agent_kay_raid_group_config_qual[0];
        }
        else
        {
            /* Extended. 
             */
            array_p = &agent_kay_raid_group_config_extended[0];
        }
...
/******************************************
 * end agent_kay_cleanup()
 ******************************************/

void agent_kay_test_r5()
{
    agent_kay_test(AGENT_KAY_RAID_TYPE_RAID5);
}

void agent_kay_test_r6()
{
    agent_kay_test(AGENT_KAY_RAID_TYPE_RAID6);
}

void agent_kay_test_r3() 
{
    agent_kay_test(AGENT_KAY_RAID_TYPE_RAID3);
}

void agent_kay_setup_r5()
{
    agent_kay_setup(AGENT_KAY_RAID_TYPE_RAID5);
}

void agent_kay_setup_r6()
{
    agent_kay_setup(AGENT_KAY_RAID_TYPE_RAID6);
}

void agent_kay_setup_r3() 
{
    agent_kay_setup(AGENT_KAY_RAID_TYPE_RAID3);
}

/*************************
 * end file agent_kay_test.c
 *************************/
