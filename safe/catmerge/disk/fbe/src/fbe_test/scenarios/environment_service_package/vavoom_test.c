 ...
 *
 * @brief
 *  This file contains the functions to test Single SP Enclosure firmware upgrade
...
char * vavoom_short_desc = "Test Single SP LCC firmware upgrade state transition and queuing logic.";
char * vavoom_long_desc =
    "\n"
    "\n"
    "The vavoom scenario tests Single SP enclosure firmware upgrade state transition and queuing logic.\n"
    "It includes: \n"
