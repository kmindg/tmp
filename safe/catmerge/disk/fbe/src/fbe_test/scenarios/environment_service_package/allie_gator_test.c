...
/*!**************************************************************************
 * @file allie_gator_test.c
 ***************************************************************************
 *
 * @brief
 *  This file contains the functions to test Naga 12 DAE LCC and PS firmware upgrade
...
char * allie_gator_short_desc = "Test Naga 12 DAE LCC and PS firmware upgrade state transition and queuing logic.";
char * allie_gator_long_desc =
    "\n"
    "\n"
    "The allie_gator scenario tests Naga DAE firmware upgrade state transition and queuing logic.\n"
    "It includes: \n"
...
fbe_u32_t allie_gator_test_get_num_of_tests(void)
{
 ...
 ****************************************************************
 * @brief
 *  Main entry point for Naga 12G enclosure firmware upgrade.
 *
 * @param None.               
 *
 * @return None.
...
void allie_gator_test(void)
{
    ...
    numOfTests = allie_gator_test_get_num_of_tests();
    ...
    for(fupDevice = TEST_IOSXP; fupDevice < numOfTests; fupDevice++)
    {
        ...
        mut_printf(MUT_LOG_LOW, "    Initiate Naga %s FUP %d_%d_%d(%d)",
