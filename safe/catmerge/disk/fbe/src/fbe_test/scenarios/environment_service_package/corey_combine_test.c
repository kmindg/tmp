...
char * corey_combine_short_desc = "Test Tabasco 12G DAE LCC firmware upgrade state transition and queuing logic.";
char * corey_combine_long_desc =
    "\n"
    "\n"
    "The corey_combine scenario tests Tabasco 12G DAE LCC firmware upgrade state transition and queuing logic.\n"
    "It includes: \n"
