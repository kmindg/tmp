...
/*!**************************************************************************
 * @file scooby_dum_physical_config.c
 ***************************************************************************
 *
 * @brief
 *  This file contains physical configuration setup for the Scooby Dum tests.
 *
 * @version
...
/*!*******************************************************************
 * @def SCOOBY_DUM_TEST_NUMBER_OF_PHYSICAL_OBJECTS
 *********************************************************************
 * @brief Number of objects we will create.
 *        (1 board + 2 port + 1 encl + 15 pdo) 
 * Note: Whenever we change make sure to change in scooby_dum_test.c file.
 *********************************************************************/
#define SCOOBY_DUM_TEST_NUMBER_OF_PHYSICAL_OBJECTS 19


/*!*******************************************************************
 * @def SCOOBY_DUM_TEST_DRIVE_CAPACITY
 *********************************************************************
 * @brief Number of blocks in the physical drive.
 *
 * Note: change the drive capacity to smaller to reduce zeroing test time
 *********************************************************************/
#define SCOOBY_DUM_TEST_DRIVE_CAPACITY (TERMINATOR_MINIMUM_NON_SYSTEM_DRIVE_CAPACITY/2)
...
/*!**************************************************************
 * scooby_dum_physical_config()
 ****************************************************************
 * @brief
 *  Configure the Scooby Dum test's physical configuration.
 *
 * @param None.              
 *
 * @return None.
...
void scooby_dum_physical_config(void)
{
    ...
    {
        fbe_test_pp_util_insert_sas_drive(0, 0, slot, 520, SCOOBY_DUM_TEST_DRIVE_CAPACITY, &drive_handle);
    }
    ...
    status = fbe_api_wait_for_number_of_objects(SCOOBY_DUM_TEST_NUMBER_OF_PHYSICAL_OBJECTS, 20000, FBE_PACKAGE_ID_PHYSICAL);
    ...
    MUT_ASSERT_TRUE(total_objects == SCOOBY_DUM_TEST_NUMBER_OF_PHYSICAL_OBJECTS);
    mut_printf(MUT_LOG_LOW, "Verifying object count...Passed");

	for (object_id = 0 ; object_id < SCOOBY_DUM_TEST_NUMBER_OF_PHYSICAL_OBJECTS; object_id++){
...
/******************************************
 * end scooby_dum_physical_config()
 ******************************************/

/*************************
 * end file scooby_dum_physical_config.c
 *************************/
