...
void eliot_rosewater_config_init(void)
{
#define NUMBER_OF_OBJECTS 16 /* 1 board, 1 port, 1 enclosure, 13 PDOs */
    ...
    if(fbe_test_util_is_simulation())
    {
        ...
        mut_printf(MUT_LOG_LOW, "=== init Eliot Rosewater configuration ===\n");
...
void eliot_rosewater_config_destroy(void)
{
    mut_printf(MUT_LOG_LOW, "=== Eliot Rosewater destroy configuration ===\n");
    if(fbe_test_util_is_simulation())
    {
