...
extern "C" void
sep_external_fast_queue_push_queue_element(fbe_queue_element_t *queue_element, fbe_cpu_id_t cpu_id);

extern void * __cdecl operator new( size_t   size, void  *pBuffer );
...
sep_external_fast_queue_push_queue_element(fbe_queue_element_t *queue_element, fbe_cpu_id_t cpu_id)
{
    ...
    class EmbeddedWaiterQC_FastGroup : public BasicWaiter {
    public:
        ...
        BasicWaiterQueuingClass GetQueuingClass() const CSX_CPP_OVERRIDE { return QC_FastGroup; }
    };    
    ...
    BasicWaiter * waiter = new((void*)queue_element) EmbeddedWaiterQC_FastGroup();
