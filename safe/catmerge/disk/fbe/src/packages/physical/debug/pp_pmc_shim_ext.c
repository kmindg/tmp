...
static char CSX_MAYBE_UNUSED usageMsg_pp_display_mp_shim_table[] =
...
CSX_DBG_EXT_DEFINE_CMD(pp_display_mp_shim_table, "pp_display_mp_shim_table")
{
...
static char CSX_MAYBE_UNUSED usageMsg_pp_display_mp_shim_port_info[] =
...
CSX_DBG_EXT_DEFINE_CMD(pp_display_mp_shim_port_info, "pp_display_mp_shim_port_info")
{
	fbe_u32_t port_number = 0,portal_number = 0;
	fbe_u32_t port_handle = 0;
	fbe_dbgext_ptr pmc_port_array_ptr = 0;
...
static char CSX_MAYBE_UNUSED usageMsg_pp_display_port_obj_dev_table[] =
"!pp_display_port_obj_dev_table <port object ID>\n"
"  Display port object's device table contents.\n";
#pragma data_seg ()

CSX_DBG_EXT_DEFINE_CMD(pp_display_port_obj_dev_table, "pp_display_port_obj_dev_table")
{
