...
{
    fbe_sas_ramhorn_enclosure_t * ramhornPrvtData = (fbe_sas_ramhorn_enclosure_t *)enclPrvtData;
    fbe_eses_enclosure_print_prvt_data((void *)&(ramhornPrvtData->eses_enclosure), trace_func, trace_context);
}
// End of file fbe_sas_ramhorn_enclosure_utils.c
