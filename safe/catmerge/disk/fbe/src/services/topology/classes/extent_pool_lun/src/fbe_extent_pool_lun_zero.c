...
static fbe_status_t  fbe_ext_pool_lun_zero_start_lun_zeroing_completion(fbe_packet_t * packet_p,
                                                               fbe_packet_completion_context_t context);

/* completion function to get the raid extent zero checkpoint. */
static fbe_status_t fbe_ext_pool_lun_zero_get_raid_extent_zero_checkpoint_completion(fbe_packet_t * packet_p,
                                                                            fbe_packet_completion_context_t context);

/* completion function for lun zeroing packet allocation */
static fbe_status_t
fbe_ext_pool_lun_zero_start_lun_zeroing_packet_allocation_completion(fbe_memory_request_t * memory_request, 
...
/*!****************************************************************************
 * fbe_ext_pool_lun_zero_start_lun_zeroing_packet_allocation()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t
fbe_ext_pool_lun_zero_start_lun_zeroing_packet_allocation(fbe_ext_pool_lun_t * lun_p, fbe_packet_t * packet_p)
{
    ...
    fbe_memory_build_chunk_request(memory_request_p,
                                   ...
                                   (fbe_memory_completion_function_t)fbe_ext_pool_lun_zero_start_lun_zeroing_packet_allocation_completion,
                                   lun_p);
...
/******************************************************************************
 * end fbe_ext_pool_lun_zero_start_lun_zeroing_packet_allocation()
 ******************************************************************************/


/*!****************************************************************************
 * fbe_ext_pool_lun_zero_start_lun_zeroing_packet_allocation_completion()
 ******************************************************************************
 * @brief
                                                              ...
                                                              fbe_memory_completion_context_t context)
{
    ...
    fbe_transport_set_completion_function(new_packet_p, fbe_ext_pool_lun_zero_start_lun_zeroing_completion, lun_p);
	...
	if(status == FBE_STATUS_OK){ /* Small stack */
		status = fbe_ext_pool_lun_send_io_packet(lun_p, new_packet_p);
...
/*!****************************************************************************
 * fbe_ext_pool_lun_zero_start_lun_zeroing_completion()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t 
fbe_ext_pool_lun_zero_start_lun_zeroing_completion(fbe_packet_t * packet_p, fbe_packet_completion_context_t context)
{
    fbe_ext_pool_lun_t *                          lun_p = NULL;
    ...
    else if (lun_p->clear_need_zero_b == FBE_FALSE)
    {
        ...
        fbe_ext_pool_lun_event_log_lun_zero_start_or_complete(lun_p, FBE_TRUE);
    }
...
/*!****************************************************************************
 * fbe_ext_pool_lun_zero_calculate_zero_checkpoint_for_lu_extent()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t
fbe_ext_pool_lun_zero_calculate_zero_checkpoint_for_lu_extent(fbe_ext_pool_lun_t * lun_p,
...
/******************************************************************************
 * end fbe_ext_pool_lun_zero_calculate_zero_checkpoint_for_lu_extent()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_zero_calculate_zero_percent_for_lu_extent()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t
fbe_ext_pool_lun_zero_calculate_zero_percent_for_lu_extent(fbe_ext_pool_lun_t * lun_p,
...
/******************************************************************************
 * end fbe_ext_pool_lun_zero_calculate_zero_percent_for_lu_extent()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_zero_adjust_zeroing_udpate_rate()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static void
fbe_ext_pool_lun_zero_adjust_zeroing_udpate_rate(fbe_ext_pool_lun_t *lun_p, 
                                        fbe_lba_t zero_checkpoint)

{
    ...
    fbe_ext_pool_lun_metadata_get_zero_checkpoint(lun_p, &current_zero_checkpoint);
...
/******************************************************************************
 * end fbe_ext_pool_lun_zero_adjust_zeroing_udpate_rate()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_zero_get_raid_extent_zero_checkpoint()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t
fbe_ext_pool_lun_zero_get_raid_extent_zero_checkpoint(fbe_ext_pool_lun_t * lun_p,
                                             fbe_packet_t * packet_p)
{
    ...
    fbe_transport_set_completion_function(packet_p, fbe_ext_pool_lun_zero_get_raid_extent_zero_checkpoint_completion, lun_p);
...
/******************************************************************************
 * end fbe_ext_pool_lun_zero_get_raid_extent_zero_checkpoint()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_zero_get_raid_extent_zero_checkpoint_completion()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_zero_get_raid_extent_zero_checkpoint_completion(fbe_packet_t * packet_p,
                                                        fbe_packet_completion_context_t context)
{
    fbe_ext_pool_lun_t *                                             lun_p = NULL;
    fbe_payload_ex_t *                                      sep_payload_p = NULL;
    ...
    fbe_ext_pool_lun_zero_calculate_zero_checkpoint_for_lu_extent(lun_p,
    ...
    if(zero_checkpoint == FBE_LBA_INVALID)
    {
        ...
        fbe_ext_pool_lun_event_log_lun_zero_start_or_complete(lun_p, FBE_FALSE);
        ...
        if (fbe_ext_pool_lun_metadata_is_initial_verify_needed(lun_p))
        {
            fbe_base_object_trace((fbe_base_object_t*) lun_p, 
            ...
            fbe_lifecycle_set_cond(&fbe_ext_pool_lun_lifecycle_const, (fbe_base_object_t *)lun_p, FBE_LUN_LIFECYCLE_COND_VERIFY_NEW_LUN);
        }
        else
        {
            fbe_base_object_trace((fbe_base_object_t*) lun_p, 
    ...
    fbe_ext_pool_lun_zero_adjust_zeroing_udpate_rate(lun_p, zero_checkpoint);

    /* update the zero checkpoint with lun nonpaged metadata. */
    status = fbe_ext_pool_lun_metadata_set_zero_checkpoint(lun_p, packet_p, zero_checkpoint, persist_checkpoint);

    return FBE_STATUS_MORE_PROCESSING_REQUIRED;
}
/******************************************************************************
 * end fbe_ext_pool_lun_zero_get_raid_extent_zero_checkpoint_completion()
 ******************************************************************************/
