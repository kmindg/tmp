...
/**********************************************************************
 * fbe_sas_magnum_enclosure_executer.c
 **********************************************************************
 * DESCRIPTION: 
 *  This file contains entry functions for the magnum enclosure class.
 *
 * HISTORY:
 *   3/2/09 - File created from fbe_sas_viper_enclosure_executer.c - bphilbin
 *             
 ***********************************************************************/
...
static fbe_status_t 
sas_magnum_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet);
 ...
 *  3/2/09 - created from sas_viper_enclosure_io_entry - bphilbin
 *
 ****************************************************************/
fbe_status_t 
fbe_sas_magnum_enclosure_io_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet)
{
    ...
    switch(transport_id) {
        case FBE_TRANSPORT_ID_DISCOVERY:
            ...
            */
            status = fbe_base_discovering_discovery_bouncer_entry((fbe_base_discovering_t *) sas_magnum_enclosure,
                                                                        (fbe_transport_entry_t)sas_magnum_enclosure_discovery_transport_entry,
                                                                        packet);
            break;
        default:
...
/****************************************************************
 * sas_magnum_enclosure_discovery_transport_entry()
 ****************************************************************
 * DESCRIPTION:
 ...
 * HISTORY:
 *  7/31/08 - updated. bphilbin
 *  3/2/09 - created from sas_viper_enclosure_discovery_transport_entry - bphilbin
 *
 ****************************************************************/
static fbe_status_t 
sas_magnum_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet)
{
    ...
    sas_magnum_enclosure = (fbe_sas_magnum_enclosure_t *)base_object;
    ...
    switch(discovery_opcode){
        ...
        default:
            status = fbe_eses_enclosure_discovery_transport_entry((fbe_base_object_t *)sas_magnum_enclosure, packet);
            break;
    }
 ...
 *  3/2/09 - created from fbe_sas_viper_enclosure_event_entry - bphilbin
 *
 ****************************************************************/
fbe_status_t 
fbe_sas_magnum_enclosure_event_entry(fbe_object_handle_t object_handle, 
...
//End of file fbe_sas_magnum_enclosure_executer.c
