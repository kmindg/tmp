...
/*!*************************************************************************
 * @file fbe_sas_cayenne_iosxp_enclosure_usurper.c
 ***************************************************************************
 *
 * @brief
 *  This file contains usurper functions for sas cayenne iosxp enclosure.
 *
...
static fbe_status_t 
sas_cayenne_iosxp_enclosure_getEnclosurePrvtInfo(fbe_sas_cayenne_iosxp_enclosure_t *cayenne_iosxpEnclosurePtr, 
                                                fbe_packet_t *packet);
#if 1
static fbe_status_t 
fbe_sas_cayenne_iosxp_enclosure_get_fan_count(fbe_sas_cayenne_iosxp_enclosure_t *pCayenneEncl, 
                             fbe_packet_t *packet);

static fbe_status_t 
fbe_sas_cayenne_iosxp_enclosure_get_fan_info(fbe_sas_cayenne_iosxp_enclosure_t *pCayenneEncl, 
                                fbe_packet_t *packet);

static fbe_status_t 
fbe_sas_cayenne_iosxp_enclosure_get_ps_count(fbe_sas_cayenne_iosxp_enclosure_t *pCayenneEncl, 
                                fbe_packet_t *packet);

static fbe_status_t 
fbe_sas_cayenne_iosxp_enclosure_get_ps_info(fbe_sas_cayenne_iosxp_enclosure_t *pCayenneEncl, 
                                fbe_packet_t *packet);
#endif

/*!**************************************************************
 * @fn fbe_sas_cayenne_iosxp_enclosure_control_entry(
 ...
 ****************************************************************/
fbe_status_t 
fbe_sas_cayenne_iosxp_enclosure_control_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet)
{
    fbe_status_t                 status;
    fbe_sas_cayenne_iosxp_enclosure_t * pSasCayenneEnclosure = NULL;
    ...
    fbe_base_object_customizable_trace((fbe_base_object_t*)pSasCayenneEnclosure,
                            ...
                            "sas_cayenne_encl_ctrl_entry.\n");

    control_code = fbe_transport_get_control_code(packet);
    fbe_base_object_customizable_trace((fbe_base_object_t *)pSasCayenneEnclosure,
                                       FBE_TRACE_LEVEL_DEBUG_MEDIUM,
                                       fbe_base_enclosure_get_logheader((fbe_base_enclosure_t*)pSasCayenneEnclosure),
                                       "sas_cayenne_iosxp_encl_ctrl_entry:cntrlCode(0x%x) %s\n", 
                                       control_code,
                                       fbe_base_enclosure_getControlCodeString(control_code));
    switch(control_code) {

    case FBE_BASE_ENCLOSURE_CONTROL_CODE_GET_ENCLOSURE_PRVT_INFO:
        status = sas_cayenne_iosxp_enclosure_getEnclosurePrvtInfo(pSasCayenneEnclosure, packet);
        break;

    case FBE_BASE_ENCLOSURE_CONTROL_CODE_GET_FAN_COUNT:
        status = fbe_sas_cayenne_iosxp_enclosure_get_fan_count(pSasCayenneEnclosure, packet);
        break;

    case FBE_BASE_ENCLOSURE_CONTROL_CODE_GET_FAN_INFO:
        status = fbe_sas_cayenne_iosxp_enclosure_get_fan_info(pSasCayenneEnclosure, packet);
        break;

#if 0
    case FBE_BASE_ENCLOSURE_CONTROL_CODE_GET_PS_COUNT:
        status = fbe_sas_cayenne_iosxp_enclosure_get_ps_count(pSasCayenneEnclosure, packet);
        break;

    case FBE_BASE_ENCLOSURE_CONTROL_CODE_GET_PS_INFO:
        status = fbe_sas_cayenne_iosxp_enclosure_get_ps_info(pSasCayenneEnclosure, packet);
        break;
#endif
    default:
        ...
        if (status != FBE_STATUS_OK)
        {
            fbe_base_object_customizable_trace((fbe_base_object_t *)pSasCayenneEnclosure,
                                  ...
                                  fbe_base_enclosure_get_logheader((fbe_base_enclosure_t*)pSasCayenneEnclosure),
                                  "sas_cayenne_iosxp_ctrl_entry, unsupported ctrlCode 0x%X, status 0x%X.\n", 
                                  control_code,
                                  status);
        }
        break;
...
/*!**************************************************************
 * @fn sas_cayenne_iosxp_enclosure_getEnclosurePrvtInfo(
 *                         fbe_sas_cayenne_iosxp_enclosure_t *cayenneEnclosurePtr, 
 *                         fbe_packet_t * packet)
 ****************************************************************
 * @brief
 *  This function copy fbe_sas_cayenne_iosxp_enclosure_t structure
 *  into buffer.
 *
 * @param cayenneEnclosurePtr - pointer to the fbe_sas_cayenne_iosxp_enclosure_t.
 * @param packet - The control packet that is arriving.
 *
 * @return fbe_status_t - FBE_STATUS_OK, if no error
 *
 ...
 ****************************************************************/
static fbe_status_t 
sas_cayenne_iosxp_enclosure_getEnclosurePrvtInfo(fbe_sas_cayenne_iosxp_enclosure_t *pCayenneEncl, 
                                          fbe_packet_t *packet)
{
    ...
    fbe_base_enclosure_get_enclosure_number((fbe_base_enclosure_t *)pCayenneEncl, &enclosure_number);

    fbe_base_object_customizable_trace((fbe_base_object_t *)pCayenneEncl,
                          FBE_TRACE_LEVEL_DEBUG_HIGH,
                          fbe_base_enclosure_get_logheader((fbe_base_enclosure_t*)pCayenneEncl),
                          "VoyagerICMEncl:%s entry\n", __FUNCTION__);    

    bufferLength = sizeof(fbe_base_object_mgmt_get_enclosure_prv_info_t);
    status = fbe_base_enclosure_get_packet_payload_control_data(packet,(fbe_base_enclosure_t*)pCayenneEncl, TRUE, (fbe_payload_control_buffer_t *)&pBuffer, bufferLength);
    if(status == FBE_STATUS_OK)
    {
            /* Copy fbe_sas_cayenne_iosxp_enclosure_t structute into buffer */
                memcpy(pBuffer, pCayenneEncl, sizeof(fbe_sas_cayenne_iosxp_enclosure_t));
        }
...
}   // end of sas_cayenne_iosxp_enclosure_getEnclosurePrvtInfo

#if 1

/*!*************************************************************************
* @fn fbe_sas_cayenne_iosxp_enclosure_get_fan_count()                  
***************************************************************************
* @brief
*       This function gets the total fan count in the enclosure.
*
* @param     pCayenneEnclosure - The pointer to the fbe_sas_cayenne_iosxp_enclosure_t.
                             ...
                             fbe_packet_t *packet)
{
    ...
    status = fbe_base_enclosure_get_number_of_components((fbe_base_enclosure_t *)pCayenneEncl,
    ...
    {
        /* Get subtype. */
        enclStatus = fbe_base_enclosure_edal_getU8_thread_safe((fbe_base_enclosure_t *)pCayenneEncl,
...
} // End of function - fbe_sas_cayenne_iosxp_enclosure_get_fan_count

/*!*************************************************************************
* @fn fbe_sas_cayenne_iosxp_enclosure_get_fan_info()                  
***************************************************************************
* @brief
*       This function gets the fan info.
*
* @param     pCayenneEncl - The pointer to the fbe_sas_cayenne_iosxp_enclosure_t.
* @param     packet - The pointer to the fbe_packet_t.
*
* @return    fbe_status_t.
*
                                ...
                                fbe_packet_t *packet)
{
    ...
    fbe_u8_t PsCoolingComponentCount = 0;
    fbe_u8_t PsCount = 0;
    fbe_u32_t coolingIndex = 0;
    ...
    PsCoolingComponentCount = fbe_eses_enclosure_get_number_of_cooling_components_per_ps((fbe_eses_enclosure_t *)pCayenneEncl);
    PsCount = fbe_eses_enclosure_get_number_of_power_supplies((fbe_eses_enclosure_t *)pCayenneEncl);

    // Skip power supply cooling elements. Then the first one in the edal is the overall element for all fans.
    coolingIndex = pGetFanInfo->slotNumOnEncl + 1 + (PsCoolingComponentCount * PsCount);
    // Inserted.
    enclStatus = fbe_base_enclosure_edal_getBool_thread_safe((fbe_base_enclosure_t *)pCayenneEncl,
    ...
    // Firmware Rev.
    enclStatus = fbe_base_enclosure_edal_getStr_thread_safe((fbe_base_enclosure_t *)pCayenneEncl,
    ...
    // Cayenne fans are not subEnclosures, so zero out the Subencl product id field.
...
} // End of function - fbe_sas_cayenne_iosxp_enclosure_get_fan_info
...
/*!*************************************************************************
* @fn fbe_sas_cayenne_iosxp_enclosure_get_ps_info()                  
***************************************************************************
* @brief
                                ...
                                fbe_packet_t *packet)
{
    ...
    {
        // get the side id
        encl_status = fbe_base_enclosure_edal_getU8_thread_safe((fbe_base_enclosure_t *)pCayenneEncl,
        ...
        {
            // get insert status
            encl_status = fbe_base_enclosure_edal_getBool_thread_safe((fbe_base_enclosure_t *)pCayenneEncl,
                                                                      FBE_ENCL_COMP_INSERTED,   // Attribute.
                                                                      FBE_ENCL_POWER_SUPPLY,    // Component type.
                                                                      psIndex,                  // Component index.
                                                                      &inserted);               // The value to be returned.
            ...
            // Get detailed FW Rev
            encl_status = fbe_base_enclosure_edal_getStr_thread_safe((fbe_base_enclosure_t *)pCayenneEncl,
        ...
        if((sideId == slotNum) && (containerIndex == FBE_ENCLOSURE_CONTAINER_INDEX_SELF_CONTAINED))
        {
            ...
            fbe_eses_enclosure_convert_subencl_product_id_to_unique_id((fbe_eses_enclosure_t *)pCayenneEncl,
    ...
    if(fbe_eses_enclosure_is_ps_downloadable((fbe_eses_enclosure_t *)pCayenneEncl, 
                                        slotNum,
    ...
    encl_status = fbe_eses_enclosure_get_local_lcc_side_id((fbe_eses_enclosure_t *)pCayenneEncl, &sp_id);
    if (encl_status != FBE_ENCLOSURE_STATUS_OK)
    {
        return encl_status;
    }
     ...
     */
    if ((psCountPerSide = fbe_eses_enclosure_get_number_of_power_supplies_per_side((fbe_eses_enclosure_t *)pCayenneEncl)) == 0)
    {
        psCountPerSide = 1;
    }

    /* When the Cayenne enclosure is connected as a boot enclosure,
...
} // End of function - fbe_sas_cayenne_iosxp_enclosure_get_ps_info
#endif

//End of file fbe_sas_cayenne_iosxp_enclosure_usurper.c
