...
/*!**************************************************************************
 * @file fbe_extent_pool_lun_usurper.c
 ***************************************************************************
 *
 * @brief
 ...
 *****************************************/
static fbe_status_t
fbe_ext_pool_lun_set_configuration(fbe_ext_pool_lun_t * lun_p, fbe_packet_t * packet_p);

static fbe_status_t 
fbe_ext_pool_lun_usurper_initiate_verify(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);

static fbe_status_t 
fbe_ext_pool_lun_usurper_initiate_zero(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);

static fbe_status_t 
fbe_ext_pool_lun_usurper_initiate_zero_completion(fbe_packet_t * packet_p,
                                                       fbe_packet_completion_context_t context);

static fbe_status_t
fbe_ext_pool_lun_usurper_get_verify_report(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);  
static fbe_status_t
fbe_ext_pool_lun_usurper_get_verify_status(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t
fbe_ext_pool_lun_usurper_get_verify_status_completion(fbe_packet_t* in_packet_p, fbe_packet_completion_context_t in_context);

static fbe_status_t fbe_ext_pool_lun_usurper_get_info(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_get_raid_info_completion(fbe_packet_t* in_packet_p, 
                                                             fbe_packet_completion_context_t in_context);
static fbe_status_t fbe_ext_pool_lun_usurper_set_power_save_info(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_trespass_op(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_zero_fill(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);

static fbe_status_t fbe_ext_pool_lun_usurper_clear_verify_report(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);

static void fbe_ext_pool_lun_usurper_clear_verify_result_counts(fbe_lun_verify_counts_t* in_results_p);

static void fbe_ext_pool_lun_usurper_clear_mirror_objects_count(fbe_u32_t* mirror_objects_count_p);

static fbe_status_t fbe_ext_pool_lun_usurper_get_control_buffer(
...
static fbe_status_t fbe_ext_pool_lun_usurper_prepare_to_destroy_lun( fbe_ext_pool_lun_t* in_lun_p,
                                                            fbe_packet_t* in_packet_p);

static fbe_status_t fbe_ext_pool_lun_usurper_set_power_saving_policy( fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_get_power_saving_policy( fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);

static fbe_status_t fbe_ext_pool_lun_initialize_power_saving(fbe_ext_pool_lun_t *lun_p, fbe_database_lun_configuration_t * set_config_p);

static fbe_status_t fbe_ext_pool_lun_usurper_get_zero_status(fbe_ext_pool_lun_t * in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_get_lun_info(fbe_ext_pool_lun_t * in_lun_p, fbe_packet_t* in_packet_p);

static fbe_status_t fbe_ext_pool_lun_usurper_enable_performace_statistics(fbe_ext_pool_lun_t* in_lun_p,
                                                        fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_disable_performace_statistics(fbe_ext_pool_lun_t* in_lun_p,
                                                        fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_get_performace_statistics(fbe_ext_pool_lun_t *in_lun_p,
                                                 fbe_packet_t *in_packet_p);

static fbe_status_t fbe_ext_pool_lun_usurper_get_attributes(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_export_device(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t lun_connect_to_bvd(fbe_ext_pool_lun_t *lun_p);
static fbe_status_t fbe_lun_connect_bvd_interface(fbe_lun_number_t lun_number, fbe_ext_pool_lun_t * const lun_p);
static fbe_status_t fbe_ext_pool_lun_usurper_set_gen_num(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p);

static fbe_status_t fbe_ext_pool_lun_usurper_set_write_bypass(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p, fbe_bool_t write_bypass_mode);
static fbe_status_t fbe_ext_pool_lun_usurper_get_rebuild_status(fbe_ext_pool_lun_t * in_lun_p, fbe_packet_t* in_packet_p);
static fbe_status_t fbe_ext_pool_lun_usurper_get_rebuild_status_completion(fbe_packet_t * packet_p,
                                                                  fbe_packet_completion_context_t context);
static fbe_status_t fbe_ext_pool_lun_reset_unexpected_error_info(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p);
static fbe_status_t fbe_ext_pool_lun_disable_fail_on_unexpected_errors(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p);
static fbe_status_t fbe_ext_pool_lun_enable_fail_on_unexpected_errors(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p);

static fbe_status_t fbe_ext_pool_lun_prepare_for_power_shutdown(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p);
static fbe_status_t fbe_ext_pool_lun_set_read_and_pin_index(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p);

/*!***************************************************************
 * fbe_ext_pool_lun_control_entry()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
fbe_status_t 
fbe_ext_pool_lun_control_entry(fbe_object_handle_t object_handle, 
                                fbe_packet_t * packet_p)
{
    ...
    if(object_handle == NULL){
        return  fbe_ext_pool_lun_class_control_entry(packet_p);
    }
    ...
    switch (opcode)
    {
        ...
        case FBE_LUN_CONTROL_CODE_SET_CONFIGURATION:
            status = fbe_ext_pool_lun_set_configuration(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_INITIATE_VERIFY:
            status = fbe_ext_pool_lun_usurper_initiate_verify(lun_p, packet_p);
            break;
        
        case FBE_LUN_CONTROL_CODE_INITIATE_ZERO:
            status = fbe_ext_pool_lun_usurper_initiate_zero(lun_p, packet_p);
            break;
            
        case FBE_LUN_CONTROL_CODE_SET_NONPAGED_GENERATION_NUM:
            status = fbe_ext_pool_lun_usurper_set_gen_num(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_GET_VERIFY_STATUS:
            status = fbe_ext_pool_lun_usurper_get_verify_status(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_GET_VERIFY_REPORT:
            status = fbe_ext_pool_lun_usurper_get_verify_report(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_CLEAR_VERIFY_REPORT:
            status = fbe_ext_pool_lun_usurper_clear_verify_report(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_SET_POWER_SAVE_INFO:
            status = fbe_ext_pool_lun_usurper_set_power_save_info(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_TRESPASS_OP:
            status = fbe_ext_pool_lun_usurper_trespass_op(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_PREPARE_TO_DESTROY_LUN:
            status = fbe_ext_pool_lun_usurper_prepare_to_destroy_lun(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_SET_POWER_SAVING_POLICY:
            status = fbe_ext_pool_lun_usurper_set_power_saving_policy(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_GET_POWER_SAVING_POLICY:
            status = fbe_ext_pool_lun_usurper_get_power_saving_policy(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_GET_ZERO_STATUS:
            status = fbe_ext_pool_lun_usurper_get_zero_status(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_ENABLE_PERFORMANCE_STATS:
            status = fbe_ext_pool_lun_usurper_enable_performace_statistics(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_DISABLE_PERFORMANCE_STATS:
            status = fbe_ext_pool_lun_usurper_disable_performace_statistics(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_GET_PERFORMANCE_STATS:
            status = fbe_ext_pool_lun_usurper_get_performace_statistics(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_GET_ATTRIBUTES:
            status = fbe_ext_pool_lun_usurper_get_attributes(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_GET_LUN_INFO:
            status = fbe_ext_pool_lun_usurper_get_lun_info(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_EXPORT_DEVICE:
            status = fbe_ext_pool_lun_usurper_export_device(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_ENABLE_WRITE_BYPASS:
            status = fbe_ext_pool_lun_usurper_set_write_bypass(lun_p, packet_p, FBE_TRUE);
            break;

        case FBE_LUN_CONTROL_CODE_DISABLE_WRITE_BYPASS:
            status = fbe_ext_pool_lun_usurper_set_write_bypass(lun_p, packet_p, FBE_FALSE);
            break;
        ...
        case FBE_BASE_CONFIG_CONTROL_CODE_METADATA_SET_NONPAGED:
            status = fbe_ext_pool_lun_metadata_set_nonpaged_metadata(lun_p, packet_p);
            break;
        ...
        case FBE_LUN_CONTROL_CODE_GET_REBUILD_STATUS:
            status = fbe_ext_pool_lun_usurper_get_rebuild_status(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_CLEAR_UNEXPECTED_ERROR_INFO:
            status = fbe_ext_pool_lun_reset_unexpected_error_info(lun_p, packet_p);
            break;

        case FBE_LUN_CONTROL_CODE_ENABLE_FAIL_ON_UNEXPECTED_ERROR:
            status = fbe_ext_pool_lun_enable_fail_on_unexpected_errors(lun_p, packet_p);
            break;
        case FBE_LUN_CONTROL_CODE_DISABLE_FAIL_ON_UNEXPECTED_ERROR:
            status = fbe_ext_pool_lun_disable_fail_on_unexpected_errors(lun_p, packet_p);
            break;
        case FBE_LUN_CONTROL_CODE_PREPARE_FOR_POWER_SHUTDOWN:
            status = fbe_ext_pool_lun_prepare_for_power_shutdown(lun_p, packet_p);
            break;
        case FBE_LUN_CONTROL_CODE_SET_READ_AND_PIN_INDEX:
            status = fbe_ext_pool_lun_set_read_and_pin_index(lun_p, packet_p);
            break;
        default:
...
/* end fbe_ext_pool_lun_control_entry() */

/*!**************************************************************
 * fbe_ext_pool_lun_set_configuration()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
static fbe_status_t
fbe_ext_pool_lun_set_configuration(fbe_ext_pool_lun_t * lun_p, fbe_packet_t * in_packet_p)
{
    fbe_ext_pool_lun_configuration_t * set_config_p = NULL;    /* INPUT */
    ...
    else
    {
        ...
        lun_p->server_index = set_config_p->server_index;
        
        fbe_ext_pool_lun_unlock(lun_p);

        //fbe_ext_pool_lun_initialize_power_saving(lun_p, set_config_p);/*does not have to be under lock*/
...
/**************************************
 * end fbe_ext_pool_lun_set_configuration()
 **************************************/

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_initiate_verify()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_initiate_verify(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p)
{
    ...
    fbe_ext_pool_lun_usurper_clear_verify_result_counts(&verify_report_p->current);

    // Clear the current mirror object counts
    fbe_ext_pool_lun_usurper_clear_mirror_objects_count(&verify_report_p->mirror_objects_count);

    // Get the control buffer pointer from the packet payload.
    status = fbe_ext_pool_lun_usurper_get_control_buffer(in_lun_p, in_packet_p, 
    ...
    if (in_lun_p->lun_verify.verify_type == FBE_LUN_VERIFY_TYPE_NONE){
        ...
        fbe_lifecycle_set_cond(&fbe_ext_pool_lun_lifecycle_const,(fbe_base_object_t*)in_lun_p, FBE_LUN_LIFECYCLE_COND_VERIFY_LUN);
         ...
         */
        status = fbe_ext_pool_lun_usurper_send_initiate_verify_to_raid(in_lun_p, in_packet_p, initiate_verify_p);
    }

    return status;
}
/* end of fbe_ext_pool_lun_usurper_initiate_verify() */

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_set_gen_num()
 ****************************************************************
 * @brief
 *  
 *
...
static fbe_status_t fbe_ext_pool_lun_usurper_set_gen_num(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p)
{
    ...
    status = fbe_ext_pool_lun_metadata_nonpaged_set_generation_num((fbe_base_config_t *) in_lun_p,
                                                          in_packet_p,
                                                          gen_num_offset,
...
/* end of fbe_ext_pool_lun_usurper_set_gen_num() */


/*!**************************************************************
 * fbe_ext_pool_lun_usurper_initiate_zero()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_initiate_zero(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p)
{
    fbe_status_t    status;
    ...
    fbe_transport_set_completion_function(in_packet_p, fbe_ext_pool_lun_usurper_initiate_zero_completion, in_lun_p);

    /* initialize lun zero. */ 
    status = fbe_ext_pool_lun_zero_start_lun_zeroing_packet_allocation(in_lun_p,in_packet_p);
    if (status != FBE_STATUS_OK)
    {
        fbe_transport_set_status(in_packet_p, status, 0);
        status = fbe_transport_complete_packet(in_packet_p);
...
/* end of fbe_ext_pool_lun_usurper_initiate_zero() */

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_initiate_zero_completion()
 ******************************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_initiate_zero_completion(fbe_packet_t * packet_p,
                                                                           fbe_packet_completion_context_t context)
{
    fbe_ext_pool_lun_t *                         lun_p = NULL;
...
/* End fbe_ext_pool_lun_usurper_initiate_zero_completion()*/

static fbe_status_t 
fbe_ext_pool_lun_usurper_send_initiate_verify_to_raid_completion(fbe_packet_t * packet_p,
                                                  fbe_packet_completion_context_t context)
{
...
/*!**************************************************************
 * fbe_ext_pool_lun_usurper_send_initiate_verify_to_raid()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
fbe_status_t fbe_ext_pool_lun_usurper_send_initiate_verify_to_raid(fbe_ext_pool_lun_t * lun_p, 
                                                          fbe_packet_t * packet_p, 
                                                          fbe_lun_initiate_verify_t * initiate_lun_verify_p)
{
    ...
    fbe_transport_set_completion_function(packet_p, fbe_ext_pool_lun_usurper_send_initiate_verify_to_raid_completion, lun_p);
...
}   // End fbe_ext_pool_lun_usurper_send_initiate_verify_to_raid()

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_get_verify_status()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_get_verify_status(fbe_ext_pool_lun_t* in_lun_p,fbe_packet_t* in_packet_p)
{
    ...
    status = fbe_ext_pool_lun_usurper_allocate_and_build_control_operation(in_lun_p, in_packet_p, 
    ...
    status = fbe_transport_set_completion_function(in_packet_p, fbe_ext_pool_lun_usurper_get_verify_status_completion, &semaphore);
    ...
    fbe_payload_control_get_buffer(control_operation_p, &lun_verify_status_p);
    ...
    status = fbe_transport_complete_packet(in_packet_p);
    return status;
}   // End fbe_ext_pool_lun_usurper_get_verify_status()


/*!**************************************************************
 * fbe_ext_pool_lun_usurper_get_verify_status_completion()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_get_verify_status_completion(fbe_packet_t* in_packet_p, 
                                                                 fbe_packet_completion_context_t in_context)
{
...
}   // End fbe_ext_pool_lun_usurper_get_verify_status_completion()

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_get_verify_report()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_get_verify_report(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p)
{
    ...
    status = fbe_transport_complete_packet(in_packet_p);
    return status;
} // End fbe_ext_pool_lun_usurper_get_verify_report()



/*!**************************************************************
 * fbe_ext_pool_lun_usurper_clear_verify_report()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_clear_verify_report(fbe_ext_pool_lun_t*      in_lun_p, 
                                                        fbe_packet_t*   in_packet_p)
{
    ...
    fbe_ext_pool_lun_usurper_clear_verify_result_counts(&verify_report_p->current);
    fbe_ext_pool_lun_usurper_clear_verify_result_counts(&verify_report_p->previous);
    fbe_ext_pool_lun_usurper_clear_verify_result_counts(&verify_report_p->totals);

    fbe_transport_set_status(in_packet_p, status, 0);
    status = fbe_transport_complete_packet(in_packet_p);
    return status;
} // End fbe_ext_pool_lun_usurper_clear_verify_report()


/*!**************************************************************
 * fbe_ext_pool_lun_usurper_clear_verify_result_counts()
 ****************************************************************
 * @brief
...
}   // End fbe_ext_pool_lun_usurper_clear_verify_result_counts()



/*!**************************************************************
 * fbe_ext_pool_lun_usurper_clear_mirror_objects_count()
 ****************************************************************
 * @brief
...
}   // End fbe_ext_pool_lun_usurper_clear_mirror_objects_count()

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_add_verify_result_counts()
 ****************************************************************
 * @brief
...
}   // End fbe_ext_pool_lun_usurper_add_verify_result_counts()



/*!**************************************************************
 * fbe_ext_pool_lun_usurper_set_power_save_info()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_set_power_save_info(fbe_ext_pool_lun_t* in_lun_p,
                                                        fbe_packet_t* in_packet_p)
{
    fbe_status_t status = FBE_STATUS_GENERIC_FAILURE; 
    ...
    status = fbe_transport_complete_packet(in_packet_p);
    return status;
}   // End fbe_ext_pool_lun_usurper_set_power_save_info()

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_trespass_op()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_trespass_op(fbe_ext_pool_lun_t* in_lun_p,
                                                fbe_packet_t* in_packet_p)
{
    fbe_status_t status = FBE_STATUS_OK; 
    ...
    status = fbe_transport_complete_packet(in_packet_p);
    return status;
}   // End fbe_ext_pool_lun_usurper_trespass_op()


/*!**************************************************************
 * fbe_ext_pool_lun_usurper_prepare_to_destroy_lun()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_ext_pool_lun_usurper_prepare_to_destroy_lun( fbe_ext_pool_lun_t*      in_lun_p, fbe_packet_t*   in_packet_p)
{
    fbe_bool_t is_empty;
    ...
    if(is_empty == FBE_TRUE){
         ...
         * usurper packet
         */
        fbe_lifecycle_set_cond(&fbe_ext_pool_lun_lifecycle_const, (fbe_base_object_t*) in_lun_p,
                               FBE_LUN_LIFECYCLE_COND_LUN_CHECK_FLUSH_FOR_DESTROY);
    }

    return FBE_STATUS_PENDING;

}   // End fbe_ext_pool_lun_usurper_prepare_to_destroy_lun()

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_get_control_buffer()
 ****************************************************************
 * @brief
...
}   // End fbe_ext_pool_lun_usurper_get_control_buffer()


/*!**************************************************************
 * fbe_ext_pool_lun_usurper_build_control_packet()
 ****************************************************************
 * @brief
...
}   // End fbe_ext_pool_lun_usurper_allocate_and_build_control_operation()
...
static fbe_status_t
fbe_ext_pool_lun_initialize_power_saving(fbe_ext_pool_lun_t *lun_p,
...
/*!****************************************************************************
 * fbe_ext_pool_lun_usurper_get_zero_status()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_usurper_get_zero_status(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t                                        status;
    ...
    status = fbe_ext_pool_lun_usurper_get_control_buffer(lun_p, packet_p, 
     ...
     */
    status = fbe_ext_pool_lun_metadata_get_zero_checkpoint(lun_p, &current_zero_checkpoint);
    if (status != FBE_STATUS_OK) 
    {
        fbe_base_object_trace((fbe_base_object_t *)lun_p,
                              FBE_TRACE_LEVEL_WARNING,
...
/******************************************************************************
 * end fbe_ext_pool_lun_usurper_get_zero_status()
 ******************************************************************************/

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_enable_performace_statistics()
 ****************************************************************
 * @brief
...
/******************************
 * end fbe_ext_pool_lun_usurper_enable_performace_statistics()
 ******************************/

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_disable_performace_statistics()
 ****************************************************************
 * @brief
...
/*!**************************************************************
 * fbe_ext_pool_lun_usurper_get_performace_statistics()
 ****************************************************************
 * @brief
                                                 ...
                                                 fbe_packet_t *in_packet_p)
{
    ...
    { //copy the stat memory
         payload = fbe_transport_get_payload_ex(in_packet_p);
         control_operation = fbe_payload_ex_get_control_operation(payload);
...
/******************************
 * end fbe_ext_pool_lun_usurper_get_performace_statistics()
 ******************************/

/*!**************************************************************
 * fbe_ext_pool_lun_usurper_get_attributes()
 ****************************************************************
 * @brief
...
/******************************
 * end fbe_ext_pool_lun_usurper_get_attributes()
 ******************************/
/*!****************************************************************************
 * fbe_ext_pool_lun_usurper_get_lun_info()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_usurper_get_lun_info(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t                                        status;
   ...
   // Get the lun offset
    ...
    get_lun_info->b_initial_verify_already_run = fbe_ext_pool_lun_metadata_was_initial_verify_run(lun_p);
...
/******************************
 * end fbe_ext_pool_lun_usurper_get_lun_info()
 ******************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_usurper_export_device(fbe_ext_pool_lun_t* in_lun_p, fbe_packet_t* in_packet_p)
 ******************************************************************************
 * @brief
...
/****************************************************************
 *  lun_connect_to_bvd(fbe_ext_pool_lun_t *lun_p)
 ****************************************************************
 * @brief
...
/*!****************************************************************************
* fbe_ext_pool_lun_metadata_set_default_nonpaged_metadata()
******************************************************************************
* @brief
...
******************************************************************************/
fbe_status_t 
fbe_ext_pool_lun_metadata_set_nonpaged_metadata(fbe_ext_pool_lun_t * lun_p,
                                                      fbe_packet_t *packet_p)
{
    fbe_status_t				 status = FBE_STATUS_OK;
...
/******************************************************************************
* end fbe_ext_pool_lun_metadata_write_default_nonpaged_metadata()
******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_usurper_get_rebuild_status()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_usurper_get_rebuild_status(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t                                status;
    ...
    fbe_transport_set_completion_function(packet_p, fbe_ext_pool_lun_usurper_get_rebuild_status_completion, lun_p);
...
/******************************************************************************
 * end fbe_ext_pool_lun_usurper_get_rebuild_status()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_usurper_get_rebuild_status_completion()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_usurper_get_rebuild_status_completion(fbe_packet_t * packet_p,
                                            fbe_packet_completion_context_t context)
{
    fbe_status_t                                status;
    fbe_ext_pool_lun_t                                  *lun_p = NULL;
...
/******************************************************************************
 * end fbe_ext_pool_lun_usurper_get_rebuild_status_completion()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_reset_unexpected_error_info()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_reset_unexpected_error_info(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t status;

    fbe_ext_pool_lun_reset_unexpected_errors(lun_p);
...
/******************************
 * end fbe_ext_pool_lun_reset_unexpected_error_info()
 ******************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_enable_fail_on_unexpected_errors()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_enable_fail_on_unexpected_errors(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t status;
...
/******************************
 * end fbe_ext_pool_lun_enable_fail_on_unexpected_errors()
 ******************************/
/*!****************************************************************************
 * fbe_ext_pool_lun_disable_fail_on_unexpected_errors()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_disable_fail_on_unexpected_errors(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t status;
    if (!fbe_lun_is_flag_set(lun_p, FBE_LUN_FLAGS_DISABLE_FAIL_ON_UNEXPECTED_ERRORS))
    {
...
/******************************
 * end fbe_ext_pool_lun_disable_fail_on_unexpected_errors()
 ******************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_mark_lun_clean_completion()
 ******************************************************************************
 * @brief
 *
...
/******************************************************************************
 * end fbe_ext_pool_lun_mark_lun_clean_completion()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_mark_lun_clean()
 ******************************************************************************
 * @brief
 *  Mark a LUN as clean
 *
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_prepare_for_power_shutdown(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t status = FBE_STATUS_GENERIC_FAILURE;
...
/******************************
 * end fbe_ext_pool_lun_mark_lun_clean()
 ******************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_set_read_and_pin_index()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t
fbe_ext_pool_lun_set_read_and_pin_index(fbe_ext_pool_lun_t* lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t status;
    fbe_payload_ex_t                           *sep_payload_p = NULL;
    fbe_payload_control_operation_t            *control_operation_p = NULL;
...
/******************************
 * end fbe_ext_pool_lun_set_read_and_pin_index()
 ******************************/

/******************************
 * end fbe_extent_pool_lun_usurper.c
 ******************************/
