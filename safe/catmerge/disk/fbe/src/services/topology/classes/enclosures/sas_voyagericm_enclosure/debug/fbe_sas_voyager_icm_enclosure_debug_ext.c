...
/*!*************************************************************************
 * @file fbe_sas_voyager_icm_enclosure_debug_ext.c
 ***************************************************************************
 *
 * @brief
...
/*!**************************************************************
 * @fn fbe_sas_voyager_icm_enclosure_debug_prvt_data(const fbe_u8_t * module_name, 
 ...
 * @param sas_voyager_icm_enclosure_p - Ptr to sas voyager_icm enclosure object.
...

{
  ...
  fbe_eses_enclosure_debug_prvt_data(module_name, sas_voyager_icm_enclosure_p + eses_enclosure_offset ,trace_func,trace_context);
  return FBE_STATUS_OK;
}
