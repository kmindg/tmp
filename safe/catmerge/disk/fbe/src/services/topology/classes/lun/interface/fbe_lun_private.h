#ifndef LUN_PRIVATE_H
#define LUN_PRIVATE_H
/***************************************************************************
 ...
 */
extern fbe_lifecycle_const_t FBE_LIFECYCLE_CONST_DATA(lun);
...
typedef enum fbe_lun_lifecycle_cond_id_e 
{
     ...
     */
    FBE_LUN_LIFECYCLE_COND_LUN_CHECK_FLUSH_FOR_DESTROY = FBE_LIFECYCLE_COND_FIRST_ID(FBE_CLASS_ID_LUN),
...
enum fbe_lun_flags_e {
    ...
    FBE_LUN_FLAGS_ENABLE_IO_LOOPBACK                = 0x00000008,   /* Clean dirty has been disabled */
};
...
typedef struct fbe_lun_hard_zero_progress_s
{    
    fbe_spinlock_t io_progress_lock;
    fbe_lun_t* lun_p;
    fbe_packet_t* usurper_packet_p;
    fbe_lba_t current_lba;
    fbe_block_count_t blocks_remaining;
    fbe_u32_t  outstanding_io_count;
} fbe_lun_hard_zero_progress_t;


/* Accessors related to local state.
 */
static __forceinline fbe_bool_t fbe_lun_is_local_state_set(fbe_lun_t *lun_p,
                                                                  fbe_lun_local_state_t local_state)
{
    return ((lun_p->local_state & local_state) == local_state);
}
static __forceinline void fbe_lun_init_local_state(fbe_lun_t *lun_p)
{
    lun_p->local_state = 0;
    return;
}
static __forceinline void fbe_lun_set_local_state(fbe_lun_t *lun_p,
                                                         fbe_lun_local_state_t local_state)
{
    lun_p->local_state |= local_state;
}

static __forceinline void fbe_lun_clear_local_state(fbe_lun_t *lun_p,
                                                           fbe_lun_local_state_t local_state)
{
    lun_p->local_state &= ~local_state;
}
static __forceinline void fbe_lun_get_local_state(fbe_lun_t *lun_p,
                                                         fbe_lun_local_state_t *local_state)
{
     *local_state = lun_p->local_state;
}

/*! @fn fbe_lun_lock(fbe_lun_t *const lun_p) 
 *  
 * @brief 
 *   Function which locks the lun via the base object lock.
 */
static __forceinline void
fbe_lun_lock(fbe_lun_t *const lun_p)
{
    fbe_base_object_lock((fbe_base_object_t *)lun_p);
    return;
}

/* @fn fbe_lun_unlock(fbe_lun_t *const lun_p) 
 *  
 * @brief 
 *   Function which unlocks the lun via the base object lock.
 */
static __forceinline void
fbe_lun_unlock(fbe_lun_t *const lun_p)
{
 ...
 */
static __forceinline void fbe_lun_get_block_edge(fbe_lun_t *lun_p,
 ...
 */
static __forceinline void fbe_lun_set_capacity(fbe_lun_t *lun_p, 
                                        fbe_lba_t capacity)
{
    fbe_base_config_set_capacity(&lun_p->base_config, capacity);
    return;
}
static __forceinline void fbe_lun_get_capacity(fbe_lun_t *lun_p,
 ...
 */
static __forceinline void fbe_lun_set_ndb_b(fbe_lun_t *lun_p, 
                                     fbe_bool_t ndb_b)
{
    lun_p->ndb_b = ndb_b;
    return;
}
static __forceinline fbe_bool_t fbe_lun_get_ndb_b(fbe_lun_t *lun_p)
{
    return lun_p->ndb_b;
}
 ...
 */
static __forceinline void fbe_lun_set_noinitialverify_b(fbe_lun_t *lun_p, 
                                     fbe_bool_t noinitialverify_b)
{
    lun_p->noinitialverify_b = noinitialverify_b;
    return;
}
static __forceinline fbe_bool_t fbe_lun_get_noinitialverify_b(fbe_lun_t *lun_p)
{
 ...
 */
static __forceinline void fbe_lun_set_clear_need_zero_b(fbe_lun_t *lun_p, 
                                     fbe_bool_t clear_need_zero_b)
{
    lun_p->clear_need_zero_b = clear_need_zero_b;
    return;
}
static __forceinline fbe_bool_t fbe_lun_get_clear_need_zero_b(fbe_lun_t *lun_p)
{
    return lun_p->clear_need_zero_b;
}

/* Accessors for the export_lun boolean.
 */
static __forceinline void fbe_lun_set_export_lun_b(fbe_lun_t *lun_p, 
                                                   fbe_bool_t export_lun_b)
{
    lun_p->export_lun_b = export_lun_b;
    return;
}
static __forceinline fbe_bool_t fbe_lun_get_export_lun_b(fbe_lun_t *lun_p)
{
    return lun_p->export_lun_b;
}


/* Accessors for the power saving information.
 */
static __forceinline void fbe_lun_set_power_save_info(fbe_lun_t *lun_p,
...
static __forceinline void fbe_lun_get_power_save_info(fbe_lun_t *lun_p,
...
/* @fn fbe_lun_get_verify_report_ptr(fbe_lun_t *lun_p)
 *  
 * @brief 
 *   Function that gets a pointer to the lun verify report data.
 */
static __forceinline fbe_lun_verify_report_t* fbe_lun_get_verify_report_ptr(fbe_lun_t *lun_p)
{
 ...
 *
 ******************************************************************************/
static __forceinline void fbe_lun_get_imported_capacity(fbe_lun_t *lun_p,
...
static __forceinline void fbe_lun_get_object_index(fbe_lun_t *lun_p,
                                                   fbe_lun_index_t * object_index_p)
{
    *object_index_p = lun_p->object_index;
    return;
}
static __forceinline void fbe_lun_set_object_index(fbe_lun_t *lun_p,
...
/*!****************************************************************************
 * fbe_lun_add_to_terminator_queue()
 ******************************************************************************
 * @brief 
...
static __forceinline void fbe_lun_add_to_terminator_queue(
                                    fbe_lun_t*       in_lun_p,
...
} // End fbe_lun_add_to_terminator_queue()
 ...
 *
 ******************************************************************************/
static __forceinline void fbe_lun_get_offset(fbe_lun_t *lun_p,
                                      fbe_lba_t * offset_p)
{
    fbe_block_edge_t * block_edge_p = NULL;
...
static __inline fbe_bool_t fbe_lun_is_raw(fbe_lun_t *lun_p)
{
...
static __inline void fbe_lun_get_num_unexpected_errors(fbe_lun_t *lun_p,
                                                       fbe_u32_t *num_unexpected_errors_p)
{
    *num_unexpected_errors_p = lun_p->num_unexpected_errors;
}
static __inline void fbe_lun_reset_num_unexpected_errors(fbe_lun_t *lun_p)
{
    lun_p->num_unexpected_errors = 0;
}
static __inline fbe_u32_t fbe_lun_inc_num_unexpected_errors(fbe_lun_t *lun_p)
{
    return fbe_atomic_32_increment(&lun_p->num_unexpected_errors);
}
/* accessors for flags.
 */
static __forceinline fbe_bool_t fbe_lun_is_flag_set(fbe_lun_t *lun_p,
                                                    fbe_lun_flags_t flags)
{
    return((lun_p->flags & flags) == flags);
}
static __forceinline void fbe_lun_init_flags(fbe_lun_t *lun_p)
{
    lun_p->flags = 0;
    return;
}
static __forceinline void fbe_lun_set_flag(fbe_lun_t *lun_p,
                                           fbe_lun_flags_t flags)
{
    lun_p->flags |= flags;
}

static __forceinline void fbe_lun_clear_flag(fbe_lun_t *lun_p,
                                             fbe_lun_flags_t flags)
{
    lun_p->flags &= ~flags;
}
static __forceinline fbe_bool_t fbe_lun_is_clean_dirty_enabled(fbe_lun_t *lun_p)
{
    return((lun_p->flags & FBE_LUN_FLAGS_DISABLE_CLEAN_DIRTY) == 0);
}
static __forceinline fbe_bool_t fbe_lun_is_clean_dirty_disabled(fbe_lun_t *lun_p)
{
...
/* fbe_lun_main.c */
fbe_status_t fbe_lun_create_object(fbe_packet_t * packet_p, fbe_object_handle_t * object_handle);
fbe_status_t fbe_lun_destroy( fbe_object_handle_t object_handle);
fbe_status_t fbe_lun_init(fbe_lun_t * const lun_p);
fbe_base_config_downstream_health_state_t fbe_lun_verify_downstream_health (fbe_lun_t * lun_p);
fbe_status_t fbe_lun_set_condition_based_on_downstream_health (fbe_lun_t *lun_p, 
                                                               fbe_base_config_downstream_health_state_t downstream_health_state);
fbe_status_t fbe_lun_reset_unexpected_errors(fbe_lun_t* lun_p);

/* fbe_lun_monitor.c */
fbe_status_t fbe_lun_monitor_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet_p);
...
/* fbe_lun_usurper.c */
fbe_status_t fbe_lun_control_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet);
...
fbe_status_t 
fbe_lun_usurper_send_initiate_verify_to_raid(fbe_lun_t* in_lun_p, fbe_packet_t * in_packet, 
                                     fbe_lun_initiate_verify_t* in_initiate_verify_p);

fbe_status_t fbe_lun_usurper_memory_allocation_completion(fbe_memory_request_t * memory_request_p, 
                                                          fbe_memory_completion_context_t in_context);

/* fbe_lun_class.c */
fbe_status_t fbe_lun_class_control_entry(fbe_packet_t * packet);
fbe_status_t  fbe_lun_class_set_resource_priority(fbe_packet_t * packet_p);

/* fbe_lun_executor.c */
fbe_status_t fbe_lun_io_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet_p);
fbe_status_t fbe_lun_block_transport_entry(fbe_transport_entry_context_t context, fbe_packet_t * packet);
fbe_status_t fbe_lun_send_io_packet(fbe_lun_t * const lun_p, fbe_packet_t *packet_p);
fbe_status_t fbe_lun_io_completion(fbe_packet_t * packet, fbe_packet_completion_context_t in_context);
fbe_status_t fbe_lun_noncached_io_completion(fbe_packet_t* in_packet_p, 
                                   fbe_packet_completion_context_t in_context);
fbe_status_t fbe_lun_set_dirty_flag_metadata(fbe_packet_t* packet_p,
                                             fbe_lun_t * lun_p);

fbe_status_t fbe_lun_set_dirty_flag_completion(fbe_packet_t*  in_packet_p,
                                                        fbe_packet_completion_context_t in_context);
                                                        
fbe_status_t fbe_lun_send_packet( fbe_lun_t*  in_lun_p,
                                  fbe_packet_t*  in_packet_p);

fbe_status_t fbe_lun_update_dirty_flag(fbe_lun_clean_dirty_context_t * context,
                                       fbe_packet_t*   in_packet_p,
                                       fbe_packet_completion_function_t completion_function);    
fbe_status_t fbe_lun_mark_peer_clean(fbe_lun_t * lun_p, 
                                      fbe_packet_t *packet_p, 
                                      fbe_packet_completion_function_t completion_function);
fbe_status_t fbe_lun_mark_local_clean(fbe_lun_t * lun_p, 
                                      fbe_packet_t *packet_p, 
                                      fbe_packet_completion_function_t completion_function);
fbe_status_t fbe_lun_handle_queued_packets_waiting_for_clear_dirty_flag(fbe_lun_t*  lun_p);
fbe_status_t fbe_lun_handle_queued_packets_waiting_for_set_dirty_flag(fbe_lun_t*  lun_p,
                                                                      fbe_packet_t* in_packet_p);

              
fbe_status_t fbe_lun_get_dirty_flag(fbe_lun_clean_dirty_context_t * context,
                                    fbe_packet_t*   in_packet_p,
                                    fbe_packet_completion_function_t completion_function);

static fbe_lifecycle_status_t
fbe_lun_mark_lun_clean_cond_function(fbe_base_object_t * object_p,
                                             fbe_packet_t * packet_p);
static fbe_status_t
fbe_lun_mark_lun_clean_completion(fbe_packet_t * packet_p,
                                  fbe_packet_completion_context_t context);

fbe_status_t fbe_lun_monitor_check_lun_dirty_initiate_verify_cond_function_completion(
                                   fbe_packet_t* in_packet_p, 
                                   fbe_packet_completion_context_t in_context);
fbe_status_t fbe_lun_send_monitor_packet(fbe_lun_t * in_lun_p, fbe_packet_t * in_packet_p,
                                         fbe_payload_block_operation_opcode_t in_opcode,
                                         fbe_lba_t in_start_lba, fbe_block_count_t in_block_count);


/* fbe_lun_event.c */
fbe_status_t fbe_lun_event_entry(fbe_object_handle_t object_handle, 
...
fbe_status_t fbe_lun_metadata_initialize_metadata_element(fbe_lun_t * lun_p, fbe_packet_t * packet_p);
fbe_status_t fbe_lun_metadata_write_default_nonpaged_metadata(fbe_lun_t * lun_p,fbe_packet_t *packet_p);
fbe_status_t fbe_lun_nonpaged_metadata_init(fbe_lun_t * lun_p, fbe_packet_t *packet_p);
fbe_status_t fbe_lun_metadata_get_zero_checkpoint(fbe_lun_t * lun_p, fbe_lba_t * zero_checkpoint_p);
fbe_status_t  fbe_lun_metadata_set_zero_checkpoint(fbe_lun_t * lun_p, 
                                                   fbe_packet_t * packet_p,
                                                   fbe_lba_t zero_checkpoint,
                                                   fbe_bool_t persist_checkpoint);

fbe_status_t fbe_lun_metadata_set_lun_has_been_written(fbe_lun_t * lun_p, fbe_packet_t * packet_p);
...
fbe_status_t fbe_lun_metadata_set_nonpaged_metadata(fbe_lun_t * lun_p,
                                                    fbe_packet_t *packet_p);

fbe_bool_t fbe_lun_is_peer_clustered_flag_set(fbe_lun_t * lun_p, fbe_lun_clustered_flags_t flags);
fbe_status_t fbe_lun_set_clustered_flag(fbe_lun_t * lun_p, fbe_lun_clustered_flags_t flags);
fbe_bool_t fbe_lun_is_clustered_flag_set(fbe_lun_t * lun_p, fbe_lun_clustered_flags_t flags);
fbe_status_t fbe_lun_clear_clustered_flag(fbe_lun_t * lun_p, fbe_lun_clustered_flags_t flags);
fbe_status_t lun_process_memory_update_message(fbe_lun_t * lun_p);

/* fbe_lun_zero.c */
fbe_status_t fbe_lun_zero_start_lun_zeroing_packet_allocation(fbe_lun_t * lun_p, fbe_packet_t * packet_p);
fbe_status_t fbe_lun_zero_get_raid_extent_zero_checkpoint(fbe_lun_t * lun_p, fbe_packet_t * packet_p);
fbe_status_t fbe_lun_zero_calculate_zero_percent_for_lu_extent(fbe_lun_t * lun_p,
                                                               fbe_lba_t   lu_zero_checkpoint_p,
                                                               fbe_u16_t * lu_zero_percentage_p);
fbe_status_t fbe_lun_zero_calculate_zero_checkpoint_for_lu_extent(fbe_lun_t * lun_p,
...
static fbe_status_t 
fbe_lun_monitor_initiate_lun_dirty_verify_cond_function_completion(fbe_packet_t * in_packet_p,
                                                                   fbe_packet_completion_context_t in_context);
...
fbe_lifecycle_status_t 
fbe_lun_join_request(fbe_lun_t * lun_p, fbe_packet_t * packet_p);

fbe_lifecycle_status_t 
fbe_lun_join_passive(fbe_lun_t * lun_p, fbe_packet_t * packet_p);

fbe_lifecycle_status_t 
fbe_lun_join_active(fbe_lun_t * lun_p, fbe_packet_t * packet_p);

fbe_lifecycle_status_t 
fbe_lun_join_done(fbe_lun_t * lun_p, fbe_packet_t * packet_p);

fbe_lifecycle_status_t 
fbe_lun_join_sync_complete(fbe_lun_t * lun_p, fbe_packet_t * packet_p);
