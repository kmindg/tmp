...
/*!**************************************************************************
 * @file fbe_ext_pool_lun_software_errors.c
 ***************************************************************************
 *
 * @brief
...
/*!**************************************************************
 * fbe_ext_pool_lun_is_unexpected_error_limit_hit()
 ****************************************************************
 * @brief
...
/******************************************
 * end fbe_ext_pool_lun_is_unexpected_error_limit_hit()
 ******************************************/

/*!**************************************************************
 * fbe_ext_pool_lun_eval_err_request()
 ****************************************************************
 * @brief
 *  Checks if our error limit has been exceeded or not.
 *
...
fbe_status_t fbe_ext_pool_lun_eval_err_request(fbe_ext_pool_lun_t *lun_p)
{
     ...
     */
    if (!fbe_ext_pool_lun_is_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REQUEST))
    {
        fbe_base_object_trace((fbe_base_object_t *)lun_p, FBE_TRACE_LEVEL_INFO, FBE_TRACE_MESSAGE_ID_INFO,
                              "LUN %s eval err marking request local state: 0x%llx\n",
                              b_is_active ? "Active" : "Passive",
                              lun_p->local_state);
        fbe_ext_pool_lun_set_clustered_flag(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REQUEST);
     ...
     */
    b_peer_flag_set = fbe_ext_pool_lun_is_peer_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REQUEST);
...
/**************************************
 * end fbe_ext_pool_lun_eval_err_request()
 **************************************/
/*!**************************************************************
 * fbe_ext_pool_lun_eval_err_active()
 ****************************************************************
 * @brief
 *  Checks if our error limit has been exceeded or not.
 *
...
fbe_status_t fbe_ext_pool_lun_eval_err_active(fbe_ext_pool_lun_t *lun_p)
{
     ...
     */
    fbe_ext_pool_lun_lock(lun_p);
    if (!fbe_ext_pool_lun_is_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_THRESHOLD_REACHED) &&
        !fbe_ext_pool_lun_is_peer_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_THRESHOLD_REACHED))
    {
        fbe_base_object_trace((fbe_base_object_t *)lun_p, FBE_TRACE_LEVEL_INFO, FBE_TRACE_MESSAGE_ID_INFO,
    ...
    else if (!fbe_ext_pool_lun_is_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REBOOT_PEER))
    {
        ...
        if (status == FBE_STATUS_OK)
        {
             ...
             */
            fbe_ext_pool_lun_set_clustered_flag(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REBOOT_PEER);
            fbe_base_object_trace((fbe_base_object_t *)lun_p, FBE_TRACE_LEVEL_WARNING, FBE_TRACE_MESSAGE_ID_INFO,
...
/**************************************
 * end fbe_ext_pool_lun_eval_err_active()
 **************************************/

/*!**************************************************************
 * fbe_ext_pool_lun_eval_err_passive()
 ****************************************************************
 * @brief
 *  Checks if our error limit has been exceeded or not.
 *
...
fbe_status_t fbe_ext_pool_lun_eval_err_passive(fbe_ext_pool_lun_t *lun_p)
{
    ...
    if (fbe_cmi_is_peer_alive() &&
        !fbe_ext_pool_lun_is_peer_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REQUEST))
    {
        fbe_base_object_trace((fbe_base_object_t *)lun_p, FBE_TRACE_LEVEL_WARNING, FBE_TRACE_MESSAGE_ID_INFO,
    ...
    if (fbe_ext_pool_lun_is_peer_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REBOOT_PEER))
    {
...
/**************************************
 * end fbe_ext_pool_lun_eval_err_passive()
 **************************************/
/*******************************
 * end fbe_ext_pool_lun_software_errors.c
 *******************************/
