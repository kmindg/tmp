 ...
 * 
 *  This includes the
 *  @ref fbe_lun_monitor_entry "lun monitor entry point", as well as all
...
fbe_status_t 
fbe_lun_monitor_entry(fbe_object_handle_t object_handle, 
                              fbe_packet_t * packet_p)
{
    ...
    status = fbe_base_config_monitor_crank_object(&fbe_lun_lifecycle_const, 
                                        (fbe_base_object_t*)lun_p, packet_p);
    return status;
}
/******************************************
 * end fbe_lun_monitor_entry()
 ******************************************/
...
fbe_status_t fbe_lun_monitor_load_verify(void)
{
    fbe_lun_monitor_io_counter = 0;
    return fbe_lifecycle_class_const_verify(&FBE_LIFECYCLE_CONST_DATA(lun));
}
/******************************************
 * end fbe_lun_monitor_load_verify()
 ******************************************/

/*--- local function prototypes --------------------------------------------------------*/
static fbe_lifecycle_status_t lun_downstream_health_broken_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
static fbe_lifecycle_status_t lun_negotiate_block_size_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
static fbe_lifecycle_status_t lun_downstream_health_disabled_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
...
static fbe_lifecycle_status_t fbe_lun_monitor_check_flush_for_destroy_cond_function(fbe_base_object_t* object_p, fbe_packet_t* packet_p);
static fbe_status_t lun_check_power_saving_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
static fbe_lifecycle_status_t lun_wait_before_hibernation_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
static fbe_lifecycle_status_t lun_get_power_save_info_from_raid_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
static fbe_lifecycle_status_t fbe_lun_monitor_populate_lun_number_cond_function(fbe_base_object_t * object_p, 
                                                                                fbe_packet_t * packet_p);
static fbe_lifecycle_status_t fbe_lun_monitor_initiate_verify_for_newly_bound_lun_cond_function(fbe_base_object_t * object_p, 
                                                                                                fbe_packet_t * packet_p);
...
static fbe_lifecycle_status_t fbe_lun_metadata_memory_init_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

/* It updates nonpaged metadata with default values. */
static fbe_lifecycle_status_t fbe_lun_write_default_nonpaged_metadata_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

/* Persist the default nonpaged metadata */
static fbe_lifecycle_status_t fbe_lun_persist_default_nonpaged_metadata_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

/* Verify the signature data for the provision drive object. */
static fbe_lifecycle_status_t fbe_lun_metadata_verify_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

/* Retrieve the metadata using metadata service and initialize the provision drive object with non paged metadata. */
static fbe_lifecycle_status_t fbe_lun_metadata_element_init_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

/* It starts lun zeroing if it finds object is initialized first time and ndb flag is not set. */
static fbe_lifecycle_status_t fbe_lun_zero_consumed_area_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

/* Initialize the object's nonpaged metadata memory. */
static fbe_lifecycle_status_t fbe_lun_nonpaged_metadata_init_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

/* It updates zero checkpoint for the lu object. */
static fbe_lifecycle_status_t fbe_lun_update_zero_checkpoint_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
...
static fbe_status_t fbe_lun_nonpaged_metadata_init_cond_completion(fbe_packet_t * packet_p, fbe_packet_completion_context_t context);
...
static fbe_status_t fbe_lun_zero_consumed_area_cond_completion(fbe_packet_t * packet_p, fbe_packet_completion_context_t context);
...
static fbe_lifecycle_status_t lu_signal_first_write_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
static fbe_status_t lu_signal_first_write_cond_function_cond_completion(fbe_packet_t * packet_p, fbe_packet_completion_context_t context);
static fbe_lifecycle_status_t lu_written_update_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

static fbe_lifecycle_status_t fbe_lun_write_default_paged_metadata_cond_function(
    fbe_base_object_t * object_p, fbe_packet_t * packet_p);

static fbe_lifecycle_status_t lun_check_local_dirty_flag_cond_function(
    fbe_base_object_t * object_p, fbe_packet_t * packet_p);

static fbe_lifecycle_status_t lun_check_peer_dirty_flag_cond_function(
    fbe_base_object_t * object_p, fbe_packet_t * packet_p);

static fbe_lifecycle_status_t fbe_lun_mark_local_clean_cond_function(
    fbe_base_object_t * object_p, fbe_packet_t * packet_p);

static fbe_lifecycle_status_t fbe_lun_mark_peer_clean_cond_function(
    fbe_base_object_t * object_p, fbe_packet_t * packet_p);

static fbe_lifecycle_status_t fbe_lun_lazy_clean_cond_function(
    fbe_base_object_t * object_p, fbe_packet_t * packet_p);
...
lun_passive_request_join_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

static fbe_lifecycle_status_t 
lun_active_allow_join_cond_function(fbe_base_object_t * object, fbe_packet_t * packet_p);
static fbe_status_t fbe_lun_persist_initial_verify_flag_completion(fbe_packet_t * in_packet_p,
                                                                   fbe_packet_completion_context_t in_context);

static fbe_status_t lun_check_background_operations_progress_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);
static fbe_status_t lun_get_rebuild_status(fbe_packet_t * packet, fbe_lun_t *lun_p);
static fbe_status_t lun_get_rebuild_status_completion(fbe_packet_t * packet_p,
                                                      fbe_packet_completion_context_t context);

static void lun_process_rebuild_progress(fbe_lun_t *lun_p, fbe_u32_t current_rebuilt_percentage);
static void lun_process_zero_progress(fbe_lun_t *lun_p);

static fbe_lifecycle_status_t lun_background_monitor_operation_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p);

static fbe_lifecycle_status_t fbe_lun_unexpected_error_cond_function(fbe_base_object_t * object, fbe_packet_t * packet_p);
...
static fbe_status_t fbe_lun_mark_all_clean(fbe_lun_t * lun_p, 
                                      fbe_packet_t *packet_p);
static fbe_status_t 
fbe_lun_mark_all_clean_local_completion(fbe_packet_t * packet_p,
                                        fbe_packet_completion_context_t context);
static fbe_lifecycle_status_t lun_packet_cancelled_cond_function(fbe_base_object_t * object_p, 
                                                                 fbe_packet_t * packet_p);


static fbe_lifecycle_status_t fbe_lun_verify_cond_function(fbe_base_object_t * object, fbe_packet_t * packet_p);
static fbe_status_t fbe_lun_initiate_verify_completion(fbe_packet_t * in_packet_p,
                                                                   fbe_packet_completion_context_t in_context);
static fbe_bool_t fbe_lun_update_zero_checkpoint_need_to_run(fbe_lun_t *lun_p, fbe_packet_t * packet_p);

/*--- lifecycle callback functions -----------------------------------------------------*/
FBE_LIFECYCLE_DEF_CALLBACK_GET_INST_DATA(lun);
FBE_LIFECYCLE_DEF_CALLBACK_GET_INST_COND(lun);

/*  lun_lifecycle_callbacks
 *  This variable has all the callbacks the lifecycle needs.
 */
static fbe_lifecycle_const_callback_t FBE_LIFECYCLE_CALLBACKS(lun) = {
    FBE_LIFECYCLE_DEF_CONST_CALLBACKS(
        lun,
        FBE_LIFECYCLE_NULL_FUNC,          /* online function */
        fbe_lun_pending_func)/* pending function */        
};
...
static fbe_lifecycle_const_cond_t lun_downstream_health_broken_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        lun_downstream_health_broken_cond_function)
};
...
static fbe_lifecycle_const_cond_t lun_downstream_health_disabled_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        lun_downstream_health_disabled_cond_function)
};
...
static fbe_lifecycle_const_cond_t lun_negotiate_block_size_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        lun_negotiate_block_size_cond_function)
};
...
static fbe_lifecycle_const_cond_t lun_metadata_memory_init_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        fbe_lun_metadata_memory_init_cond_function)
};
...
static fbe_lifecycle_const_cond_t lun_nonpaged_metadata_init_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        fbe_lun_nonpaged_metadata_init_cond_function)         
};
...
static fbe_lifecycle_const_cond_t lun_metadata_element_init_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        fbe_lun_metadata_element_init_cond_function)
};
...
static fbe_lifecycle_const_cond_t lun_metadata_verify_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        fbe_lun_metadata_verify_cond_function)
};
...
static fbe_lifecycle_const_cond_t lun_write_default_nonpaged_metadata_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        fbe_lun_write_default_nonpaged_metadata_cond_function)
};
...
static fbe_lifecycle_const_cond_t lun_persist_default_nonpaged_metadata_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        fbe_lun_persist_default_nonpaged_metadata_cond_function)
};
...
static fbe_lifecycle_const_cond_t lun_zero_consumed_area_cond = {
    FBE_LIFECYCLE_DEF_CONST_DERIVED_COND(
        ...
        fbe_lun_zero_consumed_area_cond_function)
};
...
static fbe_lifecycle_const_base_cond_t lun_check_flush_for_destroy = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        fbe_lun_monitor_check_flush_for_destroy_cond_function),
...
static fbe_lifecycle_const_base_timer_cond_t lun_wait_before_hibernation = {
    {
        FBE_LIFECYCLE_DEF_CONST_BASE_TIMER_COND(
            ...
            lun_wait_before_hibernation_cond_function),
        FBE_LIFECYCLE_DEF_CONST_COND_STATE_TRANSITIONS(
            FBE_LIFECYCLE_STATE_SPECIALIZE,         /* SPECIALIZE */
            FBE_LIFECYCLE_STATE_ACTIVATE,        /* ACTIVATE */
            FBE_LIFECYCLE_STATE_READY,           /* READY */
...
static fbe_lifecycle_const_base_cond_t lun_get_power_save_info_from_raid = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        lun_get_power_save_info_from_raid_cond_function),
...
/* populate_lun_number
 * FBE_LUN_LIFECYCLE_COND_POPULATE_LUN_NUMBER
 * The purpose of this condition is to populate a
 * valid lun number in the perfstats data for the object
 */
static fbe_lifecycle_const_base_cond_t populate_lun_number_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        "populate_lun_number",
        FBE_LUN_LIFECYCLE_COND_POPULATE_LUN_NUMBER,
        fbe_lun_monitor_populate_lun_number_cond_function),
...
static fbe_lifecycle_const_base_cond_t verify_new_lun_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        "verify_new_lun",
        FBE_LUN_LIFECYCLE_COND_VERIFY_NEW_LUN,
        fbe_lun_monitor_initiate_verify_for_newly_bound_lun_cond_function),
...
static fbe_lifecycle_const_base_cond_t lu_signal_first_write_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        FBE_LUN_LIFECYCLE_COND_LUN_SIGNAL_FIRST_WRITE,
        lu_signal_first_write_cond_function),
...
static fbe_lifecycle_const_base_cond_t lu_written_update_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        FBE_LUN_LIFECYCLE_COND_LUN_MARK_LUN_WRITTEN,
        lu_written_update_cond_function),
...
static fbe_lifecycle_const_base_cond_t lun_lazy_clean_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        fbe_lun_lazy_clean_cond_function),
...
static fbe_lifecycle_const_base_cond_t lun_check_local_dirty_flag_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        FBE_LUN_LIFECYCLE_COND_CHECK_LOCAL_DIRTY_FLAG,
        lun_check_local_dirty_flag_cond_function),
...
static fbe_lifecycle_const_base_cond_t lun_check_peer_dirty_flag_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        FBE_LUN_LIFECYCLE_COND_CHECK_PEER_DIRTY_FLAG,
        lun_check_peer_dirty_flag_cond_function),
...
static fbe_lifecycle_const_base_cond_t lun_mark_local_clean_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        FBE_LUN_LIFECYCLE_COND_MARK_LOCAL_CLEAN,
        fbe_lun_mark_local_clean_cond_function),
...
static fbe_lifecycle_const_base_cond_t lun_mark_peer_clean_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        ...
        FBE_LUN_LIFECYCLE_COND_MARK_PEER_CLEAN,
        fbe_lun_mark_peer_clean_cond_function),
...
static fbe_lifecycle_const_base_cond_t lun_unexpected_error_cond = {
    FBE_LIFECYCLE_DEF_CONST_BASE_COND(
        "lun_unexpected_error_cond",
        FBE_LUN_LIFECYCLE_COND_UNEXPECTED_ERROR,
        fbe_lun_unexpected_error_cond_function),
 ...
 */
static fbe_lifecycle_const_base_cond_t * FBE_LIFECYCLE_BASE_COND_ARRAY(lun)[] = {
    &lun_check_flush_for_destroy,
 ...
 */
FBE_LIFECYCLE_DEF_CONST_BASE_CONDITIONS(lun);


/*! @todo For now there are no base conditions.  Uncomment the above if we add them.
 */
//FBE_LIFECYCLE_DEF_CONST_NULL_BASE_CONDITIONS(lun);
...
static fbe_lifecycle_const_rotary_cond_t lun_ready_rotary[] = {
    ...
    FBE_LIFECYCLE_DEF_CONST_ROTARY_COND(populate_lun_number_cond, FBE_LIFECYCLE_ROTARY_COND_ATTR_IS_PRESET),
...
static fbe_lifecycle_const_rotary_t FBE_LIFECYCLE_ROTARY_ARRAY(lun)[] = {
...
FBE_LIFECYCLE_DEF_CONST_ROTARIES(lun);

/*--- global lun lifecycle constant data ----------------------------------------*/

fbe_lifecycle_const_t FBE_LIFECYCLE_CONST_DATA(lun) = {
    FBE_LIFECYCLE_DEF_CONST_DATA(
        lun,
        FBE_CLASS_ID_LUN,                  /* This class */
 ...
 ****************************************************************/
static fbe_lifecycle_status_t 
lun_downstream_health_broken_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_lun_t * lun_p = (fbe_lun_t *)object_p;
    fbe_status_t status;
    ...
    /* Look for all the edges with downstream objects.
       */
    downstream_health_state = fbe_lun_verify_downstream_health(lun_p);
    ...
    switch (downstream_health_state)
    {
        ...
        case FBE_DOWNSTREAM_HEALTH_DISABLED:
            ...
            if (fbe_lun_is_unexpected_error_limit_hit(lun_p)){
            ...
            status = fbe_lun_clear_clustered_flag(lun_p, FBE_LUN_CLUSTERED_FLAG_THRESHOLD_REACHED);
            ...
            fbe_lifecycle_set_cond(&fbe_lun_lifecycle_const, (fbe_base_object_t *)lun_p, FBE_BASE_OBJECT_LIFECYCLE_COND_ACTIVATE);
            break;
...
/*************************************************
 * end lun_downstream_health_broken_cond_function()
 *************************************************/
 ...
 ****************************************************************/
static fbe_lifecycle_status_t 
lun_negotiate_block_size_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_status_t status;
    fbe_lun_t * lun_p = (fbe_lun_t *)object_p;
...
/**************************************
 * end lun_negotiate_block_size_cond_function()
 **************************************/

static fbe_lifecycle_status_t 
lun_downstream_health_disabled_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_lun_t * lun = (fbe_lun_t *)object_p;
    fbe_base_config_downstream_health_state_t downstream_health_state;
    ...
    downstream_health_state = fbe_lun_verify_downstream_health(lun);
 ...
 ****************************************************************
 * @brief
 *  This is the condition function to mark the lun for population
 * of the lun number in its perfstats memory. This is to satisfy an Observability
 * requirement that all backend objects report the same identifier when they poll.
 *
 * @param object_p - current object.
 * @param packet_p - monitor packet
 *
 * @return fbe_lifecycle_status_t - FBE_STATUS_OK   
 *
 * @author
 *  09/17/2013 - Created. Ryan Gadsby
 *
 ****************************************************************/

static fbe_lifecycle_status_t 
fbe_lun_monitor_populate_lun_number_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
      fbe_lun_t*                     lun_p;
    
      lun_p  = (fbe_lun_t *)object_p;
      ...
      if (lun_p->performance_stats.counter_ptr.lun_counters) 
      {
            fbe_database_get_lun_number(lun_p->performance_stats.counter_ptr.lun_counters->object_id,
                                     &lun_p->performance_stats.counter_ptr.lun_counters->lun_number);

            if (lun_p->performance_stats.counter_ptr.lun_counters->lun_number == FBE_U32_MAX) 
            { //database didn't have lun number at the time of the last poll, so don't clear condition.
               fbe_base_object_trace((fbe_base_object_t*)lun_p,
                             FBE_TRACE_LEVEL_DEBUG_HIGH,
                             FBE_TRACE_MESSAGE_ID_FUNCTION_ENTRY,
                             "%s : LUN number isn't set for object ID 0x%x", __FUNCTION__, lun_p->performance_stats.counter_ptr.lun_counters->object_id);
            }
            else
            {
...
/**************************************
 * end fbe_lun_monitor_populate_lun_number_cond_function()
 **************************************/
...
static fbe_lifecycle_status_t 
fbe_lun_monitor_initiate_verify_for_newly_bound_lun_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_status_t                   status; 
    fbe_lun_t*                     lun_p;
   ...
   // Tell the RAID object to initialize its verify data for this lun.
    status = fbe_lun_usurper_send_initiate_verify_to_raid(lun_p, packet_p, &initiate_verify);

    return FBE_LIFECYCLE_STATUS_PENDING;

}
/**************************************
 * end fbe_lun_monitor_initiate_verify_for_newly_bound_lun_cond_function()
 **************************************/
 ...
 ****************************************************************/
static fbe_lifecycle_status_t 
fbe_lun_monitor_check_flush_for_destroy_cond_function(fbe_base_object_t* object_p, 
                                                      fbe_packet_t* packet_p)
{
    fbe_status_t                                status;
    fbe_lun_t*                                  lun_p = (fbe_lun_t *)object_p;
...
/**************************************
 * end fbe_lun_monitor_check_flush_for_destroy_cond_function()
 **************************************/
/*!****************************************************************************
 * fbe_lun_metadata_memory_init_cond_function()
 ******************************************************************************
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t 
fbe_lun_metadata_memory_init_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_lun_t * lun_p = NULL;
...
/******************************************************************************
 * end fbe_lun_metadata_memory_init_cond_function()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t 
fbe_lun_nonpaged_metadata_init_cond_function(fbe_base_object_t * object_p,
                                             fbe_packet_t * packet_p)
{
    fbe_lun_t *         lun_p = NULL;
    fbe_status_t        status;
    ...
    fbe_transport_set_completion_function(packet_p, fbe_lun_nonpaged_metadata_init_cond_completion, lun_p);

    /* initialize signature for the raid group object. */
    status = fbe_lun_nonpaged_metadata_init(lun_p, packet_p);
    return FBE_LIFECYCLE_STATUS_PENDING;
}
/******************************************************************************
 * end fbe_lun_nonpaged_metadata_init_cond_function()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_lun_nonpaged_metadata_init_cond_completion()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t 
fbe_lun_nonpaged_metadata_init_cond_completion(fbe_packet_t * packet_p,
                                               fbe_packet_completion_context_t context)
{
    fbe_lun_t *                         lun_p = NULL;
    ...
    if((control_status == FBE_PAYLOAD_CONTROL_STATUS_OK) && (status == FBE_STATUS_OK))
    {
        ...
        fbe_lifecycle_reschedule(&fbe_lun_lifecycle_const,
...
/******************************************************************************
 * end fbe_lun_nonpaged_metadata_init_cond_completion()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t 
fbe_lun_metadata_element_init_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_lun_t      *lun_p = NULL;
    ...
    fbe_lun_metadata_initialize_metadata_element(lun_p, packet_p);
    return FBE_LIFECYCLE_STATUS_PENDING;
}
/******************************************************************************
 * end fbe_lun_metadata_element_init_cond_function()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t 
fbe_lun_metadata_verify_cond_function(fbe_base_object_t * object, fbe_packet_t * packet_p)
{
    fbe_lun_t * lun_p = NULL;
    ...
    if (is_metadata_initialized) {
        ...
        if (disk_version_size != memory_version_size) {
            ...
            fbe_base_object_trace((fbe_base_object_t*)lun_p,
                              FBE_TRACE_LEVEL_WARNING,
                              FBE_TRACE_MESSAGE_ID_INFO,
                              "lun nonpaged verify - on-disk size: %d in-memory size: %d update new values here.\n",
...
/******************************************************************************
 * end fbe_lun_metadata_verify_cond_function()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t 
fbe_lun_zero_consumed_area_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_status_t                   status; 
    fbe_lun_t*                     lun_p;
    fbe_lba_t                      block_count;
    ...
    fbe_lun_check_hook(lun_p, SCHEDULER_MONITOR_STATE_LUN_ZERO,
...
/******************************************************************************
 * end fbe_lun_zero_consumed_area_cond_function()
 ******************************************************************************/
                                            ...
                                            fbe_packet_completion_context_t context)
{
    ...
    fbe_transport_set_completion_function(packet_p, fbe_lun_zero_consumed_area_cond_completion, lun_p);

    /* initialize lun signature. */ 
    status = fbe_lun_zero_start_lun_zeroing_packet_allocation(lun_p, packet_p);
    return FBE_STATUS_MORE_PROCESSING_REQUIRED;
}
/**************************************
 * end fbe_lun_persist_initial_verify_flag_completion()
 **************************************/
/*!****************************************************************************
 * fbe_lun_zero_consumed_area_cond_completion()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t 
fbe_lun_zero_consumed_area_cond_completion(fbe_packet_t * packet_p, fbe_packet_completion_context_t context)
{
    fbe_lun_t *                         lun_p = NULL;
    fbe_payload_ex_t *                     payload = NULL;
    fbe_payload_control_operation_t *   control_operation = NULL;
...
/******************************************************************************
 * end fbe_lun_zero_consumed_area_cond_completion()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t 
fbe_lun_write_default_nonpaged_metadata_cond_function(fbe_base_object_t * object_p,
                                                      fbe_packet_t * packet_p)
{
    fbe_lun_t *         lun_p = NULL;
    fbe_status_t        status;
    ...
    if (fbe_base_config_is_active((fbe_base_config_t *)object_p))
    {
        ...
        /* initialize signature for the raid group object. */
        status = fbe_lun_metadata_write_default_nonpaged_metadata(lun_p, packet_p);
        return FBE_LIFECYCLE_STATUS_PENDING;
    }
...
/******************************************************************************
 * end fbe_lun_write_default_nonpaged_metadata_cond_function()
 ******************************************************************************/
 ...
 *
 ******************************************************************************/
static fbe_lifecycle_status_t fbe_lun_persist_default_nonpaged_metadata_cond_function(fbe_base_object_t * object_p, 
                                                                                      fbe_packet_t * packet_p)
{
    fbe_status_t status;
...
/******************************************************************************
 * end fbe_lun_persist_default_nonpaged_metadata_cond_function()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_bool_t
fbe_lun_update_zero_checkpoint_need_to_run(fbe_lun_t *lun_p, fbe_packet_t * packet_p)
{
    fbe_status_t    status;
     ...
     */
    status = fbe_lun_metadata_get_zero_checkpoint(lun_p, &zero_checkpoint);
...
/*!****************************************************************************
 * fbe_lun_update_zero_checkpoint_cond_function()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t
fbe_lun_update_zero_checkpoint_cond_function(fbe_base_object_t * object_p,
                                             fbe_packet_t * packet_p)
{
    fbe_lun_t *         lun_p = NULL;
    fbe_status_t        status;
    ...
    status = fbe_lun_zero_get_raid_extent_zero_checkpoint(lun_p, packet_p);
...
/******************************************************************************
 * end fbe_lun_update_zero_checkpoint_cond_function()
 ******************************************************************************/
...
static fbe_status_t lun_check_power_saving_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    ...
    if (!fbe_base_config_is_clustered_flag_set(base_config_p, FBE_BASE_CONFIG_CLUSTERED_FLAG_HIBERNATE_READY)) 
    {
       ...
       /*before we go to slumer, we mark the path state as FBE_BLOCK_PATH_ATTR_FLAGS_CLIENT_IS_READY_TO_HIBERNATE. This will generate an event at the BVD level
        ...
        to hibernate. LUN also needs to make sure it waits enough time as described in fbe_lun_t.power_save_io_drain_delay*/
    ...
    fbe_lifecycle_set_cond(&fbe_lun_lifecycle_const, object_p, FBE_LUN_LIFECYCLE_COND_LUN_WAIT_BEFORE_HIBERNATION);
...
static fbe_lifecycle_status_t lun_wait_before_hibernation_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    ...
    time the monitor kicked, but the other option is for each IO to do some expensive checks.
    we also have to check if by any chance the power saving was disabled along the way*/
    /* Geng: we have to not only check oustanding_io, but also the flag FBE_BLOCK_TRANSPORT_FLAGS_IO_IN_PROGRESS
     */
    io_in_progess = (base_config_p->block_transport_server.attributes & FBE_BLOCK_TRANSPORT_FLAGS_IO_IN_PROGRESS);
    ...
    if (outstanding_io != 0 ||
        ...
        status = fbe_lifecycle_stop_timer(&fbe_lun_lifecycle_const, object_p, FBE_LUN_LIFECYCLE_COND_LUN_WAIT_BEFORE_HIBERNATION);
        if (status != FBE_STATUS_OK) {
...
static fbe_lifecycle_status_t   lun_get_power_save_info_from_raid_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet)
{
    fbe_lun_t *                                     lun_p = (fbe_lun_t *)object_p;
 ...
 *
 ****************************************************************/
fbe_lifecycle_status_t fbe_lun_clear_peer_state(fbe_lun_t *lun_p)
{
    ...
    status = fbe_lifecycle_get_state(&fbe_lun_lifecycle_const, (fbe_base_object_t*)lun_p, &lifecycle_state);
...
fbe_lun_pending_func(fbe_base_object_t *base_object_p, fbe_packet_t * packet)
{
     ...
     */
    status = fbe_lun_handle_shutdown(lun_p);
...
/**************************************
 * end fbe_lun_pending_func()
 **************************************/

/****************************************************************
 *  fbe_lun_handle_shutdown
 ****************************************************************
 * @brief
...
fbe_status_t fbe_lun_handle_shutdown(fbe_lun_t * const lun_p)
{
...
static fbe_lifecycle_status_t lu_signal_first_write_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    ...
    {
        fbe_transport_set_completion_function(packet_p, lu_signal_first_write_cond_function_cond_completion, lun_p);
        status = fbe_lun_metadata_set_lun_has_been_written(lun_p, packet_p);
...
static fbe_status_t 
lu_signal_first_write_cond_function_cond_completion(fbe_packet_t * packet_p, fbe_packet_completion_context_t context)
{
    ...
    if((control_status == FBE_PAYLOAD_CONTROL_STATUS_OK) && (status == FBE_STATUS_OK)){
        ...
        fbe_lifecycle_clear_current_cond((fbe_base_object_t *) lun_p);
        fbe_lifecycle_set_cond(&fbe_lun_lifecycle_const, (fbe_base_object_t *)lun_p, FBE_BASE_CONFIG_LIFECYCLE_COND_PERSIST_NON_PAGED_METADATA);
...
fbe_lun_metadata_write_default_paged_metadata(fbe_lun_t * lun_p,
                                              fbe_packet_t *packet_p);
static fbe_lifecycle_status_t 
fbe_lun_write_default_paged_metadata_cond_function(fbe_base_object_t * object_p,
                                                   fbe_packet_t * packet_p)
{
    fbe_lun_t *         lun_p = NULL;
    fbe_status_t        status;
...
/******************************************************************************
 * end fbe_lun_write_default_paged_metadata_cond_function()
 ******************************************************************************/
                                           ...
                                           fbe_packet_t *packet_p)
{
    ...
    status = fbe_lun_mark_local_clean(lun_p, packet_p,
                                        ...
                                        fbe_packet_completion_context_t context)
{
    ...
    fbe_lun_mark_peer_clean(lun_p, packet_p,
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t
fbe_lun_mark_local_clean_cond_function(fbe_base_object_t * object_p,
                                       fbe_packet_t * packet_p)
{
    fbe_lun_t *         lun_p = NULL;
    fbe_status_t        status;
    ...
    status = fbe_lun_mark_local_clean(lun_p, packet_p, fbe_lun_mark_local_clean_completion);
...
/******************************************************************************
 * end fbe_lun_mark_local_clean_cond_function()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t
fbe_lun_mark_peer_clean_cond_function(fbe_base_object_t * object_p,
                                       fbe_packet_t * packet_p)
{
    fbe_lun_t *         lun_p = NULL;
    fbe_status_t        status;
    ...
    status = fbe_lun_mark_peer_clean(lun_p, packet_p, fbe_lun_mark_peer_clean_completion);
    if(status == FBE_STATUS_OK) {
        return FBE_LIFECYCLE_STATUS_PENDING;
    }
...
/******************************************************************************
 * end fbe_lun_mark_peer_clean_cond_function()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t
fbe_lun_lazy_clean_cond_function(fbe_base_object_t * object_p,
                                 fbe_packet_t * packet_p)
{
    fbe_lun_t                  *lun_p = NULL;
    fbe_status_t                status;
...
/******************************************************************************
 * end fbe_lun_lazy_clean_cond_function()
 ******************************************************************************/
                                    ...
                                    fbe_packet_completion_context_t context)
{
    ...
    fbe_lifecycle_force_clear_cond(&fbe_lun_lifecycle_const,
                                   (fbe_base_object_t*)lun_p,
                                   FBE_LUN_LIFECYCLE_COND_LAZY_CLEAN);
...
static fbe_lifecycle_status_t 
lun_check_local_dirty_flag_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_status_t                    status; 
    fbe_lun_t*                      lun_p   = NULL;
...
/**************************************
 * end lun_check_local_dirty_flag_cond_function()
 **************************************/
...
static fbe_lifecycle_status_t 
lun_check_peer_dirty_flag_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    fbe_status_t                    status; 
    fbe_lun_t*                      lun_p   = NULL;
    fbe_lun_clean_dirty_context_t * context = NULL;
 ...
 ******************************************************************************/
fbe_status_t lun_check_common_dirty_flag_completion(fbe_packet_t * in_packet_p,
                                                    fbe_packet_completion_context_t in_context,
                                                    fbe_bool_t peer_sp)
{
    fbe_status_t                    status; 
    ...
    if(context->dirty)
    {
        ...
        status = fbe_lun_usurper_send_initiate_verify_to_raid(
...
lun_passive_request_join_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    ...
    fbe_base_object_trace((fbe_base_object_t *)lun_p, 
                          FBE_TRACE_LEVEL_INFO, 
                          FBE_TRACE_MESSAGE_ID_INFO,
                          "LUN Join Active cflags: 0x%llx Passive cflags: 0x%llx Passive state:0x%llx\n", 
    ...
    {
       if (fbe_lun_is_peer_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_THRESHOLD_REACHED))
       { 
           fbe_lun_unlock(lun_p);
        ...
        fbe_base_object_trace((fbe_base_object_t *)lun_p, FBE_TRACE_LEVEL_INFO, FBE_TRACE_MESSAGE_ID_INFO,
                              ...
                              (unsigned long long)lun_p->lun_metadata_memory.base_config_metadata_memory.flags,
                              (unsigned long long)lun_p->lun_metadata_memory_peer.base_config_metadata_memory.flags);                              
        fbe_lifecycle_set_cond(&fbe_lun_lifecycle_const, (fbe_base_object_t *)lun_p, 
                               FBE_BASE_CONFIG_LIFECYCLE_COND_DOWNSTREAM_HEALTH_BROKEN);
        fbe_lun_unlock(lun_p);
        return FBE_LIFECYCLE_STATUS_DONE;
    }
    ...
    if (fbe_lun_is_local_state_set(lun_p, FBE_LUN_LOCAL_STATE_JOIN_DONE))
    {
        ...
        fbe_lun_unlock(lun_p);
        return fbe_lun_join_done(lun_p, packet_p);
    }
    else if (fbe_lun_is_local_state_set(lun_p, FBE_LUN_LOCAL_STATE_JOIN_STARTED))
    {
        ...
        fbe_lun_unlock(lun_p);
        return fbe_lun_join_passive(lun_p, packet_p);
    }
    else
    {
        fbe_base_object_trace((fbe_base_object_t*)lun_p, 
        ...
        fbe_lun_unlock(lun_p);
        return fbe_lun_join_request(lun_p, packet_p);
    }
}
/******************************************************************************
 * end lun_passive_request_join_cond_function()
 ******************************************************************************/
...
lun_active_allow_join_cond_function(fbe_base_object_t * object, fbe_packet_t * packet_p)
{
    ...
    fbe_base_object_trace((fbe_base_object_t *)lun_p, 
                          FBE_TRACE_LEVEL_INFO, 
                          FBE_TRACE_MESSAGE_ID_INFO,
                          "LUN Join Active cflags: 0x%llx Passive cflags: 0x%llx Active state:0x%llx\n", 
                          (unsigned long long)lun_p->lun_metadata_memory.base_config_metadata_memory.flags,
                          (unsigned long long)lun_p->lun_metadata_memory_peer.base_config_metadata_memory.flags,
                          (unsigned long long)lun_p->local_state);
    ...
    if (fbe_lun_is_local_state_set(lun_p, FBE_LUN_LOCAL_STATE_JOIN_STARTED))
    {
        ...
        fbe_lun_unlock(lun_p);
        return fbe_lun_join_active(lun_p, packet_p);
    }
...
/******************************************************************************
 * end lun_active_allow_join_cond_function()
 ******************************************************************************/
/*!**************************************************************
 * fbe_lun_check_hook()
 ****************************************************************
 ...
 *
 ****************************************************************/
fbe_status_t fbe_lun_check_hook(fbe_lun_t *lun_p,
                                fbe_u32_t state,
                                fbe_u32_t substate,
                                fbe_u64_t val2,
...
/******************************************
 * end fbe_lun_check_hook()
 ******************************************/

/*!****************************************************************************
 * lun_check_background_operations_progress_cond_function()
 ******************************************************************************
 * @brief
 *
...
static void lun_process_rebuild_progress(fbe_lun_t *lun_p, fbe_u32_t current_rebuilt_percentage)
{
    ...
    else if (lun_p->last_rebuild_percent == 100 && current_rebuilt_percentage == 100) 
    {
        /* If we have been already rebuilt 100% we should not be rebuild in progress
         * Raid group usurper sets rebuild in progress blindly if there is a position to be rebuilt
         * even though this lun could've already been rebuilt. Raid group does not know of the 
         * lun's previous rebuilt percent. 
         */
        lun_p->rebuild_status.is_rebuild_in_progress = FBE_FALSE;
    }
...
static void lun_process_zero_progress(fbe_lun_t *lun_p)
{
    ...
    status = fbe_lun_metadata_get_zero_checkpoint(lun_p, &lu_zero_checkpoint);
...
static fbe_lifecycle_status_t lun_background_monitor_operation_cond_function(fbe_base_object_t * object_p, fbe_packet_t * packet_p)
{
    ...
    if (fbe_base_config_is_system_bg_service_enabled(FBE_BASE_CONFIG_CONTROL_SYSTEM_BG_SERVICE_ENABLE_ZERO_CHKPT_UPDATE) &&
        fbe_lun_update_zero_checkpoint_need_to_run((fbe_lun_t *)object_p, packet_p)                                                   )
    {
        /* update the zero checkpoint. */
        return fbe_lun_update_zero_checkpoint_cond_function(object_p, packet_p);
    }
    ...
    if (power_save_state != FBE_POWER_SAVE_STATE_ENTERING_POWER_SAVE) {
        lun_check_power_saving_cond_function(object_p, packet_p);
    }

    /* leave this first so any checkpoints that are somehow updated will be reported up to upper layers*/
    status = lun_check_background_operations_progress_cond_function(object_p, packet_p);
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t 
fbe_lun_unexpected_error_cond_function(fbe_base_object_t * object, fbe_packet_t * packet_p)
{
    fbe_status_t status;
    fbe_lun_t *  lun_p = (fbe_lun_t*)object;
    fbe_u32_t num_errors;
        ...
        !fbe_lun_is_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_THRESHOLD_REACHED) )
    {
        ...
        fbe_lun_lock(lun_p);
        fbe_lun_set_clustered_flag(lun_p, FBE_LUN_CLUSTERED_FLAG_THRESHOLD_REACHED);
        fbe_lun_unlock(lun_p);
    }
    ...
    else if (fbe_lun_is_local_state_set(lun_p, FBE_LUN_LOCAL_STATE_EVAL_ERR_STARTED))
    {
        if (b_is_active)
        {
            fbe_lun_eval_err_active(lun_p);
        }
        else
        {
            fbe_lun_eval_err_passive(lun_p);
        }
        return FBE_LIFECYCLE_STATUS_DONE;
    }
    else
    {
        ...
        fbe_lun_eval_err_request(lun_p);
    }
    return FBE_LIFECYCLE_STATUS_DONE;
}
/******************************************************************************
 * end fbe_lun_unexpected_error_cond_function()
 ******************************************************************************/
 ...
 ******************************************************************************/
static fbe_lifecycle_status_t
fbe_lun_verify_cond_function(fbe_base_object_t *object_p, fbe_packet_t * packet_p)
{
   fbe_lifecycle_state_t lifecycle_state;
   fbe_status_t status;
   fbe_lun_t * lun_object = (fbe_lun_t *)object_p;
   ...
   fbe_lun_usurper_send_initiate_verify_to_raid(lun_object, packet_p, &lun_object->lun_verify);
  
   return FBE_LIFECYCLE_STATUS_PENDING;
}
/******************************************************************************
 * end fbe_lun_verify_cond_function()
 ******************************************************************************/
...
/******************************************************************************
 * end lun_packet_cancelled_cond_function()
 ******************************************************************************/

/*******************************
 * end fbe_lun_monitor.c
 *******************************/
