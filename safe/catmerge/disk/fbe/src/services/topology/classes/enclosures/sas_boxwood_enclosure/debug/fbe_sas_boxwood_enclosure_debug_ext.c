...
/*!*************************************************************************
 * @file fbe_sas_boxwood_enclosure_debug_ext.c
 ***************************************************************************
 *
 * @brief
...
/*!**************************************************************
 * @fn fbe_sas_boxwood_enclosure_debug_prvt_data(const fbe_u8_t * module_name, 
 *                                   fbe_dbgext_ptr sas_boxwood_enclosure_p,
 *                                   fbe_trace_func_t trace_func,
 *                                   fbe_trace_context_t trace_context)
 ****************************************************************
 * @brief
 *  Display private data about the sas boxwood enclosure object.
 *
 * @param  module_name - This is the name of the module we are debugging.
 * @param sas_boxwood_enclosure_p - Ptr to sas boxwood enclosure object.
 ...
 *
 ****************************************************************/
fbe_status_t fbe_sas_boxwood_enclosure_debug_prvt_data(const fbe_u8_t * module_name, 
                                           fbe_dbgext_ptr sas_boxwood_enclosure_p, 
                                           fbe_trace_func_t trace_func, 
                                           fbe_trace_context_t trace_context)

{
  ...
  fbe_eses_enclosure_debug_prvt_data(module_name, sas_boxwood_enclosure_p + eses_enclosure_offset ,trace_func,trace_context);
  return FBE_STATUS_OK;
}
