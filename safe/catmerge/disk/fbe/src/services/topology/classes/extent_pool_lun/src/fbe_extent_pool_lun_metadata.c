...
/*!**************************************************************************
 * @file fbe_extent_pool_lun_metadata.c
 ***************************************************************************
 *
 * @brief
 ...
 *****************************************/
static fbe_status_t 
fbe_ext_pool_lun_metadata_nonpaged_set_generation_num_completion(fbe_packet_t * packet, 
 ...
 *****************************************/
/*!**************************************************************
 * fbe_ext_pool_lun_metadata_is_initial_verify_needed()
 ****************************************************************
 * @brief
...
fbe_bool_t fbe_ext_pool_lun_metadata_is_initial_verify_needed(fbe_ext_pool_lun_t *lun_p)
{
    ...
    if (!fbe_lun_get_noinitialverify_b(lun_p) &&
        !fbe_ext_pool_lun_metadata_was_initial_verify_run(lun_p))
    {
        return FBE_TRUE;
    }
    return FBE_FALSE;
...
/******************************************
 * end fbe_ext_pool_lun_metadata_is_initial_verify_needed()
 ******************************************/

/*!**************************************************************
 * fbe_ext_pool_lun_metadata_was_initial_verify_run()
 ****************************************************************
 * @brief
...
/******************************************
 * end fbe_ext_pool_lun_metadata_was_initial_verify_run()
 ******************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_metadata_initialize_metadata_element()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t
fbe_ext_pool_lun_metadata_initialize_metadata_element(fbe_ext_pool_lun_t * lun_p, fbe_packet_t * packet_p)
{
...
/******************************************************************************
 * end fbe_ext_pool_lun_metadata_initialize_metadata_element()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_nonpaged_metadata_init()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t 
fbe_ext_pool_lun_nonpaged_metadata_init(fbe_ext_pool_lun_t * lun_p, fbe_packet_t *packet_p)
{
    fbe_status_t status;
...
/******************************************************************************
 * end fbe_ext_pool_lun_nonpaged_metadata_init()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_metadata_write_default_nonpaged_metadata()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t 
fbe_ext_pool_lun_metadata_write_default_nonpaged_metadata(fbe_ext_pool_lun_t * lun_p,
...
/*!****************************************************************************
 * fbe_ext_pool_lun_metadata_write_default_paged_metadata()
 ******************************************************************************
 * @brief
                                              ...
                                              fbe_packet_t *packet_p)
{
    ...
    */ 
    ...
    fbe_transport_set_completion_function(packet_p,
                                          fbe_ext_pool_lun_metadata_write_default_paged_metadata_completion,
                                          lun_p);
...
/******************************************************************************
 * end fbe_ext_pool_lun_metadata_write_default_paged_metadata()
 ******************************************************************************/
...
/******************************************************************************
 * end fbe_ext_pool_lun_metadata_write_default_paged_metadata_completion()
 ******************************************************************************/


/*!****************************************************************************
 * fbe_ext_pool_lun_metadata_get_zero_checkpoint()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t 
fbe_ext_pool_lun_metadata_get_zero_checkpoint(fbe_ext_pool_lun_t * lun_p,
...
/******************************************************************************
 * end fbe_ext_pool_lun_metadata_get_zero_checkpoint()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_metadata_set_zero_checkpoint()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t 
fbe_ext_pool_lun_metadata_set_zero_checkpoint(fbe_ext_pool_lun_t * lun_p, 
                                     fbe_packet_t * packet_p,
...
/******************************************************************************
 * end fbe_ext_pool_lun_metadata_set_zero_checkpoint()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_metadata_set_lun_has_been_written()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t 
fbe_ext_pool_lun_metadata_set_lun_has_been_written(fbe_ext_pool_lun_t * lun_p, 
                                          fbe_packet_t * packet_p)
{
    fbe_status_t    status;
...
/******************************************************************************
 * end fbe_ext_pool_lun_metadata_set_lun_has_been_written()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_metadata_nonpaged_set_generation_num_completion()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
 ...
 /******************************************************************************
  * end fbe_ext_pool_lun_metadata_nonpaged_set_generation_num_completion()
  ******************************************************************************/

 /*!****************************************************************************
  * fbe_ext_pool_lun_metadata_nonpaged_set_generation_num()
  ******************************************************************************
  * @brief
                                                                               ...
                                                                               fbe_u32_t metadata_record_data_size)
{
    ...
    fbe_transport_set_completion_function(packet, fbe_ext_pool_lun_metadata_nonpaged_set_generation_num_completion, base_config);
 ...
 /******************************************************************************
  * end fbe_ext_pool_lun_metadata_nonpaged_set_generation_num()
  ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_is_peer_clustered_flag_set()
 ******************************************************************************
 * @brief
...
/**************************************
 * end fbe_ext_pool_lun_is_peer_clustered_flag_set()
 **************************************/

/*!**************************************************************
 * fbe_ext_pool_lun_set_clustered_flag()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
fbe_status_t 
fbe_ext_pool_lun_set_clustered_flag(fbe_ext_pool_lun_t * lun_p, fbe_lun_clustered_flags_t flags)
{
    ...
    if (!((lun_metadata_memory->flags & flags) == flags))
    {
        ...
        fbe_lifecycle_set_cond(&fbe_ext_pool_lun_lifecycle_const, (fbe_base_object_t*)lun_p, FBE_BASE_CONFIG_LIFECYCLE_COND_UPDATE_METADATA_MEMORY);
    }

    return FBE_STATUS_OK;
}
/******************************************
 * end fbe_ext_pool_lun_set_clustered_flag()
 ******************************************/
/*!**************************************************************
 * fbe_ext_pool_lun_clear_clustered_flag()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
fbe_status_t 
fbe_ext_pool_lun_clear_clustered_flag(fbe_ext_pool_lun_t * lun_p, fbe_lun_clustered_flags_t flags)
{
    fbe_lun_metadata_memory_t * lun_metadata_memory = NULL;
...
/******************************************
 * end fbe_ext_pool_lun_clear_clustered_flag()
 ******************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_is_clustered_flag_set()
 ******************************************************************************
 * @brief
...
/**************************************
 * end fbe_ext_pool_lun_is_clustered_flag_set()
 **************************************/
...
fbe_status_t lun_ext_pool_process_memory_update_message(fbe_ext_pool_lun_t * lun_p)
{
        ...
        fbe_ext_pool_lun_is_unexpected_error_limit_hit(lun_p))
    {
        ...
        fbe_lifecycle_reschedule(&fbe_ext_pool_lun_lifecycle_const, (fbe_base_object_t *) lun_p, (fbe_lifecycle_timer_msec_t) 0);
    }
    if (fbe_ext_pool_lun_is_peer_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REQUEST)&&
        !fbe_ext_pool_lun_is_clustered_flag_set(lun_p, FBE_LUN_CLUSTERED_FLAG_EVAL_ERR_REQUEST))
    {
...
/*******************************
 * end fbe_extent_pool_lun_metadata.c
 *******************************/
