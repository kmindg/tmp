 ...
 **********************************************************************/
/*!*************************************************************************
 * @file fbe_sas_viking_drvsxp_enclosure_executer.c
 ***************************************************************************
 *
 * @brief
 *  This file contains entry functions for the viking_drvsxp enclosure class.
 *
...
static fbe_status_t 
fbe_sas_viking_drvsxp_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet);

/*!*************************************************************************
* @fn fbe_sas_viking_drvsxp_enclosure_io_entry(                              
...
***************************************************************************/
fbe_status_t 
fbe_sas_viking_drvsxp_enclosure_io_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet)
{
    ...
    switch(transport_id) 
    {
        case FBE_TRANSPORT_ID_DISCOVERY:
            ...
            */
            status = fbe_base_discovering_discovery_bouncer_entry((fbe_base_discovering_t *) pSasVikingDrvsxpEnclosure,
                                                                        (fbe_transport_entry_t)fbe_sas_viking_drvsxp_enclosure_discovery_transport_entry,
                                                                        packet);
            break;
        default:
...
/*!*************************************************************************
* @fn fbe_sas_viking_drvsxp_enclosure_discovery_transport_entry(                              
...
fbe_sas_viking_drvsxp_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet)
{
    ...
    pSasVikingDrvsxpEnclosure = (fbe_sas_viking_drvsxp_enclosure_t *)base_object;
    ...
    {
        default:
            status = fbe_eses_enclosure_discovery_transport_entry((fbe_base_object_t *)pSasVikingDrvsxpEnclosure, packet);
            break;
    }
...
/*!*************************************************************************
* @fn fbe_sas_viking_drvsxp_enclosure_event_entry(                              
*                    fbe_object_handle_t object_handle,
...
***************************************************************************/
fbe_status_t 
fbe_sas_viking_drvsxp_enclosure_event_entry(fbe_object_handle_t object_handle, 
                                    fbe_event_type_t event_type, 
                                    fbe_event_context_t event_context)
{
    fbe_sas_viking_drvsxp_enclosure_t   *pSasVikingDrvsxpEnclosure = NULL;
...
//End of file fbe_sas_viking_drvsxp_enclosure_executer.c
