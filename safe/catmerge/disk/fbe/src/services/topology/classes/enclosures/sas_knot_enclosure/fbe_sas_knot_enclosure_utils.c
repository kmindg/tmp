...
/*!*************************************************************************
 * @file fbe_sas_knot_enclosure_utils.c
 ***************************************************************************
 *
 * @brief
...
{
    fbe_sas_knot_enclosure_t * knotPrvtData = (fbe_sas_knot_enclosure_t *)enclPrvtData;
    fbe_eses_enclosure_print_prvt_data((void *)&(knotPrvtData->eses_enclosure), trace_func, trace_context);
}
// End of file fbe_sas_knot_enclosure_utils.c
