 ...
 **********************************************************************/
/*!*************************************************************************
 * @file fbe_sas_voyager_icm_enclosure_executer.c
 ***************************************************************************
 *
 * @brief
 *  This file contains entry functions for the voyager_icm enclosure class.
 *
 * @ingroup fbe_enclosure_class
 *
 * HISTORY
 *   26-Feb-2010:  Created from fbe_sas_magnum_enclosure_executer.c -Dipak Patel
 *
 ***************************************************************************/
...
static fbe_status_t 
fbe_sas_voyager_icm_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet);

/*!*************************************************************************
* @fn fbe_sas_voyager_icm_enclosure_io_entry(                              
...
***************************************************************************/
fbe_status_t 
fbe_sas_voyager_icm_enclosure_io_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet)
{
    ...
    switch(transport_id) {
        case FBE_TRANSPORT_ID_DISCOVERY:
            ...
            */
            status = fbe_base_discovering_discovery_bouncer_entry((fbe_base_discovering_t *) sas_voyager_icm_enclosure,
                                                                        (fbe_transport_entry_t)fbe_sas_voyager_icm_enclosure_discovery_transport_entry,
                                                                        packet);
            break;
        default:
...
/*!*************************************************************************
* @fn fbe_sas_voyager_icm_enclosure_discovery_transport_entry(                              
...
fbe_sas_voyager_icm_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet)
{
    ...
    sas_voyager_icm_enclosure = (fbe_sas_voyager_icm_enclosure_t *)base_object;
    ...
    switch(discovery_opcode){
        ...
        default:
            status = fbe_eses_enclosure_discovery_transport_entry((fbe_base_object_t *)sas_voyager_icm_enclosure, packet);
            break;
    }
...
/*!*************************************************************************
* @fn fbe_sas_voyager_icm_enclosure_event_entry(                              
*                    fbe_object_handle_t object_handle,
...
***************************************************************************/
fbe_status_t 
fbe_sas_voyager_icm_enclosure_event_entry(fbe_object_handle_t object_handle, 
                                    fbe_event_type_t event_type, 
                                    fbe_event_context_t event_context)
{
    fbe_sas_voyager_icm_enclosure_t * sas_voyager_icm_enclosure = NULL;
...
//End of file fbe_sas_voyager_icm_enclosure_executer.c
