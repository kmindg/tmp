...
/*!**************************************************************************
 * @file fbe_extent_pool_lun_event_log.c
 ***************************************************************************
 *
 * @brief
...
static fbe_status_t fbe_ext_pool_lun_event_log_send_control_packet_and_get_response(
...
fbe_status_t fbe_ext_pool_lun_event_log_lun_bv(fbe_u32_t  lun_number,fbe_object_id_t lun_object_id,
                                         fbe_event_event_log_request_t*  event_log_data_p,
                                         fbe_u32_t message_code);
fbe_status_t fbe_ext_pool_lun_event_log_lun_bv_started(fbe_u32_t  lun_number,fbe_object_id_t in_lun_object_id,
                                         fbe_event_event_log_request_t*  event_log_data_p);
fbe_status_t fbe_ext_pool_lun_event_log_lun_bv_completed(fbe_u32_t  lun_number,fbe_object_id_t in_lun_object_id,
                                         fbe_event_event_log_request_t*  event_log_data_p);
...
/*!****************************************************************************
 * fbe_ext_pool_lun_event_log_lun_zero_start_or_complete 
 ******************************************************************************
 * @brief
...
/******************************************************************************
 * end fbe_ext_pool_lun_event_log_lun_zero_start_or_complete()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_event_log_event 
 ******************************************************************************
 * @brief
                                      ...
                                      fbe_event_event_log_request_t*  event_log_data_p)
{
    ...
    switch(event_log_data_p->event_log_type)
    {
        case FBE_EVENT_LOG_EVENT_TYPE_LUN_BV_STARTED:
            status = fbe_ext_pool_lun_event_log_lun_bv_started(lun_number,object_id,event_log_data_p);
            break;
        case FBE_EVENT_LOG_EVENT_TYPE_LUN_BV_COMPLETED:
            status = fbe_ext_pool_lun_event_log_lun_bv_completed(lun_number,object_id,event_log_data_p);
            break;    
    }
...
/******************************************************************************
 * end fbe_ext_pool_lun_event_log_event()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_event_log_lun_bv_started 
 ******************************************************************************
 * @brief
...
/*!****************************************************************************
 * fbe_ext_pool_lun_event_log_lun_bv_completed 
 ******************************************************************************
 * @brief
...
/******************************************
 * end fbe_extent_pool_lun_event_log.c
 *****************************************/
