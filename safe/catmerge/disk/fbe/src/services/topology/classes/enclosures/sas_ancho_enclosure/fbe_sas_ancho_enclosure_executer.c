...
/**********************************************************************
 * fbe_sas_ancho_enclosure_executer.c
 **********************************************************************
 * DESCRIPTION: 
 *  Leverage the ESES class
...
static fbe_status_t 
sas_ancho_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet);

fbe_status_t 
fbe_sas_ancho_enclosure_io_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet)
{
    ...
    switch(transport_id) {
        case FBE_TRANSPORT_ID_DISCOVERY:
            ...
            */
            status = fbe_base_discovering_discovery_bouncer_entry((fbe_base_discovering_t *) sas_ancho_enclosure,
                                                                        (fbe_transport_entry_t)sas_ancho_enclosure_discovery_transport_entry,
                                                                        packet);
            break;
        default:
...
/****************************************************************
 * sas_ancho_enclosure_discovery_transport_entry()
 ****************************************************************
 * DESCRIPTION:
...
sas_ancho_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet)
{
    ...
    sas_ancho_enclosure = (fbe_sas_ancho_enclosure_t *)base_object;
    ...
    switch(discovery_opcode){
        ...
        default:
            status = fbe_eses_enclosure_discovery_transport_entry((fbe_base_object_t *)sas_ancho_enclosure, packet);
            break;
    }
 ...
 ****************************************************************/
fbe_status_t 
fbe_sas_ancho_enclosure_event_entry(fbe_object_handle_t object_handle, 
...
//End of file fbe_sas_ancho_enclosure_executer.c
