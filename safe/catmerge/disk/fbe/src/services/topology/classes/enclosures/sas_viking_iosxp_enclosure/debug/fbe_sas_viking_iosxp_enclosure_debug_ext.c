...
/*!*************************************************************************
 * @file fbe_sas_viking_iosxp_enclosure_debug_ext.c
 ***************************************************************************
 *
 * @brief
...
/*!**************************************************************
 * @fn fbe_sas_viking_iosxp_enclosure_debug_prvt_data(const fbe_u8_t * module_name, 
 *                                   fbe_dbgext_ptr sas_viking_enclosure_p,
 ...
 * @param pSasVikingEnclosure - Ptr to sas voyager_icm enclosure object.
 ...
 *
 ****************************************************************/
fbe_status_t fbe_sas_viking_iosxp_enclosure_debug_prvt_data(const fbe_u8_t * pModuleName, 
                                           fbe_dbgext_ptr pSasVikingEnclosure, 
                                           fbe_trace_func_t trace_func, 
                                           fbe_trace_context_t trace_context)

{
  ...
  fbe_eses_enclosure_debug_prvt_data(pModuleName, pSasVikingEnclosure + eses_enclosure_offset ,trace_func,trace_context);
  return FBE_STATUS_OK;
}
