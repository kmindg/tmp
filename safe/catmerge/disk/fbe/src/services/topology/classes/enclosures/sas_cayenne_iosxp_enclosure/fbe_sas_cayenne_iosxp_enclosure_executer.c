 ...
 **********************************************************************/
/*!*************************************************************************
 * @file fbe_sas_cayenne_iosxp_enclosure_executer.c
 ***************************************************************************
 *
 * @brief
 *  This file contains entry functions for the cayenne enclosure class.
 *
...
static fbe_status_t 
fbe_sas_cayenne_iosxp_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet);

/*!*************************************************************************
* @fn fbe_sas_cayenne_iosxp_enclosure_io_entry(                              
...
***************************************************************************/
fbe_status_t 
fbe_sas_cayenne_iosxp_enclosure_io_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet)
{
    fbe_sas_cayenne_iosxp_enclosure_t * pSasVikingEnclosure = NULL;
    fbe_transport_id_t          transport_id;
    fbe_status_t                status;

    pSasVikingEnclosure = (fbe_sas_cayenne_iosxp_enclosure_t *)fbe_base_handle_to_pointer(object_handle);
        ...
        case FBE_TRANSPORT_ID_DISCOVERY:
            ...
            */
            status = fbe_base_discovering_discovery_bouncer_entry((fbe_base_discovering_t *) pSasVikingEnclosure,
                                                                  (fbe_transport_entry_t)fbe_sas_cayenne_iosxp_enclosure_discovery_transport_entry,
                                                                  packet);
            break;
        default:
...
/*!*************************************************************************
* @fn fbe_sas_cayenne_iosxp_enclosure_discovery_transport_entry(                              
...
fbe_sas_cayenne_iosxp_enclosure_discovery_transport_entry(fbe_base_object_t * base_object, fbe_packet_t * packet)
{
    ...
    pSasVikingEnclosure = (fbe_sas_cayenne_iosxp_enclosure_t *)base_object;
...
/*!*************************************************************************
* @fn fbe_sas_cayenne_iosxp_enclosure_event_entry(                              
*                    fbe_object_handle_t object_handle,
...
***************************************************************************/
fbe_status_t 
fbe_sas_cayenne_iosxp_enclosure_event_entry(fbe_object_handle_t object_handle, 
                                    fbe_event_type_t event_type, 
                                    fbe_event_context_t event_context)
{
    fbe_sas_cayenne_iosxp_enclosure_t * pSasVikingEnclosure = NULL;
...
//End of file fbe_sas_cayenne_iosxp_enclosure_executer.c
