...
/*!**************************************************************************
 * @file fbe_extent_pool_lun_main.c
 ***************************************************************************
 *
 * @brief
 ...
 */
fbe_status_t fbe_ext_pool_lun_load(void);
fbe_status_t fbe_ext_pool_lun_unload(void);
fbe_status_t fbe_ext_pool_lun_create_object(fbe_packet_t * packet, fbe_object_handle_t * object_handle);
fbe_status_t fbe_ext_pool_lun_destroy_interface( fbe_object_handle_t object_handle);
fbe_status_t fbe_ext_pool_metadata_lun_create_object(fbe_packet_t * packet, fbe_object_handle_t * object_handle);

static fbe_status_t fbe_ext_pool_lun_destroy( fbe_object_handle_t object_handle);
static fbe_status_t fbe_ext_pool_lun_init(fbe_ext_pool_lun_t * const lun_p);

static fbe_status_t fbe_ext_pool_lun_process_block_transport_event(fbe_block_transport_event_type_t event_type, 
                                                          fbe_block_trasnport_event_context_t context);

/* Export class methods.
 */
fbe_class_methods_t fbe_ext_pool_lun_class_methods = {FBE_CLASS_ID_EXTENT_POOL_LUN,
                                             fbe_ext_pool_lun_load,
                                             fbe_ext_pool_lun_unload,
                                             fbe_ext_pool_lun_create_object,
                                             fbe_ext_pool_lun_destroy_interface,
                                             fbe_ext_pool_lun_control_entry,
                                             fbe_ext_pool_lun_event_entry,
                                             fbe_ext_pool_lun_io_entry,
                                             fbe_ext_pool_lun_monitor_entry};

fbe_class_methods_t fbe_ext_pool_metadata_lun_class_methods = {FBE_CLASS_ID_EXTENT_POOL_METADATA_LUN,
                                             fbe_ext_pool_lun_load,
                                             fbe_ext_pool_lun_unload,
                                             fbe_ext_pool_metadata_lun_create_object,
                                             fbe_ext_pool_lun_destroy_interface,
                                             fbe_ext_pool_lun_control_entry,
                                             fbe_ext_pool_lun_event_entry,
                                             fbe_ext_pool_lun_io_entry,
 ...
 */
fbe_block_transport_const_t fbe_ext_pool_lun_block_transport_const = {fbe_ext_pool_lun_block_transport_entry, 
															fbe_ext_pool_lun_process_block_transport_event,
															fbe_ext_pool_lun_io_entry,
                                                            NULL, NULL};
...
static void fbe_ext_pool_lun_initialize_verify_report (fbe_ext_pool_lun_t*  in_lun_p);
 ...
 ****************************************************************/
fbe_status_t 
fbe_ext_pool_lun_load(void)
{
    FBE_ASSERT_AT_COMPILE_TIME(sizeof(fbe_ext_pool_lun_t) <= FBE_MEMORY_CHUNK_SIZE); 
 ...
 ****************************************************************/
fbe_status_t 
fbe_ext_pool_lun_unload(void)
{
    /* Destroy any global data.
     */
    return FBE_STATUS_OK;
}
/* end fbe_ext_pool_lun_unload() */
 ...
 ****************************************************************/
fbe_status_t 
fbe_ext_pool_lun_create_object(fbe_packet_t * packet_p, fbe_object_handle_t * object_handle)
{
    ...
    /* Set class id.
     */
    fbe_base_object_set_class_id((fbe_base_object_t *) lun_p, FBE_CLASS_ID_EXTENT_POOL_LUN);
     ...
     * dependencies. 
     */
	status = fbe_ext_pool_lun_init(lun_p);
     ...
     */
    fbe_lifecycle_verify((fbe_lifecycle_const_t *)&fbe_ext_pool_lun_lifecycle_const, (fbe_base_object_t *) lun_p);
...
/* end fbe_ext_pool_lun_create_object() */
 ...
 ****************************************************************/
fbe_status_t 
fbe_ext_pool_metadata_lun_create_object(fbe_packet_t * packet_p, fbe_object_handle_t * object_handle)
{
    fbe_ext_pool_lun_t *lun_p;
    fbe_status_t status;
    ...
    /* Set class id.
     */
    fbe_base_object_set_class_id((fbe_base_object_t *) lun_p, FBE_CLASS_ID_EXTENT_POOL_METADATA_LUN);
 ...
 ****************************************************************/
static fbe_status_t 
fbe_ext_pool_lun_init(fbe_ext_pool_lun_t * const lun_p)
{
    fbe_status_t status;
    ...
    status = fbe_base_config_set_block_transport_const((fbe_base_config_t *)lun_p, &fbe_ext_pool_lun_block_transport_const);
    ...
    fbe_ext_pool_lun_initialize_verify_report(lun_p);
 ...
 ****************************************************************/
fbe_status_t 
fbe_ext_pool_lun_destroy_interface(fbe_object_handle_t object_handle)
{
    fbe_status_t status;
    ...
    fbe_base_object_trace((fbe_base_object_t*)fbe_base_handle_to_pointer(object_handle), 
                          FBE_TRACE_LEVEL_DEBUG_HIGH, 
                          FBE_TRACE_MESSAGE_ID_CREATE_OBJECT,
                          "fbe_ext_pool_lun_main: %s entry\n", __FUNCTION__);

    /* Destroy this object.
     */
    fbe_ext_pool_lun_destroy(object_handle);
...
/* end fbe_ext_pool_lun_destroy_interface */

/*!***************************************************************
 * fbe_ext_pool_lun_destroy()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
static fbe_status_t 
fbe_ext_pool_lun_destroy(fbe_object_handle_t object_handle)
{
...
/* end fbe_ext_pool_lun_destroy */

/*!**************************************************************
 * fbe_ext_pool_lun_initialize_verify_report()
 ****************************************************************
 * @brief
...
static void fbe_ext_pool_lun_initialize_verify_report(fbe_ext_pool_lun_t*  in_lun_p)
{
    ...
    return;
} // End fbe_ext_pool_lun_initialize_verify_report()


/*!**************************************************************
 * fbe_ext_pool_lun_verify_downstream_health()
 ****************************************************************
 * @brief
...
fbe_ext_pool_lun_verify_downstream_health (fbe_ext_pool_lun_t * lun_p)
{
...
/**********************************************
 * end fbe_ext_pool_lun_verify_downstream_health()
 **********************************************/


/*!**************************************************************
 * fbe_ext_pool_lun_set_condition_based_on_downstream_health()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
fbe_status_t
fbe_ext_pool_lun_set_condition_based_on_downstream_health (fbe_ext_pool_lun_t *lun_p, 
                                                  fbe_base_config_downstream_health_state_t downstream_health_state)
{
    fbe_status_t status = FBE_STATUS_OK;
...
/**************************************************************
 * end fbe_ext_pool_lun_set_condition_based_on_downstream_health()
 **************************************************************/
...
/******************************************
 * end fbe_ext_pool_lun_process_block_transport_event()
 ******************************************/

/*!****************************************************************************
 * fbe_ext_pool_lun_reset_unexpected_errors()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t
fbe_ext_pool_lun_reset_unexpected_errors(fbe_ext_pool_lun_t* lun_p)
{
...
/******************************
 * end fbe_ext_pool_lun_reset_unexpected_errors()
 ******************************/
/*******************************
 * end fbe_extent_pool_lun_main.c
 *******************************/
