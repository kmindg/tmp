...
/**************************************
 * end fbe_lun_join_request()
 **************************************/

/*!****************************************************************************
 * fbe_lun_join_passive()
 ******************************************************************************
 * @brief
    ...
    else
    {
        ...
        if (!fbe_lun_is_local_state_set(lun_p, FBE_LUN_LOCAL_STATE_JOIN_REQUEST))
        {
            ...
            if (b_is_active)
            {
                ...
                status = fbe_lifecycle_set_cond(&fbe_lun_lifecycle_const, (fbe_base_object_t*) lun_p, 
...
/**************************************
 * end fbe_lun_join_done()
 **************************************/

/*!****************************************************************************
 * fbe_lun_join_sync_complete()
 ******************************************************************************
 * @brief
...
/**************************************
 * end fbe_lun_join_sync_complete()
 **************************************/
/*************************
 * end file fbe_lun_join.c
 *************************/
