...
/*!**************************************************************************
 * @file fbe_mirror_class.c
 ***************************************************************************
 *
 * @brief
 *  This file contains the Mirror class code.
 * 
 * @ingroup fbe_mirror_class_files
 * 
 * @version
 ...
 *****************************************/
static fbe_status_t fbe_mirror_class_get_info(fbe_packet_t * packet);


/*!***************************************************************
 * fbe_mirror_class_control_entry()
 ****************************************************************
 * @brief
 *  This function is the management packet entry point for
 *  operations to the mirror class.
 *
...
fbe_status_t fbe_mirror_class_control_entry(fbe_packet_t * packet)
{
    ...
    switch (opcode)
    {
        case FBE_RAID_GROUP_CONTROL_CODE_CLASS_GET_INFO:
            status = fbe_mirror_class_get_info(packet);
            break;
        default:
...
/********************************************
 * end fbe_mirror_class_control_entry
 ********************************************/

/*!***************************************************************
 * fbe_mirror_class_get_info()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
static fbe_status_t 
fbe_mirror_class_get_info(fbe_packet_t * packet_p)
{
    ...
    if ((get_info_p != NULL) &&
        (get_info_p->raid_type != FBE_RAID_GROUP_TYPE_RAID1) &&
        (get_info_p->raid_type != FBE_RAID_GROUP_TYPE_INTERNAL_MIRROR_UNDER_STRIPER))
    {
        fbe_topology_class_trace(FBE_CLASS_ID_MIRROR, FBE_TRACE_LEVEL_WARNING, FBE_TRACE_MESSAGE_ID_INFO,
...
/********************************************
 * end fbe_mirror_class_get_info
 ********************************************/

/************************
 * end fbe_mirror_class.c
 ************************/
