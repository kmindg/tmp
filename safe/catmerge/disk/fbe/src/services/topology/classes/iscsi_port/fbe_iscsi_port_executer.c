...
fbe_status_t 
fbe_iscsi_port_event_entry(fbe_object_handle_t object_handle, fbe_event_type_t event_type, fbe_event_context_t event_context)
{
...
***************************************************************************/
fbe_status_t 
fbe_iscsi_port_callback(fbe_cpd_shim_callback_info_t * callback_info, fbe_cpd_shim_callback_context_t context)
{
	fbe_status_t status = FBE_STATUS_OK;
	fbe_iscsi_port_t * iscsi_port = NULL;
	fbe_port_number_t port_number;        

	iscsi_port = (fbe_iscsi_port_t *)context;
    ...
    case FBE_CPD_SHIM_CALLBACK_TYPE_SFP:
        ...
        status = fbe_lifecycle_set_cond(&fbe_iscsi_port_lifecycle_const, 
								(fbe_base_object_t*)iscsi_port, 
