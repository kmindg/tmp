 ...
 /*!**************************************************************************
  * @file fbe_lun_executor.c
  ***************************************************************************
  *
  * @brief
  *  This file contains the executer functions for the lun.
  * 
  *  This includes the fbe_lun_io_entry() function which is our entry
...
static void fbe_lun_notify_of_first_write(fbe_lun_t*  in_lun_p, fbe_payload_block_operation_t *block_operation);

static void
fbe_lun_read_write_dirty_flag_allocate_completion(fbe_memory_request_t * memory_request_p, 
                                              fbe_memory_completion_context_t context);

fbe_status_t fbe_lun_get_dirty_flag_offset(fbe_lun_t*      in_lun_p,
                                           fbe_cmi_sp_id_t in_sp_id,
                                           fbe_lba_t *     out_lba);
static fbe_status_t fbe_lun_send_func_packet(fbe_lun_t *lun_p, fbe_packet_t *packet_p);



static fbe_status_t fbe_lun_split_and_send_func_packet(fbe_lun_t *lun_p, fbe_packet_t *packet_p);
static void fbe_lun_split_and_send_func_packet_allocate_completion(fbe_memory_request_t * memory_request_p, fbe_memory_completion_context_t context);
static fbe_status_t fbe_lun_split_and_send_func_packet_completion(fbe_packet_t * packet, fbe_packet_completion_context_t in_context);
static void fbe_lun_traffic_trace(fbe_lun_t *lun_p,
...
fbe_status_t fbe_lun_block_transport_entry(fbe_transport_entry_context_t context, 
                                           fbe_packet_t * packet_p)
{
    fbe_status_t status;
...
/**************************************
 * end fbe_lun_block_transport_entry()
 **************************************/

/****************************************************************
 * fbe_lun_send_io_packet()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
fbe_status_t fbe_lun_send_io_packet(fbe_lun_t * const lun_p,
                                    fbe_packet_t *packet_p)
{
    fbe_status_t           status;
     ...
     */
    fbe_lun_class_set_resource_priority(packet_p);
	...
	fbe_lun_notify_of_first_write(lun_p, block_operation_p);
    ...
    */
    if(block_operation_p->block_opcode == FBE_PAYLOAD_BLOCK_OPERATION_OPCODE_WRITE_NONCACHED) {        
        status = fbe_lun_set_dirty_flag_metadata(packet_p, lun_p);
        return status;                                   
    }
    ...
    */
    ...
    fbe_transport_set_completion_function(packet_p, fbe_lun_io_completion, lun_p);
    
#if 0 /* This is future enhancement */
	fbe_lun_metadata_get_zero_checkpoint(lun_p, &lu_zero_checkpoint);
    ...
    status = fbe_lun_send_func_packet(lun_p, packet_p);
    return status;
}
/* end fbe_lun_send_io_packet() */
/*!***************************************************************
 * fbe_lun_io_entry()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
fbe_status_t 
fbe_lun_io_entry(fbe_object_handle_t object_handle, fbe_packet_t * packet_p)
{
    ...
    { 
        if (fbe_lun_is_flag_set(lun_p, FBE_LUN_FLAGS_ENABLE_IO_LOOPBACK))
        {
            fbe_base_object_trace((fbe_base_object_t*) lun_p, FBE_TRACE_LEVEL_DEBUG_LOW, FBE_TRACE_MESSAGE_ID_INFO,
                                  "%s: loopback packet: %p lba: 0x%llx bl: 0x%llx\n", 
                                  __FUNCTION__, packet_p, block_operation_p->lba, block_operation_p->block_count);
        ...
        */
        ...
        if (lun_p->b_perf_stats_enabled)
        {
            ...
            fbe_lun_perf_stats_inc_sum_q_length_arrival(lun_p, outstanding_io, cpu_id);
            /* number of arrivals with non zero queue*/
            if (outstanding_io > 1)
            {
                 fbe_lun_perf_stats_inc_arrivals_to_nonzero_q(lun_p, cpu_id);
            }
        }
...
/* end fbe_lun_io_entry() */

/*!****************************************************************************
 * fbe_lun_noncached_io_completion()
 ******************************************************************************
 * @brief
                                             ...
                                             fbe_packet_completion_context_t in_context)
{
    ...
    if (lun_p->b_perf_stats_enabled)
    {
        ...
        fbe_lun_perf_stats_update_perf_counters_io_completion(lun_p,
                                                              block_operation_p,
                                                              cpu_id,
                                                              payload_p);
    }
...
/* end fbe_lun_noncached_io_completion */

/*!****************************************************************************
 * fbe_lun_io_completion()
 ******************************************************************************
 * @brief
 ...
 *
 *****************************************************************************/
fbe_status_t fbe_lun_io_completion(fbe_packet_t* in_packet_p, 
                                   fbe_packet_completion_context_t in_context)
{
    fbe_status_t                    status = FBE_STATUS_OK;
    fbe_lun_t* lun_p;
...
/* end fbe_lun_io_completion */

/*!****************************************************************************
 * fbe_lun_set_dirty_flag_metadata()
 ******************************************************************************
 * @brief
 ...
 *
 *****************************************************************************/
fbe_status_t fbe_lun_set_dirty_flag_metadata(fbe_packet_t* in_packet_p,
                                             fbe_lun_t*  in_lun_p)                                   
{
    ...
    if((in_lun_p->clean_pending == TRUE) || (in_lun_p->dirty_pending == TRUE))
    {
        ...
        fbe_lun_add_to_terminator_queue(in_lun_p, in_packet_p);
    ...
    else if((in_lun_p->io_counter == 0) && (! in_lun_p->marked_dirty))
    {
        ...
        status = fbe_lun_update_dirty_flag(context, in_packet_p,
                                           fbe_lun_set_dirty_flag_completion);
        if (status == FBE_STATUS_OK)
        {
            return FBE_STATUS_MORE_PROCESSING_REQUIRED;
        }    
    ...
    else if((in_lun_p->io_counter >=1) || in_lun_p->marked_dirty)
    {
        ...
        status = fbe_lun_send_packet(in_lun_p, in_packet_p);
        return FBE_STATUS_MORE_PROCESSING_REQUIRED;
    }
...
}/* end fbe_lun_set_dirty_flag_metadata*/
                                               ...
                                               fbe_packet_completion_context_t in_context)                                   
{
        ...
        (block_status != FBE_PAYLOAD_BLOCK_OPERATION_STATUS_SUCCESS))
    {
        ...
        else
        {
            ...
            status = fbe_lun_update_dirty_flag(context, restart_packet_p, fbe_lun_set_dirty_flag_completion);
    ...
    status = fbe_lun_handle_queued_packets_waiting_for_set_dirty_flag(lun_p,in_packet_p);

    return status;
            
    
}/* end fbe_lun_set_dirty_flag_completion*/
                                  ...
                                  fbe_packet_t*  in_packet_p)                                   
{
    ...
    fbe_transport_set_completion_function(in_packet_p, fbe_lun_noncached_io_completion, in_lun_p);
    status = fbe_lun_send_func_packet(in_lun_p, in_packet_p);
    return status;  
...
/*!****************************************************************************
 * fbe_lun_handle_queued_packets_waiting_for_clear_dirty_flag()
 ******************************************************************************
 * @brief
                                                                                                      ...
                                                                                                      
{
   ...
   // Dequeue all the packets from the terminator queue and put it in a temp queue
    ...
    // Process the temp queue by removing the packet and sending it to fbe_lun_set_iocounters_and_dirty_flag_metadata
    ...
    while(!fbe_queue_is_empty(&dirty_pending_queue)) 
    {
        ...
        status = fbe_lun_set_dirty_flag_metadata(new_packet_p,lun_p);        
...
/*!****************************************************************************
 * fbe_lun_handle_queued_packets_waiting_for_set_dirty_flag()
 ******************************************************************************
 * @brief
 *  This function will restart all the packets in the terminator queue
 * 
                                                                                                      ...
                                                                                                      
{
    ...
    status = fbe_lun_send_packet(lun_p, in_packet_p);
    ...
    while(!fbe_queue_is_empty(&dirty_pending_queue)) 
    {
        ...
        status = fbe_lun_send_packet(lun_p, new_packet_p);        
...
/*!****************************************************************************
 * @fn fbe_lun_read_write_dirty_flag_allocate_subpacket()
 ******************************************************************************
 * @brief
 *
 ...
 ******************************************************************************/
static fbe_status_t
fbe_lun_read_write_dirty_flag_allocate_subpacket(fbe_lun_t * lun_p,
                                             fbe_packet_t * packet_p,
                                             fbe_lun_clean_dirty_context_t * context)
{
    ...
    fbe_memory_build_chunk_request(memory_request_p,
                                   ...
                                   fbe_lun_read_write_dirty_flag_allocate_completion, /* SAFEBUG - cast to supress warning but must fix because memory completion function shouldn't return status */
                                   context);
...
/******************************************************************************
 * end fbe_lun_read_write_dirty_flag_allocate_subpacket()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_lun_clean_dirty_subpacket_completion()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t
fbe_lun_clean_dirty_subpacket_completion(fbe_packet_t * packet_p,
                                         fbe_packet_completion_context_t context)
{
    ...
    lun_p = (fbe_lun_t *)clean_dirty_context->lun_p;
	...
	if(bo != NULL){
			...
			bo->block_opcode == FBE_PAYLOAD_BLOCK_OPERATION_OPCODE_WRITE_SAME)
        {
			...
			if((first_stripe != last_stripe) && (last_stripe - first_stripe) < 8){ /* 1 64 block request can hold up to 8 packets */
				...
				return fbe_lun_split_and_send_func_packet(lun_p, packet_p);
			}
		}
	}
    ...
    if (status == FBE_STATUS_EDGE_NOT_ENABLED)
    {
        ...
        {        
            fbe_base_object_trace((fbe_base_object_t*)lun_p, FBE_TRACE_LEVEL_WARNING, FBE_TRACE_MESSAGE_ID_INFO,
                                  ...
                                  lifecycle_state, edge_p->base_edge.path_state, packet_p);
            fbe_lun_add_to_terminator_queue(lun_p, packet_p);
        }
        return FBE_STATUS_MORE_PROCESSING_REQUIRED;
    }
    return status;
...
/******************************************
 * end fbe_lun_send_func_packet()
 ******************************************/
/*!****************************************************************************
 * @fn fbe_lun_read_write_dirty_flag_allocate_completion()
 ******************************************************************************
 * @brief 
 *
 * @param lun_p             - Pointer to the lun object.
                                              ...
                                              fbe_memory_completion_context_t context)
{
    ...
    status = fbe_lun_get_dirty_flag_offset(lun_p, clean_dirty_context->sp_id, &lba);
    ...
    fbe_lun_send_func_packet(lun_p, new_packet_p);

    return;
}
/******************************************************************************
 * end fbe_lun_read_write_dirty_flag_allocate_completion()
 ******************************************************************************/
 ...
 *
 * @author
 *  09/30/2012 - Created from fbe_lun_mark_peer_clean_cond . Ashok Tamilarasan
 *
 ******************************************************************************/
                                      ...
                                      fbe_packet_completion_function_t completion_function)
{
    ...
    status = fbe_lun_update_dirty_flag(context, packet_p, completion_function );   

    return status;
}

/*!****************************************************************************
 * fbe_lun_update_dirty_flag()
 ******************************************************************************
 * @brief
                                       ...
                                       fbe_packet_completion_function_t completion_function)                                   
{
    fbe_status_t status;
    fbe_payload_ex_t * sep_payload_p = NULL;
    fbe_lun_t * in_lun_p = NULL;

    in_lun_p = (fbe_lun_t *)context->lun_p;
    ...
    status = fbe_lun_read_write_dirty_flag_allocate_subpacket(in_lun_p, in_packet_p, context);

    return status;
} /* end fbe_lun_update_dirty_flag */

/*!****************************************************************************
 * fbe_lun_get_dirty_flag()
 ******************************************************************************
 * @brief
 * 
 *
...
static void fbe_lun_notify_of_first_write(fbe_lun_t*  in_lun_p, fbe_payload_block_operation_t *block_operation)
{
    ...
    if ((!fbe_lun_is_flag_set(in_lun_p, FBE_LUN_FLAGS_HAS_BEEN_WRITTEN)) && 
		...
		fbe_lun_calculate_cache_zero_bit_map_size_to_remove(capacity, &size_of_cache_bitmap);
...
/*!**************************************************************
 * fbe_lun_spit_and_send_func_packet()
 ****************************************************************
 * @brief
...
static fbe_status_t 
fbe_lun_split_and_send_func_packet(fbe_lun_t *lun_p, fbe_packet_t *packet_p)
{
    fbe_status_t status;
	fbe_block_edge_t				* edge_p = NULL;
    fbe_payload_ex_t				* payload_p = NULL;
	...
	if((bo->block_opcode == FBE_PAYLOAD_BLOCK_OPERATION_OPCODE_ZERO)){
		...
		fbe_memory_build_chunk_request_sync(memory_request_p,
									   ...
									   fbe_transport_get_resource_priority(packet_p),
									   fbe_transport_get_io_stamp(packet_p),
									   fbe_lun_split_and_send_func_packet_allocate_completion,
	...
	if (status == FBE_STATUS_OK) { 
		...
		fbe_lun_split_and_send_func_packet_allocate_completion(memory_request_p, (fbe_memory_completion_context_t)lun_p);
		return FBE_STATUS_OK;
	}
...
static void
fbe_lun_split_and_send_func_packet_allocate_completion(fbe_memory_request_t * memory_request_p, fbe_memory_completion_context_t context)
{
    fbe_lun_t *                         lun_p = NULL;
    fbe_packet_t *                      new_packet_p = NULL;
    fbe_packet_t *                      packet_p = NULL;
	...
	for(i = first_stripe; i <= last_stripe; i++){
		...
		/* Set completion function */
		fbe_transport_set_completion_function(new_packet_p, fbe_lun_split_and_send_func_packet_completion, lun_p);
...
static fbe_status_t 
fbe_lun_split_and_send_func_packet_completion(fbe_packet_t * packet, fbe_packet_completion_context_t in_context)
{    
    fbe_lun_t						* lun = NULL;
    ...
    if (lun->b_perf_stats_enabled)
    {
        ...
        fbe_lun_perf_stats_update_perf_counters_io_completion(lun,
