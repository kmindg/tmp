 ...
 *****************************************/
static fbe_status_t fbe_lun_state_change_event_entry(fbe_lun_t * const lun_p, fbe_event_context_t event_context);
static fbe_status_t fbe_lun_permit_request_event_entry(fbe_lun_t * lun_p, fbe_event_context_t event_context);
static fbe_status_t fbe_lun_update_verify_report_event_entry(fbe_lun_t * lun_p,fbe_event_context_t event_context);
static fbe_status_t fbe_lun_power_saving_changed_event_entry(fbe_lun_t * lun_p,fbe_event_context_t event_context);
static fbe_status_t fbe_lun_handle_data_request_event(fbe_lun_t * lun_p,fbe_event_context_t event_context);
static fbe_status_t fbe_lun_handle_remap_event(fbe_lun_t * lun_p,fbe_event_context_t event_context);              
static fbe_status_t fbe_lun_process_non_paged_write(fbe_lun_t * lun_p);
static fbe_status_t fbe_lun_process_attribute_changed(fbe_lun_t * lun_p, fbe_event_context_t event_context);
static fbe_status_t fbe_lun_event_log_event_entry(fbe_lun_t * lun_p,fbe_event_context_t event_context);
static fbe_status_t fbe_lun_event_peer_contact_lost(fbe_lun_t * lun_p,fbe_event_context_t event_context);
 ...
 ****************************************************************/
fbe_status_t 
fbe_lun_event_entry(fbe_object_handle_t object_handle, 
                    ...
                    fbe_event_context_t event_context)
{
    ...
    switch (event_type)
    {
        case FBE_EVENT_TYPE_EDGE_STATE_CHANGE:
            status = fbe_lun_state_change_event_entry(lun_p, event_context);
            break;
        case FBE_EVENT_TYPE_PERMIT_REQUEST:
            status = fbe_lun_permit_request_event_entry(lun_p, event_context);
            break;
        case FBE_EVENT_TYPE_VERIFY_REPORT:
            status = fbe_lun_update_verify_report_event_entry(lun_p, event_context);
            break;
        case FBE_EVENT_TYPE_POWER_SAVING_CONFIG_CHANGED:
            status = fbe_lun_power_saving_changed_event_entry(lun_p, event_context);
            break;
        //  Data Request event
        case FBE_EVENT_TYPE_DATA_REQUEST:
            status = fbe_lun_handle_data_request_event(lun_p, event_context);
            break;
        case FBE_EVENT_TYPE_PEER_NONPAGED_WRITE:
            /*check if this is a change of the first write bit*/
            status = fbe_lun_process_non_paged_write(lun_p);
        ...
        case FBE_EVENT_TYPE_ATTRIBUTE_CHANGED:
            status = fbe_lun_process_attribute_changed(lun_p, event_context);
            break;
        case FBE_EVENT_TYPE_EVENT_LOG:
            status = fbe_lun_event_log_event_entry(lun_p, event_context);
            break;
        case FBE_EVENT_TYPE_PEER_CONTACT_LOST:
            status = fbe_lun_event_peer_contact_lost(lun_p, event_context);
            status = fbe_base_config_event_entry(object_handle, event_type, event_context);
            break;

        case FBE_EVENT_TYPE_PEER_MEMORY_UPDATE:
            status = lun_process_memory_update_message(lun_p);
            if (status != FBE_STATUS_OK) {
                return status;
            }
            status = fbe_base_config_event_entry(object_handle, event_type, event_context);
...
/* end fbe_lun_event_entry() */


/*!**************************************************************
 * fbe_lun_state_change_event_entry()
 ****************************************************************
 * @brief
...
static fbe_status_t 
fbe_lun_state_change_event_entry(fbe_lun_t * const lun_p, 
                                 fbe_event_context_t event_context)
{
    fbe_status_t status;
    ...
    switch (path_state)
    {
        ...
        case FBE_PATH_STATE_GONE:
             ...
             */
            status =  fbe_lun_set_condition_based_on_downstream_health(lun_p,
...
/******************************************
 * end fbe_lun_state_change_event_entry()
 ******************************************/

/*!**************************************************************
 * fbe_lun_permit_request_event_entry()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_lun_permit_request_event_entry(fbe_lun_t * lun_p,
                                                       fbe_event_context_t event_context)
{
    fbe_status_t status;
     ...
     */
    fbe_lun_calculate_cache_zero_bit_map_size(external_capacity, &zero_bitmap_blocks);
...
/****************************************************************
 * end fbe_lun_permit_request_event_entry()
 ****************************************************************/

/*!**************************************************************
 * fbe_lun_update_verify_report_event_entry()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_lun_update_verify_report_event_entry(fbe_lun_t * lun_p,
                                                             fbe_event_context_t event_context)
{
    fbe_event_t*                        event_p;
    ...
    fbe_lun_usurper_add_verify_result_counts(&verify_event_data.error_counts, &verify_report_p->current);

    // Add the error counts to the historical totals
    fbe_lun_usurper_add_verify_result_counts(&verify_event_data.error_counts, &verify_report_p->totals);
...
/****************************************************
 * end fbe_lun_update_verify_report_event_entry()
 ****************************************************/

/*!**************************************************************
 * fbe_lun_power_saving_changed_event_entry()
 ****************************************************************
 * @brief
...
/****************************************************
 * end fbe_lun_power_saving_changed_event_entry()
 ****************************************************/


/*!****************************************************************************
 * fbe_lun_handle_data_request_event()
 ******************************************************************************
 * @brief
...
static fbe_status_t fbe_lun_handle_data_request_event(fbe_lun_t * lun_p,fbe_event_context_t event_context)
{
    ...
    switch (data_event_type)
    {
        case FBE_DATA_EVENT_TYPE_REMAP:
            fbe_lun_handle_remap_event(lun_p, event_context);
            break;
...
} // End fbe_lun_handle_data_request_event()




/*!***************************************************************
 * fbe_lun_handle_remap_event
 *****************************************************************
 * @brief
...
fbe_status_t
fbe_lun_handle_remap_event(fbe_lun_t * lun_p,fbe_event_context_t event_context) 
{
...
}   // end fbe_lun_handle_remap_event()
...
static fbe_status_t fbe_lun_process_attribute_changed(fbe_lun_t * lun_p, fbe_event_context_t event_context)
{
    ...
    if (attr != lun_p->prev_path_attr ) {
        ...
        /* Clear the wear level flag on the downstream edge since we already reported 
         * the change upstream 
         */
        if (lun_p->prev_path_attr & FBE_BLOCK_PATH_ATTR_FLAGS_WEAR_LEVEL_REQUIRED)
        {
            status = fbe_block_transport_clear_path_attributes(edge_p, FBE_BLOCK_PATH_ATTR_FLAGS_WEAR_LEVEL_REQUIRED);
            lun_p->prev_path_attr &= ~FBE_BLOCK_PATH_ATTR_FLAGS_WEAR_LEVEL_REQUIRED;
            if (status != FBE_STATUS_OK) {
                fbe_base_object_trace((fbe_base_object_t*)lun_p,
                                       FBE_TRACE_LEVEL_ERROR,
                                       FBE_TRACE_MESSAGE_ID_INFO,
                                       "lun_attr_change: Failed to clear wear leveling attr.  Sts:0x%x\n", status);
                return status;
            }
        }
    }
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_lun_event_log_event_entry(fbe_lun_t * lun_p,
                                                  fbe_event_context_t event_context)
{
    fbe_event_t*                        event_p;
    ...
    fbe_lun_event_log_event(lun_p,&event_log_data);
...
/*!**************************************************************
 * fbe_lun_event_peer_contact_lost()
 ****************************************************************
 * @brief
 *  This function will log an event.
 *
 ...
 *
 ****************************************************************/
static fbe_status_t fbe_lun_event_peer_contact_lost(fbe_lun_t * lun_p,
                                                    fbe_event_context_t event_context)
{
    fbe_lifecycle_state_t   lifecycle_state;
    fbe_status_t            status;
