 ...
 *****************************************/
static fbe_status_t fbe_lun_calculate_imported_capacity(fbe_packet_t * packet);
static fbe_status_t fbe_lun_calculate_exported_capacity(fbe_packet_t * packet);
static fbe_status_t fbe_lun_class_prepare_for_power_shutdown(fbe_packet_t * packet);
static fbe_status_t fbe_lun_prefstats_set_enabled(fbe_packet_t * packet);
static fbe_status_t fbe_lun_prefstats_send_packet_to_service(fbe_payload_control_operation_opcode_t control_code,
...
static fbe_status_t fbe_lun_prefstats_forward_packet_to_object(fbe_packet_t *packet,
...
static fbe_status_t fbe_lun_prefstats_enumerate_class(fbe_class_id_t class_id,  fbe_package_id_t package_id, fbe_object_id_t ** obj_array_p, fbe_u32_t *num_objects_p);
static fbe_status_t fbe_lun_prefstats_get_total_objects_of_class(fbe_class_id_t class_id, fbe_package_id_t package_id, fbe_u32_t *total_objects_p);
static fbe_status_t fbe_lun_prefstats_enable_peformance_stats(fbe_object_id_t in_lun_object_id, fbe_packet_t *packet);
static fbe_status_t fbe_lun_perfstats_forward_packet_completion(fbe_packet_t * packet, fbe_packet_completion_context_t context);

static fbe_status_t fbe_lun_class_calculate_cache_zero_bit_map_size_to_remove(fbe_packet_t *packet_p);
 ...
 ****************************************************************/
fbe_status_t 
fbe_lun_class_control_entry(fbe_packet_t * packet)
{
    fbe_status_t                            status;
    ...
    switch (opcode) {
        case FBE_LUN_CONTROL_CODE_CLASS_CALCULATE_IMPORTED_CAPACITY:
            status = fbe_lun_calculate_imported_capacity(packet);
            break;
        case FBE_LUN_CONTROL_CODE_CLASS_CALCULATE_EXPORTED_CAPACITY:
            status = fbe_lun_calculate_exported_capacity(packet);
            break;
        case FBE_LUN_CONTROL_CODE_CLASS_PREPARE_FOR_POWER_SHUTDOWN:
            status = fbe_lun_class_prepare_for_power_shutdown(packet);
            break;
        case  FBE_LUN_CONTROL_CODE_CLASS_PREFSTATS_SET_ENABLED:
            status = fbe_lun_prefstats_set_enabled(packet);
            break;
        case  FBE_LUN_CONTROL_CODE_CLASS_PREFSTATS_SET_DISABLED:
            status = fbe_lun_prefstats_set_disabled(packet);
            break;
        case FBE_LUN_CONTROL_CODE_CLASS_CALCULATE_CACHE_ZERO_BIT_MAP_SIZE_TO_REMOVE:
            status = fbe_lun_class_calculate_cache_zero_bit_map_size_to_remove(packet);
            break;
        default:
...
/* end fbe_lun_class_control_entry() */

/*!***************************************************************
 *      fbe_lun_class_subpacket_completion()
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
fbe_status_t fbe_lun_class_subpacket_completion(fbe_packet_t * sub_packet_p,
 ...
 *
 ****************************************************************/
void fbe_lun_class_prepare_for_power_shutdown_alloc_completion(fbe_memory_request_t * memory_request_p, 
...
/*!***************************************************************
 *      fbe_lun_class_prepare_for_power_shutdown()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
static fbe_status_t
fbe_lun_class_prepare_for_power_shutdown(fbe_packet_t * packet_p)
{
    fbe_status_t                    status = FBE_STATUS_INVALID;
...
/*!****************************************************************************
 *      fbe_lun_calculate_imported_capacity()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t 
fbe_lun_calculate_imported_capacity(fbe_packet_t * packet)
{
	...
	fbe_lun_calculate_cache_zero_bit_map_size(calculate_capacity_p->exported_capacity, &cache_zero_bit_map_size);
...
/* end fbe_lun_calculate_imported_capacity() */


/*!****************************************************************************
 *      fbe_lun_calculate_exported_capacity()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
static fbe_status_t 
fbe_lun_calculate_exported_capacity(fbe_packet_t * packet)
{
    fbe_lun_control_class_calculate_capacity_t *            calculate_capacity_p = NULL;    
    fbe_payload_ex_t *                                      sep_payload = NULL;
    fbe_payload_control_operation_t *                       control_operation = NULL; 
     ...
     */
	fbe_lun_calculate_cache_zero_bit_map_size(
...
/* end fbe_lun_calculate_exported_capacity() */


/*!****************************************************************************
 * fbe_lun_class_set_resource_priority()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t  
fbe_lun_class_set_resource_priority(fbe_packet_t * packet_p)
{
 ...
 *
 ******************************************************************************/
fbe_status_t fbe_lun_calculate_cache_zero_bit_map_size(fbe_block_count_t lun_capacity, fbe_block_count_t *blocks)
{
...
/*!****************************************************************************
 * fbe_lun_calculate_cache_zero_bit_map_size_to_remove()
 ******************************************************************************
 * @brief
 * This function is the revers of fbe_lun_calculate_cache_zero_bit_map_size
...
fbe_status_t fbe_lun_calculate_cache_zero_bit_map_size_to_remove(fbe_block_count_t lun_capacity, fbe_block_count_t *blocks)
{
	...
	we calculated in fbe_lun_calculate_cache_zero_bit_map_size*/
	if ((number_of_512_gb_chunks_remainder != 0) &&
...
/******************************************************************************
 * end fbe_lun_class_set_resource_priority()
 ******************************************************************************/

/*!****************************************************************************
 * fbe_lun_class_calculate_cache_zero_bit_map_size_to_remove()
 ******************************************************************************
 * @brief
 ...
 ******************************************************************************/
fbe_status_t fbe_lun_class_calculate_cache_zero_bit_map_size_to_remove(fbe_packet_t *packet_p)
{
    ...
    status = fbe_lun_calculate_cache_zero_bit_map_size_to_remove(lun_capacity, &blocks);
...
/******************************************************************************
 * end fbe_lun_class_calculate_cache_zero_bit_map_size_to_remove()
 ******************************************************************************/
...
static fbe_status_t fbe_lun_prefstats_set_enabled(fbe_packet_t *packet)
{
    ...
    status = fbe_lun_prefstats_enumerate_class(FBE_CLASS_ID_LUN, FBE_PACKAGE_ID_SEP_0, &obj_list, &obj_count);
    for(obj_i = 0; obj_i < obj_count; obj_i++) {
            status = fbe_lun_prefstats_enable_peformance_stats(*(obj_list+obj_i), packet);
    }

    /* releasing obj_list. It was allocated in fbe_lun_perfstats_enumerate_class and used in this function*/
...
static fbe_status_t fbe_lun_prefstats_get_total_objects_of_class(fbe_class_id_t class_id, fbe_package_id_t package_id, fbe_u32_t *total_objects_p)
{
   ...
   fbe_topology_control_get_total_objects_of_class_t total_objects = {0};
    ...
    status = fbe_lun_prefstats_send_packet_to_service(FBE_TOPOLOGY_CONTROL_CODE_GET_TOTAL_OBJECTS_OF_CLASS,
                                                 &total_objects,
...
static fbe_status_t fbe_lun_prefstats_enumerate_class(fbe_class_id_t class_id,  fbe_package_id_t package_id, fbe_object_id_t ** obj_array_p, fbe_u32_t *num_objects_p)
{
   ...
   /* one for the entry and one for the NULL termination.
    ...
    status = fbe_lun_prefstats_get_total_objects_of_class(class_id, package_id, num_objects_p);
    ...
    *obj_array_p = fbe_allocate_nonpaged_pool_with_tag(alloc_size, 'tats');
    ...
    status = fbe_lun_prefstats_send_packet_to_service(FBE_TOPOLOGY_CONTROL_CODE_ENUMERATE_CLASS,
                                                                        &enumerate_class,
...
static fbe_status_t fbe_lun_prefstats_enable_peformance_stats(fbe_object_id_t in_lun_object_id, fbe_packet_t *packet)
{
   ...
   status = fbe_lun_prefstats_forward_packet_to_object (packet, FBE_LUN_CONTROL_CODE_ENABLE_PERFORMANCE_STATS,
                                                         NULL,
                                                         0,
                                                         in_lun_object_id,
                                                         NULL,
                                                ...
                                                fbe_package_id_t package_id)
{
	...
	fbe_transport_set_completion_function(packet, fbe_lun_perfstats_forward_packet_completion, (fbe_packet_completion_context_t) &sem);
...
static fbe_status_t fbe_lun_prefstats_set_disabled(fbe_packet_t *packet)
{
    ...
    status = fbe_lun_prefstats_enumerate_class(FBE_CLASS_ID_LUN, FBE_PACKAGE_ID_SEP_0, &obj_list, &obj_count);
    for(obj_i = 0; obj_i < obj_count; obj_i++) {
            status = fbe_lun_prefstats_disable_peformance_stats(*(obj_list+obj_i), packet);
    }
...
static fbe_status_t fbe_lun_prefstats_disable_peformance_stats(fbe_object_id_t in_lun_object_id, fbe_packet_t *packet)
{
   ...
   status = fbe_lun_prefstats_forward_packet_to_object (packet, FBE_LUN_CONTROL_CODE_DISABLE_PERFORMANCE_STATS,
                                                         NULL,
                                                         0,
                                                         in_lun_object_id,
                                                         NULL,
