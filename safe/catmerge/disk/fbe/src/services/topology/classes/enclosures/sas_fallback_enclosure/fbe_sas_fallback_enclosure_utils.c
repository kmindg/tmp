...
{
    fbe_sas_fallback_enclosure_t * fallbackPrvtData = (fbe_sas_fallback_enclosure_t *)enclPrvtData;
    fbe_eses_enclosure_print_prvt_data((void *)&(fallbackPrvtData->eses_enclosure), trace_func, trace_context);
}
// End of file fbe_sas_fallback_enclosure_utils.c
