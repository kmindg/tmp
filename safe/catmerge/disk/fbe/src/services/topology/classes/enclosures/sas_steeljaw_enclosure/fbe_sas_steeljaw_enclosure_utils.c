...
{
    fbe_sas_steeljaw_enclosure_t * steeljawPrvtData = (fbe_sas_steeljaw_enclosure_t *)enclPrvtData;
    fbe_eses_enclosure_print_prvt_data((void *)&(steeljawPrvtData->eses_enclosure), trace_func, trace_context);
}
// End of file fbe_sas_steeljaw_enclosure_utils.c
