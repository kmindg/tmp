...
/*!*************************************************************************
 * @file fbe_rdgen_verify_only.c
 ***************************************************************************
 *
 * @brief
 *  This file contains the rdgen verify only state machine.
 *  This is an operation that simply does verifies and nothing else.
 *
 * @version
...
/*!**************************************************************
 * fbe_rdgen_ts_verify_only_state0()
 ****************************************************************
 * @brief
...
fbe_rdgen_ts_state_status_t fbe_rdgen_ts_verify_only_state0(fbe_rdgen_ts_t *ts_p)
{
    ...
    {
        fbe_rdgen_ts_set_state(ts_p, fbe_rdgen_ts_verify_only_state1);
    }
    return FBE_RDGEN_TS_STATE_STATUS_EXECUTING;
}
/******************************************
 * end fbe_rdgen_ts_verify_only_state0()
 ******************************************/

/*!**************************************************************
 * fbe_rdgen_ts_verify_only_state1()
 ****************************************************************
 * @brief
...
fbe_rdgen_ts_state_status_t fbe_rdgen_ts_verify_only_state1(fbe_rdgen_ts_t *ts_p)
{
    ...
    fbe_rdgen_ts_set_state(ts_p, fbe_rdgen_ts_verify_only_state2);

    return FBE_RDGEN_TS_STATE_STATUS_EXECUTING;
}
/******************************************
 * end fbe_rdgen_ts_verify_only_state1()
 ******************************************/

/*!**************************************************************
 * fbe_rdgen_ts_verify_only_state2()
 ****************************************************************
 * @brief
...
fbe_rdgen_ts_state_status_t fbe_rdgen_ts_verify_only_state2(fbe_rdgen_ts_t *ts_p)
{
    ...
    {
        fbe_rdgen_ts_set_calling_state(ts_p, fbe_rdgen_ts_verify_only_state4);
        fbe_rdgen_ts_set_state(ts_p, fbe_rdgen_ts_verify_state0);
    }
    return FBE_RDGEN_TS_STATE_STATUS_EXECUTING;
}
/******************************************
 * end fbe_rdgen_ts_verify_only_state2()
 ******************************************/

/*!**************************************************************
 * fbe_rdgen_ts_verify_only_state4()
 ****************************************************************
 * @brief
 *  Handle the status from the verify operation.
 *
 * @param ts_p - current_ts.               
 *
 * @return FBE_RDGEN_TS_STATE_STATUS_EXECUTING   
...
fbe_rdgen_ts_state_status_t fbe_rdgen_ts_verify_only_state4(fbe_rdgen_ts_t *ts_p)
{
    ...
    /* Interpret the error status from the verify operation.
     * If we have more error handling to do, then exit now. 
     * fbe_rdgen_ts_handle_error() will already have set the next state.
     */
    error_status = fbe_rdgen_ts_handle_error(ts_p, fbe_rdgen_ts_verify_only_state2);
    ...
    if (ts_p->blocks_remaining == 0)
    {
         ...
         */
        fbe_rdgen_ts_set_state(ts_p, fbe_rdgen_ts_verify_only_state0);
    }
    else
    {
        if (fbe_rdgen_ts_is_time_to_trace(ts_p))
        {
            fbe_rdgen_service_trace(FBE_TRACE_LEVEL_INFO, 
                                FBE_TRACE_MESSAGE_ID_FUNCTION_ENTRY,
                                "%s: next verify slice  current lba: 0x%llx current blocks: 0x%llx "
        ...
        /* Continue verifying, as we have more blocks to verify.
         */
        fbe_rdgen_ts_set_state(ts_p, fbe_rdgen_ts_verify_state0);
    }
...
/******************************************
 * end fbe_rdgen_ts_verify_only_state4()
 ******************************************/

/*************************
 * end file fbe_rdgen_verify_only.c
 *************************/
