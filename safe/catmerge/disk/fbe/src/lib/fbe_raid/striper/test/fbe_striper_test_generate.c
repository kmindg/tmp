...
/*!*************************************************************************
 * @file fbe_striper_test_generate.c
 ***************************************************************************
 *
 * @brief
...
/*!***************************************************************
 * fbe_striper_test_setup_invalid_opcode
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
fbe_status_t fbe_striper_test_setup_invalid_opcode(fbe_raid_group_test_state_t * const test_state_p,
                                                   fbe_raid_group_test_state_machine_task_t *const task_p)
{
    ...
    /*! @note Initialize our logical drive block size and optimum block size.
     */
    ...
    MUT_ASSERT_INT_EQUAL_MSG(FBE_STATUS_OK, status, 
                             "striper: bad status from fbe_raid_siots_embedded_init");
...
/* end fbe_striper_test_setup_invalid_opcode() */

/*!***************************************************************
 * @fn fbe_striper_test_invalid_opcode(void)
 ****************************************************************
 * @brief
 ...
 *
 ****************************************************************/
void fbe_striper_test_invalid_opcode(void)
{
     ...
     */
    status = fbe_striper_test_setup_invalid_opcode(test_state_p,
    ...
    MUT_ASSERT_TRUE_MSG((siots_p->common.state == (fbe_raid_common_state_t)fbe_raid_siots_invalid_opcode), 
                        "striper: state set incorrectly in generate");
    MUT_ASSERT_TRUE_MSG((siots_p->algorithm == RG_NO_ALG), "striper: bad algorithm from generate");
...
/* end fbe_striper_test_invalid_opcode() */

/*!**************************************************************
 * fbe_striper_test_generate_add_unit_tests()
 ****************************************************************
 * @brief
...
void fbe_striper_test_generate_add_unit_tests(mut_testsuite_t * const suite_p)
{
    MUT_ADD_TEST(suite_p, 
                 fbe_striper_test_invalid_opcode,
                 fbe_striper_unit_tests_setup, 
                 fbe_striper_unit_tests_teardown);
    return;
}
/******************************************
 * end fbe_striper_test_generate_add_unit_tests()
 ******************************************/
/*************************
 * end file fbe_striper_test_generate.c
 *************************/
