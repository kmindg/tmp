...
/*!*************************************************************************
 * @file fbe_mirror_test_read.c
 ***************************************************************************
 *
 * @brief
 *  This file contains testing functions for the raid mirror read state machine.
 *
 * @version
 ...
 *
 ****************************************************************/
fbe_status_t fbe_mirror_test_setup_read(fbe_raid_group_test_state_t * const test_state_p,
                                         fbe_raid_group_test_state_machine_task_t *const task_p)
{
    ...
    /* Start the read and confirm that we transition to state0.
    */
    ...
    MUT_ASSERT_TRUE_MSG((siots_p->common.state == (fbe_raid_common_state_t)fbe_mirror_read_state0), 
                        "mirror: bad status from generate");
    MUT_ASSERT_TRUE_MSG((siots_p->algorithm == MIRROR_RD), "mirror: bad status from generate");
 ...
 *
 ****************************************************************/
fbe_status_t fbe_mirror_test_read_state0(fbe_raid_group_test_state_t * const test_state_p)
{
    fbe_status_t status = FBE_STATUS_OK;
     ...
     */
    state_status = fbe_mirror_read_state0(siots_p);
    ...
    MUT_ASSERT_TRUE_MSG(fbe_raid_siots_get_state(siots_p) == fbe_mirror_read_state3,
                        "mirror: siots state unexpected");
    return status;  
}
/* end fbe_mirror_test_read_state0() */

/*!***************************************************************
 * fbe_mirror_test_read_state_machine_test_case()
 ****************************************************************
 * @brief
 ...
 ****************************************************************/
fbe_status_t 
fbe_mirror_test_read_state_machine_test_case(fbe_raid_group_test_state_machine_task_t *const task_p)
{
    fbe_status_t status = FBE_STATUS_OK;
     ...
     */
    status = fbe_mirror_test_setup_read(test_state_p, task_p);
...
/* end fbe_mirror_test_read_state_machine_test_case() */

/*!***************************************************************
 *          fbe_mirror_test_read_state_machine_tests()
 ****************************************************************
 * @brief
 *  This function executes tests of the read state machine.
 *
 ...
 *
 ****************************************************************/
fbe_status_t fbe_mirror_test_read_state_machine_tests(void)
{
    fbe_status_t status = FBE_STATUS_OK;
...
/* end fbe_mirror_test_read_state_machine_tests() */

/*!**************************************************************
 * fbe_mirror_test_read_add_unit_tests()
 ****************************************************************
 * @brief
...
/******************************************
 * end fbe_mirror_test_read_add_unit_tests()
 ******************************************/


/*********************************
 * end file fbe_mirror_test_read.c
 *********************************/
