...
/*!**************************************************************************
 * @file fbe_mirror_rekey.c
 ***************************************************************************
 *
 * @brief
 *   This file contains the state functions of the mirror rekey algorithm.
 *
 * @author
...
static fbe_raid_state_status_t fbe_mirror_rekey_state1(fbe_raid_siots_t * siots_p);
static fbe_raid_state_status_t fbe_mirror_rekey_state2(fbe_raid_siots_t * siots_p);
static fbe_raid_state_status_t fbe_mirror_rekey_state3(fbe_raid_siots_t * siots_p);
static fbe_raid_state_status_t fbe_mirror_rekey_state4(fbe_raid_siots_t * siots_p);
static fbe_raid_state_status_t fbe_mirror_rekey_state10(fbe_raid_siots_t * siots_p);
static fbe_raid_state_status_t fbe_mirror_rekey_state11(fbe_raid_siots_t * siots_p);
static fbe_raid_state_status_t fbe_mirror_rekey_state20(fbe_raid_siots_t * siots_p);
static fbe_raid_state_status_t fbe_mirror_rekey_handle_read_error(fbe_raid_siots_t * siots_p,
                                                                  fbe_raid_fru_eboard_t *eboard_p);

/*!***************************************************************
 * fbe_mirror_rekey_state0()
 ****************************************************************
 * @brief
...
fbe_raid_state_status_t fbe_mirror_rekey_state0(fbe_raid_siots_t * siots_p)
{
     ...
     */
    fbe_raid_siots_transition(siots_p, fbe_mirror_rekey_state1);
    ...
    if (RAID_MEMORY_COND(status == FBE_STATUS_OK))
    {
         ...
         */
        status = fbe_mirror_rekey_setup_resources(siots_p, &read_info[0]);
        if (RAID_COND(status != FBE_STATUS_OK))
        {
            fbe_raid_siots_set_unexpected_error(siots_p, FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS,
                                            "mirror: rekey failed to setup resources. status: 0x%x\n",
                                            status);
            return FBE_RAID_STATE_STATUS_EXECUTING;
        }
         ...
         */
        fbe_raid_common_set_state(&siots_p->common, (fbe_raid_common_state_t)fbe_mirror_rekey_state3);
    }
    ...
    else
    {
         ...
         */
        fbe_raid_siots_set_unexpected_error(siots_p, FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS,
                                            "mirror: rekey memory request failed with status: 0x%x\n",
                                            status);
        return FBE_RAID_STATE_STATUS_EXECUTING;
    }
...
/**************************************
 * end fbe_mirror_rekey_state0()
 **************************************/
/****************************************************************
 * fbe_mirror_rekey_state1()
 ****************************************************************
 * @brief
...
static fbe_raid_state_status_t fbe_mirror_rekey_state1(fbe_raid_siots_t * siots_p)
{
    ...
    if (RAID_MEMORY_COND(!fbe_raid_siots_is_deferred_allocation_successful(siots_p)))
    {
        ...
        fbe_raid_siots_trace(siots_p, FBE_RAID_SIOTS_TRACE_PARAMS_ERROR,
                             "mirror: rekey memory allocation error common flags: 0x%x \n",
     ...
     */
    fbe_raid_siots_transition(siots_p, fbe_mirror_rekey_state3);
...
/********************************
 * end fbe_mirror_rekey_state1()
 ********************************/
/*!***************************************************************
 *  fbe_mirror_rekey_state3()
 ****************************************************************
 * @brief
...
static fbe_raid_state_status_t fbe_mirror_rekey_state3(fbe_raid_siots_t * siots_p)
{
    ...
    fbe_raid_siots_transition(siots_p, fbe_mirror_rekey_state4);
    ...
    if (fbe_queue_length(&siots_p->read_fruts_head) != siots_p->wait_count) {
        ...
        fbe_raid_siots_set_unexpected_error(siots_p, FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS,
                                            "mirror: queue length %d not equal to wait count %lld\n",
...
/**************************************
 * end fbe_mirror_rekey_state3
 **************************************/

/*!**************************************************************
 * fbe_mirror_rekey_handle_read_error()
 ****************************************************************
 * @brief
                                                                  ...
                                                                  fbe_raid_fru_eboard_t *eboard_p)
{
    ...
    /* We need to re-evaluate our degraded positions 
    ...
    {
        fbe_raid_siots_set_unexpected_error(siots_p, FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS,
                                            "mirror rekey unexpected fru error status");
...
/******************************************
 * end fbe_mirror_rekey_handle_read_error()
 ******************************************/
/*!***************************************************************
 * fbe_mirror_rekey_state4()
 ****************************************************************
 * @brief
...
static fbe_raid_state_status_t fbe_mirror_rekey_state4(fbe_raid_siots_t * siots_p)
{
    ...
    fbe_raid_siots_log_traffic(siots_p, "mirror_rekey_state4");
    if (siots_p->wait_count != 0)
    {
        fbe_raid_siots_set_unexpected_error(siots_p, FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS, 
                                            "mirror: wait count unexpected 0x%llx", siots_p->wait_count);
        return FBE_RAID_STATE_STATUS_EXECUTING;
    }
     ...
     */
    status = fbe_mirror_get_fruts_error(read_fruts_p, &eboard);

    if (status == FBE_RAID_FRU_ERROR_STATUS_SUCCESS)
    {
        /* Success. Continue
         */
        fbe_raid_siots_transition(siots_p, fbe_mirror_rekey_state10);
        return FBE_RAID_STATE_STATUS_EXECUTING;
    }
             ...
             fbe_raid_siots_is_aborted(siots_p))
    {
        ...
        state_status = fbe_mirror_handle_fruts_error(siots_p, read_fruts_p, &eboard, status);
        return state_status;
    }
    ...
    else if (status == FBE_RAID_FRU_ERROR_STATUS_ERROR)
    {
        ...
        state_status = fbe_mirror_rekey_handle_read_error(siots_p, &eboard);
        
        if (state_status == FBE_RAID_STATE_STATUS_DONE)
        {
            /* Continue to check crc and write.
             */ 
            fbe_raid_siots_transition(siots_p, fbe_mirror_rekey_state20);
            return FBE_RAID_STATE_STATUS_EXECUTING;
        }
        else
        {
...
/**************************************
 * end fbe_mirror_rekey_state4()
 **************************************/

/****************************************************************
 * fbe_mirror_rekey_state5()
 ****************************************************************
 * @brief
...
fbe_raid_state_status_t fbe_mirror_rekey_state5(fbe_raid_siots_t * siots_p)
{
    fbe_status_t status;
...
/**************************************
 * end fbe_mirror_rekey_state5()
 **************************************/

/*!***************************************************************
 *  fbe_mirror_rekey_state10()
 ****************************************************************
 * @brief
...
static fbe_raid_state_status_t fbe_mirror_rekey_state10(fbe_raid_siots_t * siots_p)
{
    ...
    if (RAID_COND(status != FBE_STATUS_OK))
    {
        fbe_raid_siots_set_unexpected_error(siots_p, 
                                            FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS,
                                            "mirror: %s failed to set opcode.read_fruts_p = 0x%p, "
    ...
    siots_p->wait_count = siots_p->data_disks;
    fbe_raid_siots_transition(siots_p, fbe_mirror_rekey_state11);
...
/**************************************
 * end fbe_mirror_rekey_state10
 **************************************/
/****************************************************************
 * fbe_mirror_rekey_state11()
 ****************************************************************
 * @brief
...
fbe_raid_state_status_t fbe_mirror_rekey_state11(fbe_raid_siots_t * siots_p)
{
    fbe_raid_fru_eboard_t eboard;
    fbe_raid_fru_error_status_t status;
     ...
     */
    status = fbe_mirror_get_fruts_error(write_fruts_p, &eboard);
    ...
    {
        fbe_raid_state_status_t state_status;
        state_status = fbe_mirror_handle_fruts_error(siots_p, write_fruts_p, &eboard, status);
        return state_status;
    }
    else if (status == FBE_RAID_FRU_ERROR_STATUS_RETRY)
    {
    ...
    else if (status == FBE_RAID_FRU_ERROR_STATUS_ERROR)
    {
        ...
        if (RAID_COND(eboard.hard_media_err_count != 0))
        {
            fbe_raid_siots_set_unexpected_error(siots_p,
                                                FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS,
                                                "mirror: hard error count unexpected: %d \n",
                                                eboard.hard_media_err_count);
            fbe_raid_fru_eboard_display(&eboard, siots_p, FBE_TRACE_LEVEL_ERROR);
            return FBE_RAID_STATE_STATUS_EXECUTING; 
        }
        else if (eboard.dead_err_count == 1)
        {
        ...
        else
        {
             ...
             */
            fbe_raid_siots_set_unexpected_error(siots_p, FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS,
                                                "mirror: %s fru error status unknown 0x%x\n", 
                                                __FUNCTION__, status);
            fbe_raid_fru_eboard_display(&eboard, siots_p, FBE_TRACE_LEVEL_ERROR);
        }
    }    /* end else if (status == FBE_RAID_FRU_ERROR_STATUS_ERROR)*/
    else
    {
         ...
         */
        fbe_raid_siots_set_unexpected_error(siots_p, FBE_RAID_SIOTS_TRACE_UNEXPECTED_ERROR_PARAMS,
                                            "mirror: %s fru status unknown 0x%x\n", 
                                            __FUNCTION__, status);
        fbe_raid_fru_eboard_display(&eboard, siots_p, FBE_TRACE_LEVEL_ERROR);
    }
...
/*******************************
 * end og fbe_mirror_rekey_state11()
 *******************************/
/****************************************************************
 * fbe_mirror_rekey_state20()
 ****************************************************************
 * @brief
...
/*******************************
 * end of fbe_mirror_rekey_state20()
 *******************************/
/*****************************************
 * End fbe_mirror_rekey.c
 *****************************************/
