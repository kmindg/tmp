#ifndef FBE_COOLING_MGMT_H
#define FBE_COOLING_MGMT_H

#include "fbe/fbe_types.h"

fbe_status_t fbe_cooling_mgmt_fup_build_image_file_name(fbe_u8_t * pImageFileNameBuffer,
