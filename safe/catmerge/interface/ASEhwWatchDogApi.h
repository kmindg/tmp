...
#define IOCTL_ERROR_REPORT           \
HWERRMON_CTL_CODE(16, EMCPAL_IOCTL_METHOD_BUFFERED)
...
typedef enum _HWERRMON_ERROR_REPORT_STATUS
{
    ERROR_REPORT_DISABLED,
    ERROR_REPORT_ENABLED,
    ERROR_REPORT_ALREADY_ENABLED,
    ERROR_REPORT_ALREADY_DISABLED,
    ERROR_REPORT_CHANGE_ERROR,
} HWERRMON_ERROR_REPORT_STATUS;

typedef enum _HWERRMON_ERROR_REPORT_OPERATION
{
    ERROR_REPORT_ENABLE,
    ERROR_REPORT_DISABLE,
    ERROR_REPORT_STATUS
} HWERRMON_ERROR_REPORT_OPERATION;

typedef struct _HWERRMON_ERROR_REPORT
{
    HWERRMON_ERROR_REPORT_OPERATION      operation;
    HWERRMON_ERROR_REPORT_STATUS         status;
} HWERRMON_ERROR_REPORT, *PHWERRMON_ERROR_REPORT;
