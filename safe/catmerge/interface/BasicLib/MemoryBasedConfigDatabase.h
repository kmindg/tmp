...
public:
    ...
    bool GetBinary(PVOID ValuePtr, ULONG MaxLen, ULONG & ValueLen) const {return true;}
...
private:
    ...
    MemoryBasedDatabaseValue(EMCUTIL_REG_HANDLE parent_reg_handle, const PCHAR valueName, ULONG defValue);
    ...
    // 
    // @param defValue - the data to be copied into this object.
    MemoryBasedDatabaseValue(EMCUTIL_REG_HANDLE parent_reg_handle, const PCHAR valueName, ULONGLONG defValue);
    ...
    // 
    // @param defValue - the data to be copied into this object.
    MemoryBasedDatabaseValue(EMCUTIL_REG_HANDLE parent_reg_handle, const PCHAR valueName, K10_WWID defValue);
    ...
    MemoryBasedDatabaseValue(EMCUTIL_REG_HANDLE parent_reg_handle, const PCHAR valueName, const PCHAR defValue);
    ...
    // Note: this constructor may fail.  IsValueValid() must be called to determine
    // whether construction was successful.
    MemoryBasedDatabaseValue(EMCUTIL_REG_HANDLE parent_reg_handle, const PCHAR valueName, PVOID binaryValue, ULONG len);
...
public:
    static MemoryBasedDatabaseKey *getRoot();
    ...
    MemoryBasedDatabaseKey(EMCUTIL_REG_HANDLE parent_reg_handle, const char * KeyName);
...
public:
    // Add a key below this node
    // @param key - the key to add
    MemoryBasedDatabaseKey * AddSubKey(const char *KeyName);
    ...
    // 
    // @param defValue - the data to be copied into this object.
    void AddValue(const PCHAR valueName, ULONG defValue);
    ...
    // 
    // @param defValue - the data to be copied into this object.
    void AddValue(const PCHAR valueName, ULONGLONG defValue);
    ...
    // 
    // @param defValue - the data to be copied into this object.
    void AddValue(const PCHAR valueName, K10_WWID defValue);
    ...
    // Note: this constructor may fail.  IsValueValid() must be called to determine
    // whether construction was successful.
    void AddValue(const PCHAR valueName, const PCHAR defValue);
    ...
    // Note: this constructor may fail.  IsValueValid() must be called to determine
    // whether construction was successful.
    void AddValue(PCWSTR valueName, EMCPAL_UNICODE_STRING * defValue);
    ...
    // Note: this constructor may fail.  IsValueValid() must be called to determine
    // whether construction was successful.
    void AddValue(const PCHAR valueName, PVOID binaryValue, ULONG len);
...
private:
    ...
    EMCUTIL_REG_HANDLE parent_reg_handle;
    EMCUTIL_REG_HANDLE reg_handle;
