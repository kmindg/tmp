...
#ifdef C4_INTEGRATED
#define MAX_USER_VISIBLE_TRADITIONAL_LUNS       (MAX_POOL_LUS + MAX_ADVANCED_SNAPSHOT_LUNS)
#else
#define MAX_USER_VISIBLE_TRADITIONAL_LUNS       (MAX_FAR_SHADOW_LUS + MAX_SNAP_LUS + CSX_MAX(MAX_POOL_LUS, PLATFORM_HOST_ACCESSIBLE_FLARE_LUNS) + MAX_ADVANCED_SNAPSHOT_LUNS)
#endif


#define MAX_HOST_ACCESSIBLE_TRADITIONAL_LUNS    (MAX_USER_VISIBLE_TRADITIONAL_LUNS + MAX_CELERRA_BOOT_LUNS)
